import{u as zn,j as e,L as ln,r as E,P as re,a as On,N as En,R as ie,A as te,S as se,b as Bn,T as jn,E as ae,c as oe,C as Ee,d as Ie,X as le,e as ce,f as Ne,g as Ue,h as sn,i as Ae,k as Te,B as ye}from"./vendor-1jWIULEY.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const I of a.addedNodes)I.tagName==="LINK"&&I.rel==="modulepreload"&&t(I)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Ce=[{path:"/",label:"Home"},{path:"/calculator",label:"Calculator"},{path:"/admin",label:"Login"}];function Se({children:r}){const{pathname:i}=zn(),n=t=>`rounded-lg px-3 py-2 text-sm font-medium transition ${i===t?"bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-sm":"text-slate-700 hover:bg-slate-100"}`;return e.jsxs("div",{className:"min-h-screen bg-mesh text-slate-900",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 backdrop-blur",children:e.jsxs("div",{className:"mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4",children:[e.jsx(ln,{to:"/",className:"text-lg font-semibold tracking-tight text-slate-900",children:"Cluster Calculation"}),e.jsx("nav",{className:"flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm",children:Ce.map(t=>e.jsx(ln,{to:t.path,className:n(t.path),children:t.label},t.path))})]})}),e.jsx("main",{className:"mx-auto w-full max-w-7xl px-4 py-8",children:r})]})}const wn={danger:"border-rose-200 bg-rose-50 text-rose-700",warning:"border-amber-200 bg-amber-50 text-amber-700",success:"border-emerald-200 bg-emerald-50 text-emerald-700",info:"border-slate-200 bg-slate-50 text-slate-700"};function F({message:r,tone:i="info",className:n=""}){return r?e.jsx("p",{className:`rounded-lg border px-3 py-2 text-sm ${wn[i]||wn.info} ${n}`,children:r}):null}const Re=["A","A-","B+","B","B-","C+","C","C-","D+","D","D-","E"],ue=(r,i)=>{const n=Number(r);return Number.isFinite(n)?n:i},de="150".trim(),Pn=ue(de,0),Ln=r=>/^https?:\/\//i.test(r),Oe=r=>{const i=String(r||"").trim();return i?Ln(i)?i.replace(/\/+$/,""):(i.startsWith("/")?i:`/${i}`).replace(/\/+$/,""):""},me="".trim(),Nn=Oe(me),he=r=>{if(!r)return"";if(Ln(r))try{return new URL(r).pathname.replace(/\/+$/,"")||""}catch{return""}return r.startsWith("/")?r.replace(/\/+$/,""):""},ge=(r,i)=>{if(!r)return i;const n=he(r);if(!n||n==="/")return i;const t=n.toLowerCase(),s=i.toLowerCase();return s===t?"":s.startsWith(`${t}/`)?i.slice(n.length):i},q=r=>{const i=String(r||"").trim();if(!i)return Nn||"";if(Ln(i)||!Nn)return i;const n=i.startsWith("/")?i:`/${i}`,t=ge(Nn,n);return t?`${Nn}${t.startsWith("/")?t:`/${t}`}`:Nn},fn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Dn=(r,i)=>String((r==null?void 0:r.error)||(r==null?void 0:r.message)||i).trim()||i,ve=({enabled:r=!0}={})=>{const[i,n]=E.useState(null),[t,s]=E.useState(null),[a,I]=E.useState(r),[N,A]=E.useState(!1),[T,c]=E.useState(""),d=E.useMemo(()=>!0,[]),y=E.useCallback(async()=>{I(!0);try{const C=await fetch(q("/api/admin/me"),{method:"GET",credentials:"include"}),f=await fn(C);if(!C.ok){n(null),s(null);return}n((f==null?void 0:f.user)||null),s((f==null?void 0:f.profile)||null),c("")}catch{n(null),s(null)}finally{I(!1)}},[]);E.useEffect(()=>{if(!r){I(!1);return}y().catch(()=>{})},[r,y]);const u=E.useCallback(async(C,f)=>{A(!0),c("");try{const Y=await fetch(q("/api/admin/login"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(C||"").trim(),password:String(f||"")})}),g=await fn(Y);if(!Y.ok){const H=Y.status===404?"Admin login endpoint not found. Check VITE_API_BASE_URL or backend routes.":Dn(g,"Authentication request failed.");return c(H),{success:!1,error:H}}return n((g==null?void 0:g.user)||null),s((g==null?void 0:g.profile)||null),c(""),{success:!0,user:(g==null?void 0:g.user)||void 0,profile:(g==null?void 0:g.profile)||void 0,error:""}}catch(Y){const g=(Y==null?void 0:Y.message)||"Authentication request failed.";return c(g),{success:!1,error:g}}finally{A(!1)}},[]),x=E.useCallback(async()=>{const C="Google popup login is disabled in backend-auth mode. Use email and password.";return c(C),{success:!1,error:C}},[]),O=E.useCallback(async()=>{A(!0);try{await fetch(q("/api/admin/logout"),{method:"POST",credentials:"include"})}finally{n(null),s(null),c(""),A(!1)}},[]),h=E.useCallback(async({email:C,password:f,name:Y})=>{if(!i||!t)throw new Error("You must be logged in as admin.");if(t.role!=="super")throw new Error("Only a super admin can add regular admin users.");const g=await fetch(q("/api/admin/regular-admin"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(C||"").trim(),password:String(f||""),name:String(Y||"").trim()})}),H=await fn(g);if(!g.ok)throw new Error(Dn(H,"Unable to create regular admin."));return{user:(H==null?void 0:H.user)||null,profile:(H==null?void 0:H.profile)||null}},[t,i]);return{firebaseAuthReady:d,adminUser:i,adminProfile:t,authLoading:a,authWorking:N,authError:T,isAdminAuthenticated:!!(i&&t),login:u,loginWithGoogle:x,logout:O,addRegularAdmin:h}},bn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},xn={ENG:"English",KIS:"Kiswahili",MAT:"Mathematics",BIO:"Biology",CHE:"Chemistry",PHY:"Physics",GSC:"General Science",HAG:"History",GEO:"Geography",CRE:"CRE",IRE:"IRE",HRE:"HRE",CMP:"Computer Studies",AGR:"Agriculture",ARD:"Art & Design",HSC:"Home Science",BST:"Business Studies",FRE:"French",GER:"German",MUS:"Music",ARB:"Arabic"},kn=[{title:"Group I",required:!0,subjects:["ENG","KIS","MAT"]},{title:"Group II (Sciences)",required:!1,subjects:["BIO","CHE","PHY","GSC"]},{title:"Group III (Humanities)",required:!1,subjects:["HAG","GEO","CRE","IRE","HRE"]},{title:"Group IV (Technical)",required:!1,subjects:["CMP","AGR","ARD","HSC"]},{title:"Group V (Others)",required:!1,subjects:["BST","FRE","GER","MUS","ARB"]}],Ye=["ENG","KIS","MAT"],L=["BIO","CHE","PHY","GSC"],K=["HAG","GEO","CRE","IRE","HRE"],j=["CMP","AGR","ARD","HSC"],w=["BST","FRE","GER","MUS","ARB"],Sn=[...Ye,...L,...K,...j,...w],l=(r,i)=>Math.max(...i.map(n=>n in r?r[n]:0),0),D=(r,i,n)=>{const t=i.filter(s=>s in r).map(s=>r[s]).sort((s,a)=>a-s);return t.length>=n?t[n-1]:0},Me=r=>{const i=Object.values(r).sort((n,t)=>t-n);return i.length>=7?i.slice(0,7).reduce((n,t)=>n+t,0):0},fe=(r,i)=>Number((Math.sqrt(r/48*(i/84))*48*.94).toFixed(3)),Ve=r=>["BIO","CHE","MAT","PHY"].every(n=>r[n]&&r[n]in bn),Ke=(r,i)=>{const n={};for(const[I,N]of Object.entries(i))N in bn&&(n[I]=bn[N]);if(Object.keys(n).length<7)return 0;const t=Me(n),s=()=>0;let a=0;if(r===1){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L))+l(n,K)+Math.max(l(n,L),D(n,K,2),l(n,j),l(n,w))}else if(r===2){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+(n.MAT??0)+Math.max(l(n,L),l(n,K))+Math.max(l(n,L),l(n,K),l(n,j),l(n,w))}else if(r===3){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L))+l(n,K)+Math.max(l(n,L),D(n,K,2),l(n,j),l(n,w))}else if(r===4){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(n.BIO??0,n.CHE??0,n.GEO??0)+Math.max(l(n,L),l(n,K),l(n,j),l(n,w))}else if(r===5){if(!("MAT"in n&&"PHY"in n&&"CHE"in n))return s();a=n.MAT+n.PHY+n.CHE+Math.max(n.BIO??0,l(n,K),l(n,j),l(n,w))}else if(r===6){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+l(n,K)+Math.max(D(n,L,2),D(n,K,2),l(n,j),l(n,w))}else if(r===7){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(D(n,L,2),l(n,K))+Math.max(l(n,L),l(n,K),l(n,j),l(n,w))}else if(r===8){if(!("MAT"in n&&"BIO"in n))return s();a=n.MAT+n.BIO+Math.max(n.PHY??0,n.CHE??0)+Math.max(D(n,L,3),l(n,K),l(n,j),l(n,w))}else if(r===9){if(!("MAT"in n))return s();a=n.MAT+l(n,L)+D(n,L,2)+Math.max(D(n,L,3),l(n,K),l(n,j),l(n,w))}else if(r===10){if(!("MAT"in n))return s();a=n.MAT+l(n,L)+l(n,K)+Math.max(D(n,L,2),D(n,K,2),l(n,j),l(n,w))}else if(r===11)a=Math.max((n.CHE??0)+Math.max(n.MAT??0,n.PHY??0)+Math.max(n.BIO??0,n.HSC??0)+Math.max(l(n,["ENG","KIS"]),l(n,K),l(n,j),l(n,w)),Math.max(n.BIO??0,n.GSC??0)+(n.MAT??0)+Math.max(l(n,L),l(n,K))+Math.max(l(n,["ENG","KIS"]),l(n,L),l(n,K),l(n,j),l(n,w)));else if(r===12||r===13){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0)+Math.max(l(n,["ENG","KIS"]),D(n,L,3),l(n,K),l(n,j),l(n,w))}else if(r===14){if(!("CHE"in n))return s();a=Math.max(n.BIO??0,n.AGR??0,n.HSC??0)+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.GEO??0)+Math.max(l(n,["ENG","KIS"]),l(n,K),l(n,j),l(n,w))}else if(r===15){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.AGR??0)+Math.max(l(n,["ENG","KIS"]),l(n,K),l(n,j),l(n,w))}else if(r===16){if(!("GEO"in n))return s();a=n.GEO+(n.MAT??0)+l(n,L)+Math.max(D(n,L,2),D(n,K,2),l(n,j),l(n,w))}else if(r===17){if(!("FRE"in n||"GER"in n))return s();a=l(n,["FRE","GER"])+l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L),l(n,K))+Math.max(l(n,L),l(n,K),l(n,j),D(n,w,2))}else if(r===18){if(!("MUS"in n))return s();a=n.MUS+l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L),l(n,K))+Math.max(l(n,L),l(n,K),l(n,j),D(n,w,2))}else if(r===19)a=l(n,Sn)+D(n,Sn,2)+D(n,Sn,3)+D(n,Sn,4);else if(r===20){if(!(n.CRE||n.IRE||n.HRE))return s();a=l(n,["CRE","IRE","HRE"])+l(n,["ENG","KIS"])+D(n,K,2)+Math.max(l(n,L),l(n,j),l(n,w))}else return s();return fe(a,t)},be=r=>{const i={};for(let n=1;n<=20;n+=1)i[n]=Ke(n,r);return i},Zn="kuccps.cluster.sessions",en={catalog:q("/api/catalog"),adminCatalogUpload:q("/api/admin/catalog/upload"),adminCatalogCourse:q("/api/admin/catalog/course"),sessions:q("/api/sessions"),adminSessions:q("/api/admin/sessions"),adminSessionsBulkDelete:q("/api/admin/sessions/delete-many"),adminMe:q("/api/admin/me")},mn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},pn=async r=>{const i=await fetch(r,{method:"GET",credentials:"include"}),n=await mn(i);return{ok:i.ok,status:i.status,data:n}},yn=async(r,i)=>{const n=await fetch(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await mn(n);return{ok:n.ok,status:n.status,data:t}},Le=async(r,i)=>{const n=await fetch(r,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await mn(n);return{ok:n.ok,status:n.status,data:t}},xe=async r=>{const i=await fetch(r,{method:"DELETE",credentials:"include"}),n=await mn(i);return{ok:i.ok,status:i.status,data:n}},rn=(r,i)=>{const n=(r==null?void 0:r.data)||{};return String((n==null?void 0:n.error)||(n==null?void 0:n.message)||i)},cn=r=>String(r||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,""),An=r=>{const i=r&&typeof r=="object"?r:{},n={};for(let t=1;t<=20;t+=1){const s=Number(i[t]??i[String(t)]??0);n[t]=Number.isFinite(s)?s:0}return n},Gn=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=String(n||"").trim().toUpperCase(),a=String(t||"").trim().toUpperCase();!s||!a||(i[s]=a)}),i},pe=(r,i)=>{if(!i||String(r||"").trim().toUpperCase()!=="BACHELOR OF SCIENCE CLINICAL MEDICINE")return i;const n=i.replace(/\s+/g," ").trim();return/^mathematics\s*\/\s*physics$/i.test(n)?"Mathematics":i},Ge=(r,i)=>{const n={};return Object.entries(i||{}).forEach(([t,s])=>{const a=pe(r,String(t||"").trim()),I=String(s||"").trim().toUpperCase();!a||!I||(n[a]=I)}),n},hn=()=>{if(typeof window>"u")return{};try{const r=window.localStorage.getItem(Zn);if(!r)return{};const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}},Qn=r=>{typeof window>"u"||window.localStorage.setItem(Zn,JSON.stringify(r||{}))},Rn="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",Fe=(r=8)=>{if(typeof crypto<"u"&&crypto.getRandomValues){const n=new Uint8Array(r);return crypto.getRandomValues(n),Array.from(n,t=>Rn[t%Rn.length]).join("")}let i="";for(let n=0;n<r;n+=1){const t=Math.floor(Math.random()*Rn.length);i+=Rn[t]}return i},He=()=>{const r=hn();for(let i=0;i<20;i+=1){const n=Fe();if(!r[n])return n}throw new Error("Unable to generate a local access code.")},Be=r=>{const i=hn();i[r.code]=r,Qn(i)},je=(r,i="")=>({name:(r==null?void 0:r.name)||i,requirements:Ge((r==null?void 0:r.name)||i,(r==null?void 0:r.requirements)||{}),universities:Array.isArray(r==null?void 0:r.universities)?r.universities.map(n=>({name:String((n==null?void 0:n.name)||""),cutoff:Number((n==null?void 0:n.cutoff)??0),courseCode:String((n==null?void 0:n.courseCode)||"")})):[]}),we=r=>(Array.isArray(r)?r:Object.values(r||{})).map(n=>je(n)).filter(n=>!!n.name),Pe=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);!Number.isInteger(s)||s<1||(i[s]=we(t))}),i},De=()=>!0,ke=async()=>{const r=await pn(en.catalog);if(!r.ok)throw new Error(rn(r,"Unable to load course catalog from backend."));return Pe(r.data||{})},Je=async r=>{if(!r||typeof r!="object")throw new Error("Invalid course catalog payload.");const i=await yn(en.adminCatalogUpload,r);if(!i.ok)throw new Error(rn(i,"Unable to upload course catalog to backend."))},qe=async({cluster:r,name:i,requirements:n,universities:t})=>{const s=await yn(en.adminCatalogCourse,{cluster:r,name:i,requirements:n,universities:t});if(!s.ok)throw new Error(rn(s,"Unable to save course entry to backend."));return s.data||{}},$e=async({code:r,email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N})=>{const A={email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N};r&&(A.code=r);const T=await yn(en.sessions,A);if(!T.ok)throw new Error(rn(T,"Unable to save session to backend."));const c=T.data||{};return{code:cn(c.code),email:String(c.email||"").trim(),phoneNumber:String(c.phoneNumber||"").trim(),amountPaid:Number(c.amountPaid??0),grades:Gn(c.grades),results:An(c.results),medicineEligible:!!c.medicineEligible,paymentResponse:c.paymentResponse||null,createdAt:String(c.createdAt||""),updatedAt:String(c.updatedAt||""),storage:"firebase"}},Xn=async()=>{const r=hn(),i=Object.entries(r);if(!i.length)return 0;let n=0;const t={...r};for(const[s,a]of i)try{const I={code:cn(a.code||s),email:String(a.email||"").trim(),phoneNumber:String(a.phoneNumber||"").trim(),amountPaid:Number(a.amountPaid??0),grades:a.grades||{},results:a.results||{},medicineEligible:!!a.medicineEligible,paymentResponse:a.paymentResponse||null},N=await yn(en.sessions,I);if(!N.ok)throw new Error(rn(N,"Unable to sync session to backend."));delete t[s],n+=1}catch{}return n>0&&Qn(t),n},_e=async r=>{try{const i=await $e(r);return Xn().catch(()=>{}),{session:i,storage:"firebase",warning:""}}catch(i){const n=new Date().toISOString(),s={code:He(),email:String((r==null?void 0:r.email)||"").trim(),phoneNumber:String((r==null?void 0:r.phoneNumber)||"").trim(),amountPaid:Number((r==null?void 0:r.amountPaid)??0),grades:(r==null?void 0:r.grades)||{},results:An((r==null?void 0:r.results)||{}),medicineEligible:!!(r!=null&&r.medicineEligible),paymentResponse:(r==null?void 0:r.paymentResponse)||null,createdAt:n,updatedAt:n,storage:"local"};return Be(s),{session:s,storage:"local",warning:(i==null?void 0:i.message)||"Backend save failed. Session saved locally on this browser only."}}},We=async r=>{const i=cn(r);if(!i)return null;const n=await pn(`${en.sessions}/${i}`);if(n.ok&&n.data){const s=n.data;return{code:i,email:String(s.email||"").trim(),phoneNumber:String(s.phoneNumber||"").trim(),amountPaid:Number(s.amountPaid??0),grades:Gn(s.grades),results:An(s.results),medicineEligible:!!s.medicineEligible,paymentResponse:s.paymentResponse||null,createdAt:String(s.createdAt||""),updatedAt:String(s.updatedAt||""),storage:"firebase"}}const t=hn()[i];if(t)return{code:i,email:t.email||"",phoneNumber:t.phoneNumber||"",amountPaid:Number(t.amountPaid??0),grades:t.grades||{},results:An(t.results||{}),medicineEligible:!!t.medicineEligible,paymentResponse:t.paymentResponse||null,createdAt:t.createdAt||"",updatedAt:t.updatedAt||"",storage:"local"};if(n.status!==404)throw new Error(rn(n,"Unable to load session from backend."));return null},ze=async()=>{const r=await pn(en.adminSessions);if(!r.ok)throw new Error(rn(r,"Unable to load calculated sessions from backend."));return(Array.isArray(r.data)?r.data:[]).map(n=>({code:cn(n.code),email:String(n.email||"").trim(),phoneNumber:String(n.phoneNumber||"").trim(),amountPaid:Number(n.amountPaid??0),createdAt:String(n.createdAt||""),updatedAt:String(n.updatedAt||""),medicineEligible:!!n.medicineEligible,grades:Gn(n.grades),results:An(n.results),paymentResponse:n.paymentResponse||null,storage:"firebase"})).filter(n=>n.code).sort((n,t)=>(Date.parse(t.createdAt||"")||0)-(Date.parse(n.createdAt||"")||0))},Ze=async(r,i={})=>{const n=cn(r);if(!n)throw new Error("Session code is required.");const t=await Le(`${en.adminSessions}/${n}`,i);if(!t.ok)throw new Error(rn(t,"Unable to update session."))},Qe=async r=>{const i=cn(r);if(!i)throw new Error("Session code is required.");const n=await xe(`${en.adminSessions}/${i}`);if(!n.ok)throw new Error(rn(n,"Unable to delete session."))},Xe=async(r=[])=>{var n;const i=await yn(en.adminSessionsBulkDelete,{codes:Array.isArray(r)?r:[]});if(!i.ok)throw new Error(rn(i,"Unable to delete selected sessions."));return Number(((n=i.data)==null?void 0:n.deleted)??0)},In={courseName:"COURSE NAME",cluster:"CLUSTER",courseCode:"COURSE CODE",university:"UNIVERSITY",cutoff:"CUT-OFF POINTS",requirements:"MINIMUM SUBJECT REQUIREMENTS"},an=r=>String(r??"").replace(/\u00a0/g," ").trim(),nr=r=>{const i=an(r).replace(/,/g,"");if(!i||i==="-")return 0;const n=Number.parseFloat(i);return Number.isFinite(n)?n:0},Jn=r=>{const i=an(r);if(!i||/^none$/i.test(i)||i==="-")return[];const n=[];return i.split(/\r?\n|;/).map(t=>t.trim()).filter(Boolean).forEach(t=>{if(/^none$/i.test(t)||t==="-")return;const s=t.indexOf(":");if(s<0)return;const a=t.slice(0,s).trim(),I=t.slice(s+1).trim().toUpperCase();!a||!I||I==="-"||n.push({subject:a,grade:I})}),n},er=(r,i)=>{if(!i||String(r||"").trim().toUpperCase()!=="BACHELOR OF SCIENCE CLINICAL MEDICINE")return i;const n=i.replace(/\s+/g," ").trim();return/^mathematics\s*\/\s*physics$/i.test(n)?"Mathematics":i},rr=(r,i=[])=>{const n=[];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=er(r,t.subject);if(!s)return;const a=String(t.grade||"").trim().toUpperCase();if(!a)return;const I=n.findIndex(N=>N.subject===s);I>=0?n[I]={subject:s,grade:a}:n.push({subject:s,grade:a})}),n},ir=(r=[],i=[])=>{const n=[...r];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=n.findIndex(a=>a.subject===t.subject);s>=0?n[s]=t:n.push(t)}),n},tr=r=>{const i=new Set,n=[];return r.forEach(t=>{const s=`${t.name}|${t.courseCode}`;!t.name||i.has(s)||(i.add(s),n.push(t))}),n},sr=r=>Object.values(In).some(i=>an(r==null?void 0:r[i])),ne=r=>{const i=re.parse(r,{header:!0,skipEmptyLines:!1});if(!Array.isArray(i.data)||!i.data.length)throw new Error("CSV has no records.");const n={};let t=null;const s=()=>{t&&(n[t.cluster]||(n[t.cluster]=[]),n[t.cluster].push({name:t.name,requirements:rr(t.name,t.requirements),universities:tr(t.universities)}),t=null)};if(i.data.forEach(a=>{if(!a||typeof a!="object"||!sr(a))return;const I=an(a[In.courseName]),N=an(a[In.cluster]),A=an(a[In.courseCode]),T=an(a[In.university]),c=an(a[In.cutoff]),d=an(a[In.requirements]),y=Number(N);if(!!(I&&Number.isInteger(y)&&y>0))s(),t={name:I,cluster:y,requirements:Jn(d),universities:[]};else if(!t)return;d&&(t.requirements=ir(t.requirements,Jn(d))),(T||A||c)&&t.universities.push({name:T||"Unknown University",courseCode:A,cutoff:nr(c)})}),s(),!Object.keys(n).length)throw new Error("CSV did not produce a valid course catalog.");return n},ar=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}},or=`COURSE NAME,CLUSTER,COURSE CODE,UNIVERSITY,CUT-OFF POINTS,MINIMUM SUBJECT REQUIREMENTS\r
