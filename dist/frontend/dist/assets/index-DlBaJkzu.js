import{u as Zn,j as e,L as cn,r as E,P as ie,a as mn,N as En,R as te,A as se,S as ae,b as wn,T as jn,E as oe,c as Ee,C as Ie,d as le,X as ce,e as Ne,f as Ue,g as Ae,h as tn,i as Te,k as ye,B as Ce}from"./vendor-1jWIULEY.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const I of a.addedNodes)I.tagName==="LINK"&&I.rel==="modulepreload"&&t(I)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Se=[{path:"/",label:"Home"},{path:"/calculator",label:"Calculator"},{path:"/admin",label:"Login"}];function Re({children:r}){const{pathname:i}=Zn(),n=t=>`rounded-lg px-3 py-2 text-sm font-medium transition ${i===t?"bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-sm":"text-slate-700 hover:bg-slate-100"}`;return e.jsxs("div",{className:"min-h-screen bg-mesh text-slate-900",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 backdrop-blur",children:e.jsxs("div",{className:"mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4",children:[e.jsx(cn,{to:"/",className:"text-lg font-semibold tracking-tight text-slate-900",children:"Cluster Calculation"}),e.jsx("nav",{className:"flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm",children:Se.map(t=>e.jsx(cn,{to:t.path,className:n(t.path),children:t.label},t.path))})]})}),e.jsx("main",{className:"mx-auto w-full max-w-7xl px-4 py-8",children:r})]})}const Pn={danger:"border-rose-200 bg-rose-50 text-rose-700",warning:"border-amber-200 bg-amber-50 text-amber-700",success:"border-emerald-200 bg-emerald-50 text-emerald-700",info:"border-slate-200 bg-slate-50 text-slate-700"};function F({message:r,tone:i="info",className:n=""}){return r?e.jsx("p",{className:`rounded-lg border px-3 py-2 text-sm ${Pn[i]||Pn.info} ${n}`,children:r}):null}const ue=["A","A-","B+","B","B-","C+","C","C-","D+","D","D-","E"],de=(r,i)=>{const n=Number(r);return Number.isFinite(n)?n:i},Oe="150".trim(),Dn=de(Oe,0),hn=r=>/^https?:\/\//i.test(r),me=r=>{const i=String(r||"").trim();return i?hn(i)?i.replace(/\/+$/,""):(i.startsWith("/")?i:`/${i}`).replace(/\/+$/,""):""},he="".trim(),Un=me(he),ge=r=>{if(!r)return"";if(hn(r))try{return new URL(r).pathname.replace(/\/+$/,"")||""}catch{return""}return r.startsWith("/")?r.replace(/\/+$/,""):""},ve=(r,i)=>{if(!r)return i;const n=ge(r);if(!n||n==="/")return i;const t=n.toLowerCase(),s=i.toLowerCase();return s===t?"":s.startsWith(`${t}/`)?i.slice(n.length):i},ln=r=>{const i=String(r||"").trim();if(!i)return Un||"";if(hn(i)||!Un)return i;const n=i.startsWith("/")?i:`/${i}`,t=ve(Un,n);return t?`${Un}${t.startsWith("/")?t:`/${t}`}`:Un},Ye=r=>{const i=String(r||"").trim();return!i||hn(i)?"":i.startsWith("/")?i:`/${i}`},on=async(r,i)=>{const n=ln(r),t=await fetch(n,i);if(t.status!==404)return t;const s=Ye(r);return!s||s===n?t:fetch(s,i)},Kn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},kn=(r,i)=>String((r==null?void 0:r.error)||(r==null?void 0:r.message)||i).trim()||i,Me=({enabled:r=!0}={})=>{const[i,n]=E.useState(null),[t,s]=E.useState(null),[a,I]=E.useState(r),[N,A]=E.useState(!1),[T,c]=E.useState(""),d=E.useMemo(()=>!0,[]),y=E.useCallback(async()=>{I(!0);try{const C=await on("/api/admin/me",{method:"GET",credentials:"include"}),f=await Kn(C);if(!C.ok){n(null),s(null);return}n((f==null?void 0:f.user)||null),s((f==null?void 0:f.profile)||null),c("")}catch{n(null),s(null)}finally{I(!1)}},[]);E.useEffect(()=>{if(!r){I(!1);return}y().catch(()=>{})},[r,y]);const u=E.useCallback(async(C,f)=>{A(!0),c("");try{const Y=await on("/api/admin/login",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(C||"").trim(),password:String(f||"")})}),g=await Kn(Y);if(!Y.ok){const H=Y.status===404?"Admin login endpoint not found. Check VITE_API_BASE_URL or backend routes.":kn(g,"Authentication request failed.");return c(H),{success:!1,error:H}}return n((g==null?void 0:g.user)||null),s((g==null?void 0:g.profile)||null),c(""),{success:!0,user:(g==null?void 0:g.user)||void 0,profile:(g==null?void 0:g.profile)||void 0,error:""}}catch(Y){const g=(Y==null?void 0:Y.message)||"Authentication request failed.";return c(g),{success:!1,error:g}}finally{A(!1)}},[]),x=E.useCallback(async()=>{const C="Google popup login is disabled in backend-auth mode. Use email and password.";return c(C),{success:!1,error:C}},[]),O=E.useCallback(async()=>{A(!0);try{await on("/api/admin/logout",{method:"POST",credentials:"include"})}finally{n(null),s(null),c(""),A(!1)}},[]),h=E.useCallback(async({email:C,password:f,name:Y})=>{if(!i||!t)throw new Error("You must be logged in as admin.");if(t.role!=="super")throw new Error("Only a super admin can add regular admin users.");const g=await on("/api/admin/regular-admin",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(C||"").trim(),password:String(f||""),name:String(Y||"").trim()})}),H=await Kn(g);if(!g.ok)throw new Error(kn(H,"Unable to create regular admin."));return{user:(H==null?void 0:H.user)||null,profile:(H==null?void 0:H.profile)||null}},[t,i]);return{firebaseAuthReady:d,adminUser:i,adminProfile:t,authLoading:a,authWorking:N,authError:T,isAdminAuthenticated:!!(i&&t),login:u,loginWithGoogle:x,logout:O,addRegularAdmin:h}},xn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},pn={ENG:"English",KIS:"Kiswahili",MAT:"Mathematics",BIO:"Biology",CHE:"Chemistry",PHY:"Physics",GSC:"General Science",HAG:"History",GEO:"Geography",CRE:"CRE",IRE:"IRE",HRE:"HRE",CMP:"Computer Studies",AGR:"Agriculture",ARD:"Art & Design",HSC:"Home Science",BST:"Business Studies",FRE:"French",GER:"German",MUS:"Music",ARB:"Arabic"},Jn=[{title:"Group I",required:!0,subjects:["ENG","KIS","MAT"]},{title:"Group II (Sciences)",required:!1,subjects:["BIO","CHE","PHY","GSC"]},{title:"Group III (Humanities)",required:!1,subjects:["HAG","GEO","CRE","IRE","HRE"]},{title:"Group IV (Technical)",required:!1,subjects:["CMP","AGR","ARD","HSC"]},{title:"Group V (Others)",required:!1,subjects:["BST","FRE","GER","MUS","ARB"]}],fe=["ENG","KIS","MAT"],L=["BIO","CHE","PHY","GSC"],K=["HAG","GEO","CRE","IRE","HRE"],w=["CMP","AGR","ARD","HSC"],j=["BST","FRE","GER","MUS","ARB"],Rn=[...fe,...L,...K,...w,...j],l=(r,i)=>Math.max(...i.map(n=>n in r?r[n]:0),0),D=(r,i,n)=>{const t=i.filter(s=>s in r).map(s=>r[s]).sort((s,a)=>a-s);return t.length>=n?t[n-1]:0},Ve=r=>{const i=Object.values(r).sort((n,t)=>t-n);return i.length>=7?i.slice(0,7).reduce((n,t)=>n+t,0):0},Ke=(r,i)=>Number((Math.sqrt(r/48*(i/84))*48*.94).toFixed(3)),be=r=>{const i=n=>!!(r[n]&&r[n]in xn);return i("BIO")&&i("CHE")&&(i("MAT")||i("PHY"))&&(i("ENG")||i("KIS"))},Le=(r,i)=>{const n={};for(const[I,N]of Object.entries(i))N in xn&&(n[I]=xn[N]);if(Object.keys(n).length<7)return 0;const t=Ve(n),s=()=>0;let a=0;if(r===1){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L))+l(n,K)+Math.max(l(n,L),D(n,K,2),l(n,w),l(n,j))}else if(r===2){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+(n.MAT??0)+Math.max(l(n,L),l(n,K))+Math.max(l(n,L),l(n,K),l(n,w),l(n,j))}else if(r===3){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L))+l(n,K)+Math.max(l(n,L),D(n,K,2),l(n,w),l(n,j))}else if(r===4){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(n.BIO??0,n.CHE??0,n.GEO??0)+Math.max(l(n,L),l(n,K),l(n,w),l(n,j))}else if(r===5){if(!("MAT"in n&&"PHY"in n&&"CHE"in n))return s();a=n.MAT+n.PHY+n.CHE+Math.max(n.BIO??0,l(n,K),l(n,w),l(n,j))}else if(r===6){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+l(n,K)+Math.max(D(n,L,2),D(n,K,2),l(n,w),l(n,j))}else if(r===7){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(D(n,L,2),l(n,K))+Math.max(l(n,L),l(n,K),l(n,w),l(n,j))}else if(r===8){if(!("MAT"in n&&"BIO"in n))return s();a=n.MAT+n.BIO+Math.max(n.PHY??0,n.CHE??0)+Math.max(D(n,L,3),l(n,K),l(n,w),l(n,j))}else if(r===9){if(!("MAT"in n))return s();a=n.MAT+l(n,L)+D(n,L,2)+Math.max(D(n,L,3),l(n,K),l(n,w),l(n,j))}else if(r===10){if(!("MAT"in n))return s();a=n.MAT+l(n,L)+l(n,K)+Math.max(D(n,L,2),D(n,K,2),l(n,w),l(n,j))}else if(r===11)a=Math.max((n.CHE??0)+Math.max(n.MAT??0,n.PHY??0)+Math.max(n.BIO??0,n.HSC??0)+Math.max(l(n,["ENG","KIS"]),l(n,K),l(n,w),l(n,j)),Math.max(n.BIO??0,n.GSC??0)+(n.MAT??0)+Math.max(l(n,L),l(n,K))+Math.max(l(n,["ENG","KIS"]),l(n,L),l(n,K),l(n,w),l(n,j)));else if(r===12||r===13){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0)+Math.max(l(n,["ENG","KIS"]),D(n,L,3),l(n,K),l(n,w),l(n,j))}else if(r===14){if(!("CHE"in n))return s();a=Math.max(n.BIO??0,n.AGR??0,n.HSC??0)+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.GEO??0)+Math.max(l(n,["ENG","KIS"]),l(n,K),l(n,w),l(n,j))}else if(r===15){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.AGR??0)+Math.max(l(n,["ENG","KIS"]),l(n,K),l(n,w),l(n,j))}else if(r===16){if(!("GEO"in n))return s();a=n.GEO+(n.MAT??0)+l(n,L)+Math.max(D(n,L,2),D(n,K,2),l(n,w),l(n,j))}else if(r===17){if(!("FRE"in n||"GER"in n))return s();a=l(n,["FRE","GER"])+l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L),l(n,K))+Math.max(l(n,L),l(n,K),l(n,w),D(n,j,2))}else if(r===18){if(!("MUS"in n))return s();a=n.MUS+l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L),l(n,K))+Math.max(l(n,L),l(n,K),l(n,w),D(n,j,2))}else if(r===19)a=l(n,Rn)+D(n,Rn,2)+D(n,Rn,3)+D(n,Rn,4);else if(r===20){if(!(n.CRE||n.IRE||n.HRE))return s();a=l(n,["CRE","IRE","HRE"])+l(n,["ENG","KIS"])+D(n,K,2)+Math.max(l(n,L),l(n,w),l(n,j))}else return s();return Ke(a,t)},xe=r=>{const i={};for(let n=1;n<=20;n+=1)i[n]=Le(n,r);return i},Qn="kuccps.cluster.sessions",nn={catalog:"/api/catalog",adminCatalogUpload:"/api/admin/catalog/upload",adminCatalogCourse:"/api/admin/catalog/course",sessions:"/api/sessions",adminSessions:"/api/admin/sessions",adminSessionsBulkDelete:"/api/admin/sessions/delete-many",adminMe:"/api/admin/me"},gn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Gn=async r=>{const i=await on(r,{method:"GET",credentials:"include"}),n=await gn(i);return{ok:i.ok,status:i.status,data:n}},Cn=async(r,i)=>{const n=await on(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await gn(n);return{ok:n.ok,status:n.status,data:t}},pe=async(r,i)=>{const n=await on(r,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await gn(n);return{ok:n.ok,status:n.status,data:t}},Ge=async r=>{const i=await on(r,{method:"DELETE",credentials:"include"}),n=await gn(i);return{ok:i.ok,status:i.status,data:n}},en=(r,i)=>{const n=(r==null?void 0:r.data)||{};return String((n==null?void 0:n.error)||(n==null?void 0:n.message)||i)},Nn=r=>String(r||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,""),Tn=r=>{const i=r&&typeof r=="object"?r:{},n={};for(let t=1;t<=20;t+=1){const s=Number(i[t]??i[String(t)]??0);n[t]=Number.isFinite(s)?s:0}return n},Fn=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=String(n||"").trim().toUpperCase(),a=String(t||"").trim().toUpperCase();!s||!a||(i[s]=a)}),i},Fe=(r,i)=>{if(!i||String(r||"").trim().toUpperCase()!=="BACHELOR OF SCIENCE CLINICAL MEDICINE")return i;const n=i.replace(/\s+/g," ").trim();return/^mathematics\s*\/\s*physics$/i.test(n)?"Mathematics":i},He=(r,i)=>{const n={};return Object.entries(i||{}).forEach(([t,s])=>{const a=Fe(r,String(t||"").trim()),I=String(s||"").trim().toUpperCase();!a||!I||(n[a]=I)}),n},vn=()=>{if(typeof window>"u")return{};try{const r=window.localStorage.getItem(Qn);if(!r)return{};const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}},Xn=r=>{typeof window>"u"||window.localStorage.setItem(Qn,JSON.stringify(r||{}))},un="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",Be=(r=8)=>{if(typeof crypto<"u"&&crypto.getRandomValues){const n=new Uint8Array(r);return crypto.getRandomValues(n),Array.from(n,t=>un[t%un.length]).join("")}let i="";for(let n=0;n<r;n+=1){const t=Math.floor(Math.random()*un.length);i+=un[t]}return i},we=()=>{const r=vn();for(let i=0;i<20;i+=1){const n=Be();if(!r[n])return n}throw new Error("Unable to generate a local access code.")},je=r=>{const i=vn();i[r.code]=r,Xn(i)},Pe=(r,i="")=>({name:(r==null?void 0:r.name)||i,requirements:He((r==null?void 0:r.name)||i,(r==null?void 0:r.requirements)||{}),universities:Array.isArray(r==null?void 0:r.universities)?r.universities.map(n=>({name:String((n==null?void 0:n.name)||""),cutoff:Number((n==null?void 0:n.cutoff)??0),courseCode:String((n==null?void 0:n.courseCode)||"")})):[]}),De=r=>(Array.isArray(r)?r:Object.values(r||{})).map(n=>Pe(n)).filter(n=>!!n.name),ke=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);!Number.isInteger(s)||s<1||(i[s]=De(t))}),i},Je=()=>!0,qe=async()=>{const r=await Gn(nn.catalog);if(!r.ok)throw new Error(en(r,"Unable to load course catalog from backend."));return ke(r.data||{})},$e=async r=>{if(!r||typeof r!="object")throw new Error("Invalid course catalog payload.");const i=await Cn(nn.adminCatalogUpload,r);if(!i.ok)throw new Error(en(i,"Unable to upload course catalog to backend."))},_e=async({cluster:r,name:i,requirements:n,universities:t})=>{const s=await Cn(nn.adminCatalogCourse,{cluster:r,name:i,requirements:n,universities:t});if(!s.ok)throw new Error(en(s,"Unable to save course entry to backend."));return s.data||{}},We=async({code:r,email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N})=>{const A={email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N};r&&(A.code=r);const T=await Cn(nn.sessions,A);if(!T.ok)throw new Error(en(T,"Unable to save session to backend."));const c=T.data||{};return{code:Nn(c.code),email:String(c.email||"").trim(),phoneNumber:String(c.phoneNumber||"").trim(),amountPaid:Number(c.amountPaid??0),grades:Fn(c.grades),results:Tn(c.results),medicineEligible:!!c.medicineEligible,paymentResponse:c.paymentResponse||null,createdAt:String(c.createdAt||""),updatedAt:String(c.updatedAt||""),storage:"firebase"}},ne=async()=>{const r=vn(),i=Object.entries(r);if(!i.length)return 0;let n=0;const t={...r};for(const[s,a]of i)try{const I={code:Nn(a.code||s),email:String(a.email||"").trim(),phoneNumber:String(a.phoneNumber||"").trim(),amountPaid:Number(a.amountPaid??0),grades:a.grades||{},results:a.results||{},medicineEligible:!!a.medicineEligible,paymentResponse:a.paymentResponse||null},N=await Cn(nn.sessions,I);if(!N.ok)throw new Error(en(N,"Unable to sync session to backend."));delete t[s],n+=1}catch{}return n>0&&Xn(t),n},ze=async r=>{try{const i=await We(r);return ne().catch(()=>{}),{session:i,storage:"firebase",warning:""}}catch(i){const n=new Date().toISOString(),s={code:we(),email:String((r==null?void 0:r.email)||"").trim(),phoneNumber:String((r==null?void 0:r.phoneNumber)||"").trim(),amountPaid:Number((r==null?void 0:r.amountPaid)??0),grades:(r==null?void 0:r.grades)||{},results:Tn((r==null?void 0:r.results)||{}),medicineEligible:!!(r!=null&&r.medicineEligible),paymentResponse:(r==null?void 0:r.paymentResponse)||null,createdAt:n,updatedAt:n,storage:"local"};return je(s),{session:s,storage:"local",warning:(i==null?void 0:i.message)||"Backend save failed. Session saved locally on this browser only."}}},Ze=async r=>{const i=Nn(r);if(!i)return null;const n=await Gn(`${nn.sessions}/${i}`);if(n.ok&&n.data){const s=n.data;return{code:i,email:String(s.email||"").trim(),phoneNumber:String(s.phoneNumber||"").trim(),amountPaid:Number(s.amountPaid??0),grades:Fn(s.grades),results:Tn(s.results),medicineEligible:!!s.medicineEligible,paymentResponse:s.paymentResponse||null,createdAt:String(s.createdAt||""),updatedAt:String(s.updatedAt||""),storage:"firebase"}}const t=vn()[i];if(t)return{code:i,email:t.email||"",phoneNumber:t.phoneNumber||"",amountPaid:Number(t.amountPaid??0),grades:t.grades||{},results:Tn(t.results||{}),medicineEligible:!!t.medicineEligible,paymentResponse:t.paymentResponse||null,createdAt:t.createdAt||"",updatedAt:t.updatedAt||"",storage:"local"};if(n.status!==404)throw new Error(en(n,"Unable to load session from backend."));return null},Qe=async()=>{const r=await Gn(nn.adminSessions);if(!r.ok)throw new Error(en(r,"Unable to load calculated sessions from backend."));return(Array.isArray(r.data)?r.data:[]).map(n=>({code:Nn(n.code),email:String(n.email||"").trim(),phoneNumber:String(n.phoneNumber||"").trim(),amountPaid:Number(n.amountPaid??0),createdAt:String(n.createdAt||""),updatedAt:String(n.updatedAt||""),medicineEligible:!!n.medicineEligible,grades:Fn(n.grades),results:Tn(n.results),paymentResponse:n.paymentResponse||null,storage:"firebase"})).filter(n=>n.code).sort((n,t)=>(Date.parse(t.createdAt||"")||0)-(Date.parse(n.createdAt||"")||0))},Xe=async(r,i={})=>{const n=Nn(r);if(!n)throw new Error("Session code is required.");const t=await pe(`${nn.adminSessions}/${n}`,i);if(!t.ok)throw new Error(en(t,"Unable to update session."))},nr=async r=>{const i=Nn(r);if(!i)throw new Error("Session code is required.");const n=await Ge(`${nn.adminSessions}/${i}`);if(!n.ok)throw new Error(en(n,"Unable to delete session."))},er=async(r=[])=>{var n;const i=await Cn(nn.adminSessionsBulkDelete,{codes:Array.isArray(r)?r:[]});if(!i.ok)throw new Error(en(i,"Unable to delete selected sessions."));return Number(((n=i.data)==null?void 0:n.deleted)??0)},In={courseName:"COURSE NAME",cluster:"CLUSTER",courseCode:"COURSE CODE",university:"UNIVERSITY",cutoff:"CUT-OFF POINTS",requirements:"MINIMUM SUBJECT REQUIREMENTS"},sn=r=>String(r??"").replace(/\u00a0/g," ").trim(),rr=r=>{const i=sn(r).replace(/,/g,"");if(!i||i==="-")return 0;const n=Number.parseFloat(i);return Number.isFinite(n)?n:0},qn=r=>{const i=sn(r);if(!i||/^none$/i.test(i)||i==="-")return[];const n=[];return i.split(/\r?\n|;/).map(t=>t.trim()).filter(Boolean).forEach(t=>{if(/^none$/i.test(t)||t==="-")return;const s=t.indexOf(":");if(s<0)return;const a=t.slice(0,s).trim(),I=t.slice(s+1).trim().toUpperCase();!a||!I||I==="-"||n.push({subject:a,grade:I})}),n},ir=(r,i)=>{if(!i||String(r||"").trim().toUpperCase()!=="BACHELOR OF SCIENCE CLINICAL MEDICINE")return i;const n=i.replace(/\s+/g," ").trim();return/^mathematics\s*\/\s*physics$/i.test(n)?"Mathematics":i},tr=(r,i=[])=>{const n=[];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=ir(r,t.subject);if(!s)return;const a=String(t.grade||"").trim().toUpperCase();if(!a)return;const I=n.findIndex(N=>N.subject===s);I>=0?n[I]={subject:s,grade:a}:n.push({subject:s,grade:a})}),n},sr=(r=[],i=[])=>{const n=[...r];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=n.findIndex(a=>a.subject===t.subject);s>=0?n[s]=t:n.push(t)}),n},ar=r=>{const i=new Set,n=[];return r.forEach(t=>{const s=`${t.name}|${t.courseCode}`;!t.name||i.has(s)||(i.add(s),n.push(t))}),n},or=r=>Object.values(In).some(i=>sn(r==null?void 0:r[i])),ee=r=>{const i=ie.parse(r,{header:!0,skipEmptyLines:!1});if(!Array.isArray(i.data)||!i.data.length)throw new Error("CSV has no records.");const n={};let t=null;const s=()=>{t&&(n[t.cluster]||(n[t.cluster]=[]),n[t.cluster].push({name:t.name,requirements:tr(t.name,t.requirements),universities:ar(t.universities)}),t=null)};if(i.data.forEach(a=>{if(!a||typeof a!="object"||!or(a))return;const I=sn(a[In.courseName]),N=sn(a[In.cluster]),A=sn(a[In.courseCode]),T=sn(a[In.university]),c=sn(a[In.cutoff]),d=sn(a[In.requirements]),y=Number(N);if(!!(I&&Number.isInteger(y)&&y>0))s(),t={name:I,cluster:y,requirements:qn(d),universities:[]};else if(!t)return;d&&(t.requirements=sr(t.requirements,qn(d))),(T||A||c)&&t.universities.push({name:T||"Unknown University",courseCode:A,cutoff:rr(c)})}),s(),!Object.keys(n).length)throw new Error("CSV did not produce a valid course catalog.");return n},Er=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}},Ir=`COURSE NAME,CLUSTER,COURSE CODE,UNIVERSITY,CUT-OFF POINTS,MINIMUM SUBJECT REQUIREMENTS\r
...
,,1114488,University of Eldoret,15.092,\r
,,1093488,University of Embu,15.092,\r
`,lr=r=>{if(!Array.isArray(r))return{};const i={};return r.forEach(n=>{const t=String((n==null?void 0:n.subject)||"").trim(),s=String((n==null?void 0:n.grade)||"").trim().toUpperCase();!t||!s||(i[t]=s)}),i},cr=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);if(!Number.isInteger(s)||s<1)return;const a=Array.isArray(t)?t:[];i[s]=a.map(I=>({name:String((I==null?void 0:I.name)||"").trim(),requirements:lr(I==null?void 0:I.requirements),universities:Array.isArray(I==null?void 0:I.universities)?I.universities.map(N=>({name:String((N==null?void 0:N.name)||"").trim(),courseCode:String((N==null?void 0:N.courseCode)||"").trim(),cutoff:Number((N==null?void 0:N.cutoff)??0)})).filter(N=>!!N.name):[]})).filter(I=>!!I.name)}),i};let dn=null;const $n=()=>{if(dn)return dn;const r=ee(Ir);return dn=cr(r),dn},Nr=({mode:r="public"}={})=>{const[i,n]=E.useState({}),[t,s]=E.useState(!0),[a,I]=E.useState(""),N=E.useCallback(async()=>{if(s(!0),r!=="admin"){try{const c=$n();n(c),I("")}catch(c){n({}),I((c==null?void 0:c.message)||"Unable to load bundled course catalog.")}finally{s(!1)}return}try{const c=await qe();n(c),I("")}catch(c){const d=$n();n(d);const y=(c==null?void 0:c.message)||"Unable to load courses from realtime database.";I(`${y} Showing bundled courses until backend connection is available.`)}finally{s(!1)}},[r]),A=E.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await $e(c),I(""),await N()},[N,r]),T=E.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await _e(c),I(""),await N()},[N,r]);return E.useEffect(()=>{N().catch(()=>{})},[N]),{courseCatalog:i,catalogLoading:t,courseCatalogError:a,loadCatalog:N,saveCatalog:A,saveSingleCourse:T}};function Ur({isAuthenticated:r,onLogin:i,onGoogleLogin:n,authError:t,isLoading:s}){const a=mn(),[I,N]=E.useState(""),[A,T]=E.useState(""),[c,d]=E.useState(!1),[y,u]=E.useState("");if(r)return e.jsx(En,{to:"/admin",replace:!0});const x=async h=>{h.preventDefault(),u("");const C=await i(I,A);if(C.success){a("/admin");return}u(C.error||"Invalid admin credentials.")},O=async()=>{u("");const h=await n();if(h.success){a("/admin");return}u(h.error||"Google sign-in failed.")};return e.jsxs("section",{className:"mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Admin Login"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Only admins can upload course data to Firebase."}),e.jsxs("form",{onSubmit:x,className:"mt-6 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"admin_email",type:"email",value:I,onChange:h=>N(h.target.value),required:!0,className:"ui-input",placeholder:"admin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{id:"admin_password",type:c?"text":"password",value:A,onChange:h=>T(h.target.value),required:!0,className:"ui-input pr-20"}),e.jsx("button",{type:"button",onClick:()=>d(h=>!h),className:"absolute right-2 top-1/2 -translate-y-1/2 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-600 transition hover:bg-slate-50",children:c?"Hide":"View"})]})]}),e.jsx(F,{tone:"danger",message:y}),e.jsx(F,{tone:"danger",message:t}),e.jsx("button",{type:"submit",disabled:s,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:s?"Signing in...":"Login"}),e.jsxs("div",{className:"relative py-1",children:[e.jsx("div",{className:"absolute inset-0 flex items-center",children:e.jsx("span",{className:"w-full border-t border-slate-200"})}),e.jsx("div",{className:"relative flex justify-center",children:e.jsx("span",{className:"bg-white px-2 text-xs text-slate-500",children:"OR"})})]}),e.jsx("button",{type:"button",onClick:O,disabled:s,className:"inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Continue with Google"})]})]})}const Ar="/assets/courses-CtX9VR_p.csv",Tr=r=>new Promise((i,n)=>{const t=new FileReader;t.onload=()=>i(String(t.result||"")),t.onerror=()=>n(new Error("Unable to read selected file.")),t.readAsText(r)});function yr({firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:n}){const[t,s]=E.useState(""),[a,I]=E.useState(""),[N,A]=E.useState(!1),[T,c]=E.useState(null),d=async(O,h)=>{s(""),I(""),A(!0);try{const C=ee(O);await i(C);const f=Er(C);I(`${h} uploaded: ${f.clusters} clusters, ${f.courses} courses, ${f.universities} universities.`)}catch(C){s(C.message||"Failed to upload course catalog.")}finally{A(!1)}},y=async()=>{if(!T){s("Select a CSV file first.");return}try{const O=await Tr(T);await d(O,T.name)}catch(O){s(O.message||"Failed to read selected CSV file.")}},u=async()=>{try{const O=await fetch(n);if(!O.ok)throw new Error(`Unable to load bundled CSV (status ${O.status}).`);const h=await O.text();await d(h,"courses.csv")}catch(O){s(O.message||"Failed to upload bundled courses.csv.")}},x=O=>{var h;c(((h=O.target.files)==null?void 0:h[0])||null)};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight",children:"Courses Upload"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Upload a `courses.csv` compatible file through backend API into Firebase realtime database. Uploading replaces the entire catalog (existing courses are deleted)."}),r?null:e.jsx(F,{className:"mt-4",tone:"warning",message:"Backend Firebase integration is not available."}),e.jsxs("div",{className:"mt-5 flex flex-col gap-3 sm:flex-row sm:items-end",children:[e.jsxs("div",{className:"w-full sm:max-w-md",children:[e.jsx("label",{htmlFor:"admin_csv_upload",className:"mb-1 block text-sm font-medium text-slate-700",children:"Select CSV file"}),e.jsx("input",{id:"admin_csv_upload",type:"file",accept:".csv,text/csv",onChange:x,className:"ui-file-input"})]}),e.jsx("button",{type:"button",onClick:y,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Replace With Selected CSV"}),e.jsx("button",{type:"button",onClick:u,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Replace With Bundled courses.csv"})]}),e.jsx(F,{className:"mt-3",tone:"danger",message:t}),e.jsx(F,{className:"mt-3",tone:"success",message:a})]})}const _n={name:"",email:"",password:""},Cr={cluster:"",name:"",requirementsText:"",universityName:"",courseCode:"",cutoff:""},Sr=r=>{const i={};return String(r||"").split(/\r?\n|;/).map(n=>n.trim()).filter(Boolean).forEach(n=>{const t=n.indexOf(":");if(t<0)return;const s=n.slice(0,t).trim(),a=n.slice(t+1).trim().toUpperCase();!s||!a||(i[s]=a)}),i},Rr=r=>{const i=Object.entries(r||{});return i.length?i.map(([n,t])=>({subject:String(n||"").trim(),grade:String(t||"").trim().toUpperCase()})).filter(n=>n.subject&&n.grade).sort((n,t)=>n.subject.localeCompare(t.subject)).map(n=>`${n.subject}: ${n.grade}`).join(", "):"None"},ur=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a==null?void 0:a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}};function dr({firebaseConfigured:r,onUploadCatalog:i,onAddSingleCourse:n,onLogout:t,onAddRegularAdmin:s,adminProfile:a,adminEmail:I,authError:N,courseCatalog:A}){const[T,c]=E.useState(_n),[d,y]=E.useState(!1),[u,x]=E.useState(""),[O,h]=E.useState(""),[C,f]=E.useState(Cr),[Y,g]=E.useState(!1),[H,B]=E.useState(""),[Z,Q]=E.useState(""),[_,rn]=E.useState(""),[q,P]=E.useState("all"),$=(a==null?void 0:a.role)==="super",W=E.useMemo(()=>ur(A),[A]),z=E.useMemo(()=>{const U=[];return Object.entries(A||{}).forEach(([V,G])=>{const X=Number(V);!Number.isInteger(X)||X<1||Array.isArray(G)&&G.forEach(J=>{const o=String((J==null?void 0:J.name)||"").trim();o&&U.push({cluster:X,name:o,requirements:(J==null?void 0:J.requirements)||{},universities:Array.isArray(J==null?void 0:J.universities)?J.universities.length:0})})}),U.sort((V,G)=>V.cluster-G.cluster||V.name.localeCompare(G.name))},[A]),R=E.useMemo(()=>{const U=new Set;return z.forEach(V=>U.add(V.cluster)),Array.from(U).sort((V,G)=>V-G)},[z]),M=E.useMemo(()=>{const U=_.trim().toLowerCase(),V=q==="all"?null:Number(q);return z.filter(G=>V&&G.cluster!==V?!1:U?G.name.toLowerCase().includes(U):!0)},[z,q,_]),m=(U,V)=>{c(G=>({...G,[U]:V}))},v=(U,V)=>{f(G=>({...G,[U]:V}))},p=async U=>{if(U.preventDefault(),x(""),h(""),!$){x("Only a super admin can add regular admins.");return}if(!T.email||!T.password){x("Email and password are required.");return}y(!0);try{const V=await s({name:T.name,email:T.email,password:T.password});h(`Regular admin added: ${V.user.email}`),c(_n)}catch(V){x(V.message||"Unable to add regular admin.")}finally{y(!1)}},an=async U=>{if(U.preventDefault(),B(""),Q(""),!r){B("Firebase is not configured.");return}const V=Number(C.cluster);if(!Number.isInteger(V)||V<1){B("Cluster must be a whole number greater than 0.");return}const G=String(C.name||"").trim();if(!G){B("Course name is required.");return}const X=String(C.universityName||"").trim();if(!X){B("University name is required.");return}const J=String(C.cutoff||"").trim(),o=J?Number(J):0;if(!Number.isFinite(o)||o<0){B("Cutoff must be a number equal to or greater than 0.");return}g(!0);try{await n({cluster:V,name:G,requirements:Sr(C.requirementsText),universities:[{name:X,courseCode:String(C.courseCode||"").trim(),cutoff:o}]}),Q(`Saved "${G}" in cluster ${V}.`),f(S=>({...S,universityName:"",courseCode:"",cutoff:""}))}catch(S){B(S.message||"Unable to save course.")}finally{g(!1)}};return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:[e.jsx("div",{className:"pointer-events-none absolute -top-14 -right-12 h-44 w-44 rounded-full bg-cyan-200/40 blur-2xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-10 -left-10 h-36 w-36 rounded-full bg-emerald-200/50 blur-2xl"}),e.jsxs("div",{className:"relative",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Control Center"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Admin Dashboard"}),e.jsx("p",{className:"mt-2 max-w-2xl text-sm text-slate-600",children:"Manage admins and maintain course catalog content for calculator results and eligibility checks."}),e.jsxs("p",{className:"mt-3 text-xs font-medium text-slate-500",children:["Signed in as: ",I||"unknown"," (",(a==null?void 0:a.role)||"regular"," admin)"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(cn,{to:"/admin/sessions",className:"inline-flex items-center justify-center rounded-xl border border-cyan-300 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-100",children:"View Calculated Users"}),e.jsx("button",{type:"button",onClick:t,className:"inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:"Logout"})]})]}),e.jsxs("div",{className:"mt-5 grid gap-3 sm:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Clusters"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:W.clusters})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Courses"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:W.courses})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"University Entries"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:W.universities})]})]})]}),e.jsx(F,{className:"mt-3",tone:"danger",message:N})]}),e.jsxs("div",{className:"grid gap-6 xl:grid-cols-2",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Admin Users"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Create regular admin accounts that can log in and access admin tools."}),$?null:e.jsx(F,{className:"mt-3",tone:"warning",message:"Only a super admin can add regular admin users."}),e.jsxs("form",{onSubmit:p,className:"mt-5 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Full Name"}),e.jsx("input",{id:"regular_admin_name",type:"text",value:T.name,onChange:U=>m("name",U.target.value),className:"ui-input",placeholder:"Admin Name"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"regular_admin_email",type:"email",value:T.email,onChange:U=>m("email",U.target.value),required:!0,className:"ui-input",placeholder:"newadmin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsx("input",{id:"regular_admin_password",type:"password",value:T.password,onChange:U=>m("password",U.target.value),required:!0,minLength:6,className:"ui-input",placeholder:"At least 6 characters"})]}),e.jsx("div",{className:"md:col-span-3",children:e.jsx("button",{type:"submit",disabled:!$||d,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-600 disabled:cursor-not-allowed disabled:bg-slate-400",children:d?"Creating...":"Add Regular Admin"})})]}),e.jsx(F,{className:"mt-3",tone:"danger",message:u}),e.jsx(F,{className:"mt-3",tone:"success",message:O})]}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Add Single Course"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Add one course entry at a time. If the course already exists in the same cluster, the university entry is merged into it."}),r?null:e.jsx(F,{className:"mt-3",tone:"warning",message:"Firebase is not configured for catalog writes."}),e.jsxs("form",{onSubmit:an,className:"mt-5 grid gap-4 md:grid-cols-2",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cluster"}),e.jsx("input",{id:"single_course_cluster",type:"number",min:1,value:C.cluster,onChange:U=>v("cluster",U.target.value),required:!0,className:"ui-input",placeholder:"e.g. 2"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Name"}),e.jsx("input",{id:"single_course_name",type:"text",value:C.name,onChange:U=>v("name",U.target.value),required:!0,className:"ui-input",placeholder:"BACHELOR OF COMMERCE"})]}),e.jsxs("div",{className:"md:col-span-2",children:[e.jsx("label",{htmlFor:"single_course_requirements",className:"mb-1 block text-sm font-medium text-slate-700",children:"Minimum Subject Requirements"}),e.jsx("textarea",{id:"single_course_requirements",value:C.requirementsText,onChange:U=>v("requirementsText",U.target.value),rows:4,className:"ui-textarea",placeholder:`Mathematics: C+
English/Kiswahili: B`})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_university",className:"mb-1 block text-sm font-medium text-slate-700",children:"University"}),e.jsx("input",{id:"single_course_university",type:"text",value:C.universityName,onChange:U=>v("universityName",U.target.value),required:!0,className:"ui-input",placeholder:"University of Nairobi"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_code",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Code"}),e.jsx("input",{id:"single_course_code",type:"text",value:C.courseCode,onChange:U=>v("courseCode",U.target.value),className:"ui-input",placeholder:"1263134"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cutoff",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cutoff Points"}),e.jsx("input",{id:"single_course_cutoff",type:"number",step:"0.001",min:0,value:C.cutoff,onChange:U=>v("cutoff",U.target.value),className:"ui-input",placeholder:"32.613"})]}),e.jsx("div",{className:"md:col-span-2",children:e.jsx("button",{type:"submit",disabled:Y||!r,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-emerald-500 enabled:hover:to-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:Y?"Saving...":"Save Course Entry"})})]}),e.jsx(F,{className:"mt-3",tone:"danger",message:H}),e.jsx(F,{className:"mt-3",tone:"success",message:Z})]})]}),e.jsx(yr,{firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:Ar}),e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Course Requirements"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Review subject requirements per course to verify catalog accuracy."})]}),e.jsxs("div",{className:"text-xs font-medium text-slate-500",children:["Showing ",M.length," of ",z.length," courses"]})]}),e.jsxs("div",{className:"mt-4 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_course_search",className:"mb-1 block text-sm font-medium text-slate-700",children:"Search course"}),e.jsx("input",{id:"admin_course_search",type:"text",value:_,onChange:U=>rn(U.target.value),className:"ui-input",placeholder:"e.g. Clinical Medicine"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Filter by cluster"}),e.jsxs("select",{id:"admin_course_cluster",value:q,onChange:U=>P(U.target.value),className:"ui-select",children:[e.jsx("option",{value:"all",children:"All clusters"}),R.map(U=>e.jsxs("option",{value:U,children:["Cluster ",U]},U))]})]})]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Subject Requirements"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Universities"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:M.map(U=>e.jsxs("tr",{className:"hover:bg-slate-50/70",children:[e.jsxs("td",{className:"px-3 py-2 font-medium text-slate-900",children:["Cluster ",U.cluster]}),e.jsx("td",{className:"px-3 py-2",children:U.name}),e.jsx("td",{className:"px-3 py-2 text-slate-600",children:Rr(U.requirements)}),e.jsx("td",{className:"px-3 py-2 text-slate-600",children:U.universities})]},`${U.cluster}-${U.name}`))})]})})]})]})}const An=20,Or=["BIO","CHE","MAT","PHY"],On={code:"",email:"",phoneNumber:"",amountPaid:"0",medicineEligible:!1},mr=r=>{if(!r)return"Unknown";const i=Date.parse(r);return Number.isFinite(i)?new Date(i).toLocaleString():"Unknown"},bn=r=>{const i=Number(r);return Number.isFinite(i)?i.toFixed(3):"0.000"},re=r=>{const i=r&&typeof r=="object"?r:{};return Array.from({length:20},(n,t)=>{const s=t+1;return{cluster:s,score:Number(i[s]??i[String(s)]??0)}}).map(n=>({...n,score:Number.isFinite(n.score)?n.score:0}))},hr=(r,i=3)=>re(r).sort((n,t)=>t.score-n.score||n.cluster-t.cluster).slice(0,i),gr=r=>[r.code,r.email,r.phoneNumber,r.amountPaid,r.createdAt,r.medicineEligible?"eligible":"not-eligible"].join(" ").toLowerCase(),vr=(r,i)=>{if(i<=7)return Array.from({length:i},(t,s)=>s+1);const n=Math.max(1,Math.min(r-3,i-6));return Array.from({length:7},(t,s)=>n+s)};function Yr({firebaseConfigured:r}){const[i,n]=E.useState([]),[t,s]=E.useState(!0),[a,I]=E.useState(""),[N,A]=E.useState(""),[T,c]=E.useState(""),[d,y]=E.useState(""),[u,x]=E.useState(""),[O,h]=E.useState([]),[C,f]=E.useState(1),[Y,g]=E.useState(On),[H,B]=E.useState(!1),[Z,Q]=E.useState(!1),[_,rn]=E.useState(""),q=E.useCallback(async()=>{if(!r){s(!1),I("Firebase is not configured."),n([]);return}s(!0),I("");try{const o=await Qe();n(o)}catch(o){I(o.message||"Unable to load cluster sessions."),n([])}finally{s(!1)}},[r]);E.useEffect(()=>{q().catch(()=>{})},[q]);const P=E.useMemo(()=>{const o=String(d||"").trim().toLowerCase();return o?i.filter(S=>gr(S).includes(o)):i},[d,i]),$=E.useMemo(()=>Math.max(1,Math.ceil(P.length/An)),[P.length]),W=E.useMemo(()=>{const o=(C-1)*An;return P.slice(o,o+An)},[C,P]);E.useMemo(()=>{const o=new Set(P.map(b=>b.email||b.phoneNumber||b.code)).size,S=P.filter(b=>b.medicineEligible).length;return{totalSessions:P.length,uniqueUsers:o,medicineQualifiedCount:S}},[P]);const z=E.useMemo(()=>new Set(O),[O]),R=E.useMemo(()=>W.map(o=>o.code),[W]),M=R.length>0&&R.every(o=>z.has(o));E.useEffect(()=>{f(1)},[d]),E.useEffect(()=>{C>$&&f($)},[C,$]),E.useEffect(()=>{const o=new Set(P.map(S=>S.code));h(S=>S.filter(b=>o.has(b))),u&&!o.has(u)&&x(""),Y.code&&!o.has(Y.code)&&g(On)},[Y.code,u,P]);const m=o=>{h(S=>{const b=new Set(S);return b.has(o)?b.delete(o):b.add(o),Array.from(b)})},v=()=>{h(o=>{const S=new Set(o);return M?R.forEach(b=>S.delete(b)):R.forEach(b=>S.add(b)),Array.from(S)})},p=()=>{H||g(On)},an=async o=>{if(o.preventDefault(),!Y.code)return;A(""),c("");const S=Number(Y.amountPaid);if(!Number.isFinite(S)||S<0){A("Amount paid must be a valid number equal to or greater than 0.");return}B(!0);try{await Xe(Y.code,{email:Y.email,phoneNumber:Y.phoneNumber,amountPaid:S,medicineEligible:Y.medicineEligible}),c(`Session ${Y.code} updated successfully.`),g(On),await q()}catch(b){A(b.message||"Unable to update session.")}finally{B(!1)}},U=async o=>{if(o&&(A(""),c(""),!!window.confirm(`Delete session ${o}?`))){rn(o);try{await nr(o),c(`Session ${o} deleted.`),h(S=>S.filter(b=>b!==o)),u===o&&x(""),await q()}catch(S){A(S.message||"Unable to delete session.")}finally{rn("")}}},V=async()=>{if(O.length&&(A(""),c(""),!!window.confirm(`Delete ${O.length} selected session(s)?`))){Q(!0);try{const o=await er(O);c(`${o} session(s) deleted.`),h([]),u&&O.includes(u)&&x(""),await q()}catch(o){A(o.message||"Unable to delete selected sessions.")}finally{Q(!1)}}},G=E.useMemo(()=>vr(C,$),[C,$]),X=P.length?(C-1)*An+1:0,J=Math.min(P.length,C*An);return e.jsxs("section",{className:"space-y-6",children:[e.jsx("div",{className:"rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Admin Analytics"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Calculated Users Table"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Review users who calculated cluster points and manage records safely."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{type:"button",onClick:()=>q(),className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:[e.jsx(te,{className:"h-4 w-4"}),"Refresh"]}),e.jsxs(cn,{to:"/admin",className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-600",children:[e.jsx(se,{className:"h-4 w-4"}),"Back to Admin"]})]})]})}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"User Calculations"}),e.jsxs("div",{className:"flex w-full flex-wrap items-center justify-end gap-2 lg:w-auto",children:[e.jsx("input",{type:"search",value:d,onChange:o=>y(o.target.value),placeholder:"Search by email, code, phone...",className:"ui-input w-full max-w-sm"}),e.jsxs("button",{type:"button",onClick:v,disabled:!R.length,className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[M?e.jsx(ae,{className:"h-4 w-4"}):e.jsx(wn,{className:"h-4 w-4"}),M?"Unselect Page":"Select Page"]}),e.jsxs("button",{type:"button",onClick:V,disabled:!O.length||Z,className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-rose-600 px-3 py-2 text-sm font-semibold text-white transition enabled:hover:bg-rose-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(jn,{className:"h-4 w-4"}),Z?"Deleting...":`Delete Selected (${O.length})`]})]})]}),e.jsx(F,{className:"mt-3",tone:"danger",message:a}),e.jsx(F,{className:"mt-3",tone:"danger",message:N}),e.jsx(F,{className:"mt-3",tone:"success",message:T}),t?e.jsx(F,{className:"mt-3",tone:"info",message:"Loading sessions..."}):null,e.jsx("div",{className:"mt-4 overflow-x-auto",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-xs uppercase tracking-wider text-slate-500",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-3 font-semibold",children:e.jsx("input",{type:"checkbox",checked:M,onChange:v,"aria-label":"Select all on current page",className:"ui-checkbox"})}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Date"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Access Code"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"User"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Best Cluster"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Top 3 Cluster Points"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Actions"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-200 bg-white text-slate-700",children:[!t&&!W.length?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-3 py-8 text-center text-sm text-slate-500",children:"No calculation sessions found."})}):null,W.map(o=>{const S=hr(o.results),b=S[0],Vn=Object.entries(o.grades||{}).filter(([,k])=>k),Hn=_===o.code;return e.jsxs(E.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsx("input",{type:"checkbox",checked:z.has(o.code),onChange:()=>m(o.code),"aria-label":`Select ${o.code}`,className:"ui-checkbox"})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:mr(o.createdAt)}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3 font-mono font-semibold text-slate-900",children:o.code}),e.jsxs("td",{className:"px-3 py-3",children:[e.jsx("p",{className:"font-medium text-slate-900",children:o.email||"No email"}),e.jsx("p",{className:"text-xs text-slate-500",children:o.phoneNumber||"No phone"})]}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:b?`C${b.cluster}: ${bn(b.score)}`:"N/A"}),e.jsx("td",{className:"px-3 py-3",children:e.jsx("div",{className:"flex flex-wrap gap-1.5",children:S.map(k=>e.jsxs("span",{className:"rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-medium text-slate-700",children:["C",k.cluster,": ",bn(k.score)]},`${o.code}-${k.cluster}`))})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>x(k=>k===o.code?"":o.code),className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-100",children:[u===o.code?e.jsx(oe,{className:"h-3.5 w-3.5"}):e.jsx(Ee,{className:"h-3.5 w-3.5"}),u===o.code?"Hide":"View"]}),e.jsxs("button",{type:"button",onClick:()=>U(o.code),disabled:Hn,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-rose-300 bg-rose-50 px-2.5 py-1.5 text-xs font-semibold text-rose-700 transition enabled:hover:bg-rose-100 disabled:cursor-not-allowed disabled:text-rose-400",children:[e.jsx(jn,{className:"h-3.5 w-3.5"}),Hn?"Deleting...":"Delete"]})]})})]}),u===o.code?e.jsx("tr",{className:"bg-slate-50/70",children:e.jsx("td",{colSpan:8,className:"px-3 py-4",children:e.jsxs("div",{className:"grid gap-4 lg:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"Qualification Details"}),e.jsx("p",{className:"mt-2 text-xs text-slate-600",children:"Medicine core subjects (BIO, CHE, MAT, PHY):"}),e.jsx("div",{className:"mt-2 flex flex-wrap gap-1.5",children:Or.map(k=>{var Sn,Bn;return e.jsxs("span",{className:`rounded-full border px-2 py-1 text-xs font-medium ${(Sn=o.grades)!=null&&Sn[k]?"border-emerald-200 bg-emerald-50 text-emerald-700":"border-rose-200 bg-rose-50 text-rose-700"}`,children:[k,": ",((Bn=o.grades)==null?void 0:Bn[k])||"Missing"]},`${o.code}-${k}`)})}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Amount Paid: KES ",o.amountPaid||0]})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3 lg:col-span-2",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"All Cluster Points"}),e.jsx("div",{className:"mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5",children:re(o.results).map(k=>e.jsxs("div",{className:"rounded-lg border border-slate-200 bg-slate-50 px-2 py-2 text-xs",children:[e.jsxs("p",{className:"font-semibold text-slate-700",children:["Cluster ",k.cluster]}),e.jsx("p",{className:"mt-1 font-mono text-slate-900",children:bn(k.score)})]},`${o.code}-cluster-${k.cluster}`))}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Graded subjects: ",Vn.length," ",Vn.length?`(${Vn.map(([k,Sn])=>`${k}:${Sn}`).join(", ")})`:""]})]})]})})}):null]},o.code)})]})]})}),e.jsxs("div",{className:"mt-4 flex flex-wrap items-center justify-between gap-3",children:[e.jsxs("p",{className:"text-sm text-slate-600",children:["Showing ",X,"-",J," of ",P.length]}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>f(o=>Math.max(1,o-1)),disabled:C<=1,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(Ie,{className:"h-4 w-4"}),"Prev"]}),G.map(o=>e.jsx("button",{type:"button",onClick:()=>f(o),className:`inline-flex items-center justify-center rounded-lg border px-3 py-1.5 text-sm font-semibold transition ${o===C?"border-slate-900 bg-slate-900 text-white":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"}`,children:o},`page-${o}`)),e.jsxs("button",{type:"button",onClick:()=>f(o=>Math.min($,o+1)),disabled:C>=$,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:["Next",e.jsx(le,{className:"h-4 w-4"})]})]})]})]}),Y.code?e.jsx("div",{className:"fixed inset-0 z-40 flex items-center justify-center bg-slate-900/40 p-4",children:e.jsxs("div",{className:"w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsxs("h3",{className:"text-lg font-semibold text-slate-900",children:["Edit Session ",Y.code]}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Update user contact details, payment amount, and qualification flag."}),e.jsxs("form",{onSubmit:an,className:"mt-4 grid gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"edit_session_email",type:"email",value:Y.email,onChange:o=>g(S=>({...S,email:o.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_phone",className:"mb-1 block text-sm font-medium text-slate-700",children:"Phone Number"}),e.jsx("input",{id:"edit_session_phone",type:"text",value:Y.phoneNumber,onChange:o=>g(S=>({...S,phoneNumber:o.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_amount",className:"mb-1 block text-sm font-medium text-slate-700",children:"Amount Paid"}),e.jsx("input",{id:"edit_session_amount",type:"number",min:0,step:"0.01",value:Y.amountPaid,onChange:o=>g(S=>({...S,amountPaid:o.target.value})),className:"ui-input"})]}),e.jsxs("label",{className:"inline-flex items-center gap-2 text-sm font-medium text-slate-700",children:[e.jsx("input",{type:"checkbox",checked:Y.medicineEligible,onChange:o=>g(S=>({...S,medicineEligible:o.target.checked})),className:"ui-checkbox"}),"Medicine Eligible"]}),e.jsxs("div",{className:"mt-2 flex items-center justify-end gap-2",children:[e.jsxs("button",{type:"button",onClick:p,disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(ce,{className:"h-4 w-4"}),"Cancel"]}),e.jsxs("button",{type:"submit",disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(wn,{className:"h-4 w-4"}),H?"Saving...":"Save Changes"]})]})]})]})}):null]})}const yn={darajaPayment:ln("/api/payments"),darajaQuery:ln("/api/payments/query"),email:ln("/api/sendEmail"),calculateCluster:ln("/calculateClusterPoints"),adminHealth:ln("/api/admin/health")},Mr=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Yn=async({url:r,headers:i,body:n})=>{const t=await fetch(r,{method:"POST",credentials:"include",headers:i||{},body:n||void 0}),s=await Mr(t);return{ok:t.ok,status:t.status,data:s}},Mn=(r,i)=>{const n=(r==null?void 0:r.data)||{},t=(n==null?void 0:n.error)||(n==null?void 0:n.message)||(n==null?void 0:n.errorMessage)||(n==null?void 0:n.ResultDesc);return t?String(t):i},fn=r=>r&&typeof r=="object"&&"data"in r&&r.success!==!1?r.data:r,fr=r=>({source:"local-engine",results:xe(r),medicineEligible:be(r)}),Vr=async r=>{const i=(r==null?void 0:r["phone number"])||(r==null?void 0:r.phone_number)||(r==null?void 0:r.phoneNumber)||(r==null?void 0:r.phone)||"",n=Number((r==null?void 0:r.amount)??0),t=await Yn({url:yn.darajaPayment,headers:{"Content-Type":"application/json"},body:JSON.stringify({phone_number:i,amount:n,account_reference:String((r==null?void 0:r.account_reference)||(r==null?void 0:r.accountReference)||"KUCCPS-CLUSTER"),transaction_description:String((r==null?void 0:r.transaction_description)||(r==null?void 0:r.transactionDesc)||"Cluster payment")})});if(!t.ok)throw new Error(Mn(t,"Unable to initiate STK push."));return fn(t.data)},Kr=async r=>{const i=String((r==null?void 0:r.email)||"").trim(),n=String(r==null?void 0:r.subject).trim(),t=String((r==null?void 0:r.message)||"");if(!i||!n||!t)throw new Error("Email, subject and message are required.");const s=new URLSearchParams({email:i,subject:n,message:t}).toString(),a=[{url:yn.email,headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,subject:n,message:t})},{url:yn.email,headers:{"Content-Type":"application/x-www-form-urlencoded"},body:s}],I=[],N=[];for(const T of a){const c=await Yn(T);if(c.ok)return fn(c.data);I.push(c.status),N.push(Mn(c,`HTTP ${c.status}`))}const A=N.filter(Boolean).join(" | ");throw new Error(`Email API request failed. ${A||`Status codes: ${I.join(", ")}.`}`)},br=async({checkoutRequestId:r})=>{const i={checkoutRequestId:String(r||"").trim()};if(!i.checkoutRequestId)throw new Error("checkoutRequestId is required.");const n=await Yn({url:yn.darajaQuery,headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(n.ok)return fn(n.data);throw new Error(Mn(n,"Unable to fetch payment status."))},Wn=r=>new Promise(i=>window.setTimeout(i,r)),Lr=async({checkoutRequestId:r,timeoutMs:i=3e5,intervalMs:n=3e3,onStatus:t})=>{var I;const s=Date.now();let a="";for(;Date.now()-s<=i;){let N;try{N=await br({checkoutRequestId:r})}catch(c){a=String((c==null?void 0:c.message)||"").trim()||a,t==null||t({status:"pending",transientError:!0,resultDesc:a||"Temporary payment status check issue."}),await Wn(n);continue}t==null||t(N);const A=String((N==null?void 0:N.status)||"").trim().toLowerCase(),T=Number(((I=N==null?void 0:N.queryResponse)==null?void 0:I.ResultCode)??NaN);if(A==="success"||T===0)return N;if(A==="failed")throw new Error((N==null?void 0:N.resultDesc)||"Payment failed. Please try again.");await Wn(n)}throw new Error(a?`Timed out while waiting for M-Pesa confirmation. Last status: ${a}`:"Timed out while waiting for M-Pesa confirmation.")},xr=async({grades:r,checkoutRequestId:i,merchantRequestId:n})=>{const t={grades:r||{},checkoutRequestId:String(i||"").trim(),merchantRequestId:String(n||"").trim()};if(!t.checkoutRequestId&&!t.merchantRequestId)throw new Error("checkoutRequestId or merchantRequestId is required before calculation.");const s=await Yn({url:yn.calculateCluster,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(s.ok)return fn(s.data);throw new Error(Mn(s,"Unable to calculate cluster points after payment."))},pr=r=>r==="saved-session"?"Saved Session":r==="firebase-function"?"Firebase Function":"Local Cluster Engine",Gr=r=>Number(r||0).toFixed(3).replace(/\.?0+$/,""),Fr=(r,i)=>{const n=Object.entries(r||{}).map(([t,s])=>[t,Number(s)]).filter(([,t])=>Number.isFinite(t)&&t>0).sort((t,s)=>s[1]-t[1]).slice(0,i);return n.length?["Top cluster points:",...n.map(([t,s],a)=>`${a+1}. Cluster ${t}: ${Gr(s)}`)]:[]},Hr=({code:r,results:i,medicineEligible:n})=>{const t=["Your KUCCPS cluster calculation is ready.","",`Access code: ${r}`];return i&&Object.keys(i).length>0&&t.push("",...Fr(i,3)),typeof n=="boolean"&&t.push("",`Medicine eligibility: ${n?"Eligible":"Not eligible"}.`),t.push("","Use this code on the home page to open your saved cluster points and continue course selection."),t.join(`
`)},Br=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,wr=r=>Br.test(String(r||"").trim()),jr=r=>{const i=String(r||"").replace(/\D/g,"");return i.length===10&&i.startsWith("0")?`254${i.slice(1)}`:i.length===9&&i.startsWith("7")?`254${i}`:i.length===12&&i.startsWith("254")?i:null},zn=()=>Object.fromEntries(Object.keys(pn).map(r=>[r,""])),Pr="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:shadow",Dr="mt-3 inline-flex w-full items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100",kr="ui-select";function Jr({onCalculationReady:r,payableAmount:i,gradeOptions:n}){const t=mn(),[s,a]=E.useState(zn()),[I,N]=E.useState(Object.fromEntries(Jn.map((R,M)=>[R.title,M===0]))),[A,T]=E.useState(!1),[c,d]=E.useState(""),[y,u]=E.useState(""),[x,O]=E.useState(""),[h,C]=E.useState(null),[f,Y]=E.useState(""),[g,H]=E.useState(""),[B,Z]=E.useState(!1),[Q,_]=E.useState(""),rn=(R,M)=>{a(m=>({...m,[R]:M}))},q=R=>pn[R]||R,P=()=>Object.entries(s).filter(([,R])=>R&&R!=="").map(([R])=>R),$=R=>{N(M=>{const m=Object.fromEntries(Object.keys(M).map(v=>[v,!1]));return m[R]=!M[R],m})},W=async R=>{R.preventDefault(),_(""),u(""),O("");const M=P();if(M.length<7){_("Select grades for at least 7 subjects across all groups to compute cluster points.");return}const m=zn();M.forEach(p=>{m[p]=s[p]});const v=String(g||"").trim();if(!wr(v)){_("Enter a valid email address.");return}C(m),Y(v),T(!0)},z=async R=>{if(R.preventDefault(),u(""),O(""),!h){u("Please submit your grades and email first.");return}if(!f){u("Enter a valid email before continuing.");return}const M=jr(c);if(!M){u("Enter a valid M-Pesa phone number e.g. 0712345678 or 254712345678.");return}Z(!0);try{O("Sending the STK push to your phone...");const m=await Vr({amount:i,phone_number:M,phone:M,phoneNumber:M,"phone number":M}),v=String((m==null?void 0:m.CheckoutRequestID)||(m==null?void 0:m.checkoutRequestId)||"").trim(),p=String((m==null?void 0:m.MerchantRequestID)||(m==null?void 0:m.merchantRequestId)||"").trim();if(!v&&!p)throw new Error("STK push response did not include a payment reference.");O("STK push sent. Complete the payment on your phone. Waiting for confirmation...");const an=await Lr({checkoutRequestId:v,merchantRequestId:p,onStatus:S=>{(S==null?void 0:S.status)==="pending"&&O("Waiting for M-Pesa confirmation. Complete the prompt on your phone to continue.")}});O("Payment confirmed. Calculating cluster points...");let U,V="";try{U=await xr({grades:h,checkoutRequestId:v,merchantRequestId:p})}catch(S){U=fr(h),V=String((S==null?void 0:S.message)||"").trim()||"Backend calculation API was unavailable, so a local verified fallback was used."}const{session:G,storage:X,warning:J}=await ze({email:f,phoneNumber:M,amountPaid:i,grades:h,results:U.results,medicineEligible:U.medicineEligible,paymentResponse:{initiation:m,confirmation:an}}),o=["Payment confirmed."];V&&o.push(`Cluster points calculated locally (${V}).`),X==="local"?o.push(J||"Firebase save failed. Session was saved on this browser only, so code restore works only on this device."):o.push("Session saved to Firebase.");try{await Kr({email:f,subject:"KUCCPS Cluster Calculator Results",message:Hr({code:G.code,results:U.results,medicineEligible:U.medicineEligible})}),o.push(`Results email sent to ${f}.`)}catch(S){const b=S instanceof Error?S.message:"";o.push(b?`Email delivery failed (${b}). Save this code: ${G.code}.`:`Email delivery failed. Save this code: ${G.code}.`)}r({grades:h,results:U.results,source:U.source,accessCode:G.code,sessionMessage:o.join(" ")}),T(!1),u(""),O(""),_(""),t("/results")}catch(m){const v=m instanceof Error?m.message:"Payment or calculation failed.";u(v),_(v),O("")}finally{Z(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Cluster Points Calculator"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Enter your grades and email, then start payment. Cluster points are only shown after the M-Pesa payment is confirmed."}),e.jsxs("p",{className:"mt-1 text-sm font-medium text-emerald-700",children:["Amount: KES ",i]}),e.jsxs("form",{onSubmit:W,className:"mt-6 space-y-6",children:[e.jsx(F,{tone:"danger",message:Q}),e.jsx("div",{className:"grid gap-5 xl:grid-cols-2",children:Jn.map(R=>e.jsxs("article",{className:Pr,children:[e.jsx("div",{className:"flex items-start justify-between gap-3",children:e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-semibold text-slate-900",children:R.title}),e.jsx("p",{className:"mt-1 text-xs text-slate-500",children:R.required?"Core group. Enter grades for all listed subjects.":"Optional group. Fill available subjects."})]})}),e.jsxs("button",{type:"button",onClick:()=>$(R.title),className:Dr,children:[e.jsx("span",{children:I[R.title]?"Hide grade fields":"Show grade fields"}),e.jsx(Ne,{className:`h-4 w-4 text-slate-500 transition-transform ${I[R.title]?"rotate-180":"rotate-0"}`})]}),I[R.title]?e.jsx("div",{className:"mt-4 grid gap-3 sm:grid-cols-2",children:R.subjects.map(M=>e.jsxs("div",{children:[e.jsxs("label",{htmlFor:`${R.title}-${M}`,className:"mb-1 block text-sm font-medium text-slate-700",children:[q(M),R.required?e.jsx("span",{className:"text-rose-600",children:" *"}):null]}),e.jsxs("select",{id:`${R.title}-${M}`,value:s[M],onChange:m=>rn(M,m.target.value),required:R.required,className:kr,children:[e.jsx("option",{value:"",children:"Select grade"}),n.map(m=>e.jsx("option",{value:m,children:m},m))]})]},M))}):null]},R.title))}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email Address (for access code)"}),e.jsx("input",{id:"email",type:"email",value:g,onChange:R=>H(R.target.value),placeholder:"you@example.com",required:!0,className:"ui-input"})]}),e.jsx("button",{type:"submit",disabled:B,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:B?"Processing...":"Calculate Cluster Points"})]}),A?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 px-4",children:e.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsx("h2",{className:"text-lg font-semibold text-slate-900",children:"Enter M-Pesa Phone Number"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["We will send an STK push for KES ",i,". Your cluster points remain locked until the payment is confirmed."]}),e.jsxs("form",{onSubmit:z,className:"mt-4 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"dialog_phone_number",className:"mb-1 block text-sm font-medium text-slate-700",children:"M-Pesa Phone Number"}),e.jsx("input",{id:"dialog_phone_number",type:"tel",value:c,onChange:R=>d(R.target.value),placeholder:"0712345678",autoFocus:!0,required:!0,className:"ui-input"})]}),e.jsx(F,{tone:"info",message:x}),e.jsx(F,{tone:"danger",message:y}),e.jsxs("div",{className:"flex items-center justify-end gap-3",children:[e.jsx("button",{type:"button",onClick:()=>{B||(T(!1),u(""))},disabled:B,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60",children:"Cancel"}),e.jsx("button",{type:"submit",disabled:B,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-700 disabled:cursor-not-allowed disabled:bg-slate-400",children:B?"Processing...":"Send STK Push"})]})]})]})}):null]})}const Ln={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},qr={ENGLISH:"ENG",KISWAHILI:"KIS",MATHEMATICS:"MAT",MATH:"MAT",BIOLOGY:"BIO",CHEMISTRY:"CHE",PHYSICS:"PHY","GENERAL SCIENCE":"GSC",HISTORY:"HAG","HISTORY & GOVERNMENT":"HAG",GEOGRAPHY:"GEO",CRE:"CRE",IRE:"IRE",HRE:"HRE","COMPUTER STUDIES":"CMP",AGRICULTURE:"AGR","ART & DESIGN":"ARD","HOME SCIENCE":"HSC","BUSINESS STUDIES":"BST",FRENCH:"FRE",GERMAN:"GER",MUSIC:"MUS",ARABIC:"ARB"},$r=(r,i)=>{const n=[];for(const[t,s]of Object.entries(i||{})){const a=String(s||"").trim().toUpperCase();if(!(a in Ln))continue;const I=String(t).split("/").map(c=>{const d=c.trim().toUpperCase();return qr[d]||d});let N=!1,A=null,T=null;for(const c of I){const d=(r[c]||"").toUpperCase();if(d){if((Ln[d]||0)>=Ln[a]){N=!0;break}A=c,T=d}}N||n.push({subject:t,required:a,studentSubject:A,studentGrade:T})}return{passed:n.length===0,failed:n}};function _r({results:r,grades:i,courseCatalog:n}){const[t]=Ue(),s=Number(t.get("cluster")||0),a=t.get("course")||"";if(!r||!i)return e.jsx(En,{to:"/",replace:!0});if(!s||!a)return e.jsx(En,{to:"/results",replace:!0});const N=(n[s]||[]).find(y=>y.name===a);if(!N)return e.jsx(En,{to:"/results",replace:!0});const A=Number(r[s]??r[String(s)]??0),T=$r(i,N.requirements),c=[],d=y=>Number(y||0).toFixed(3).replace(/\.?0+$/,"");if(T.passed)for(const y of N.universities||[])A>=Number(y.cutoff)&&c.push(y);return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:a}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 text-sm text-slate-700",children:[e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster:"})," ",s]}),e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster Points:"})," ",A]})]})]}),T.passed?c.length?e.jsxs("article",{className:"rounded-2xl border border-emerald-200 bg-white p-5 shadow-sm",children:[e.jsx("h2",{className:"text-lg font-semibold text-emerald-900",children:"Qualified Universities"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["You qualify for ",c.length," ",c.length===1?"university":"universities"," based on your cluster points."]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-emerald-100",children:e.jsxs("table",{className:"min-w-full divide-y divide-emerald-100 text-sm",children:[e.jsx("thead",{className:"bg-emerald-50 text-left text-emerald-900",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"University"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cutoff"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Your Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Margin"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Status"})]})}),e.jsx("tbody",{className:"divide-y divide-emerald-50 bg-white text-slate-700",children:c.slice().sort((y,u)=>Number(u.cutoff)-Number(y.cutoff)).map(y=>e.jsxs("tr",{className:"hover:bg-emerald-50/40",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:y.name}),e.jsx("td",{className:"px-3 py-2",children:d(y.cutoff)}),e.jsx("td",{className:"px-3 py-2",children:d(A)}),e.jsxs("td",{className:"px-3 py-2 text-emerald-700",children:["+",d(A-Number(y.cutoff))]}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:"rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs font-semibold text-emerald-800",children:"Qualified"})})]},`${y.name}-${y.cutoff}`))})]})})]}):e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"Based on your current cluster points, you do not qualify for any listed university for this course."})]}):e.jsxs("div",{className:"space-y-4",children:[e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"You do not meet subject requirements for this course, so you are not qualified for any listed university."})]}),e.jsxs("article",{className:"rounded-2xl border border-rose-200 bg-rose-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-rose-900",children:"Subject Requirements Not Met"}),e.jsx("ul",{className:"mt-3 space-y-1 text-sm text-rose-900",children:T.failed.map(y=>e.jsxs("li",{children:[y.subject," required >= ",y.required,y.studentSubject?` (you had ${y.studentSubject}: ${y.studentGrade})`:" (subject not done)"]},`${y.subject}-${y.required}`))})]})]}),e.jsx("div",{children:e.jsx(cn,{to:"/results",className:"text-sm font-medium text-slate-700 hover:text-slate-900",children:"Back to Results"})})]})}function Wr({onRestoreByCode:r,payableAmount:i}){const n=mn(),[t,s]=E.useState(""),[a,I]=E.useState(""),[N,A]=E.useState(!1),T=async c=>{c.preventDefault(),I(""),A(!0);try{if(!await r(t)){I("Code not found. Confirm the code sent to your email.");return}n("/results")}catch(d){I(d.message||"Unable to load code.")}finally{A(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-12",children:[e.jsx("h1",{className:"mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl",children:"Start a new calculation or continue with your access code"}),e.jsxs("p",{className:"mt-4 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg",children:["New users pay KES ",i,", then receive a unique code by email to reopen saved results later."]}),e.jsxs("div",{className:"mt-6 flex flex-row items-center gap-4",children:[e.jsx("div",{className:"mt-8",children:e.jsx(cn,{to:"/calculator",className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:from-slate-800 hover:to-slate-700",children:"Get Started"})}),e.jsxs("form",{onSubmit:T,className:"max-w-xl space-y-3 rounded-xl",children:[e.jsx("label",{htmlFor:"access_code",className:"block text-sm font-medium text-slate-700",children:"Have an access code? Paste it here"}),e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row",children:[e.jsx("input",{id:"access_code",type:"text",value:t,onChange:c=>s(c.target.value.toUpperCase()),placeholder:"e.g. 8F3KQ2P9",className:"ui-input",required:!0}),e.jsx("button",{type:"submit",disabled:N,className:"inline-flex items-center justify-center rounded-lg bg-emerald-700 px-6 py-2 text-sm font-semibold text-white transition enabled:hover:bg-emerald-600 disabled:cursor-not-allowed disabled:bg-emerald-400",children:N?"Opening...":"Open"})]}),e.jsx(F,{tone:"danger",message:a})]})]})]})}function zr({clusters:r,getScore:i,courseCatalog:n,selectedCourses:t,onSelectCourse:s,onCheckCourse:a}){return e.jsx("div",{className:"mt-6 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-100 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course Check"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:r.map(I=>{const N=n[I]||[];return e.jsxs("tr",{className:"align-top hover:bg-slate-50",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:I}),e.jsx("td",{className:"px-3 py-2",children:i(I)}),e.jsx("td",{className:"px-3 py-2",children:e.jsxs("div",{className:"flex flex-col gap-2 sm:flex-row",children:[e.jsxs("select",{value:t[I]||"",onChange:A=>s(I,A.target.value),className:"ui-select sm:max-w-sm",children:[e.jsx("option",{value:"",children:"Select Course"}),N.map(A=>e.jsx("option",{value:A.name,children:A.name},A.name))]}),e.jsx("button",{type:"button",disabled:!t[I],onClick:()=>a(I,t[I]),className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-3 py-2 text-xs font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Check"})]})})]},I)})})]})})}function Zr({results:r,grades:i,source:n,courseCatalog:t,courseCatalogError:s,catalogLoading:a,accessCode:I,sessionMessage:N}){const A=mn(),[T,c]=E.useState({});if(!r||!i)return e.jsx(En,{to:"/",replace:!0});const d=Array.from({length:20},(u,x)=>x+1),y=u=>Number(r[u]??r[String(u)]??0);return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"All Cluster Points"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Select a course to evaluate your qualification details."}),e.jsxs("p",{className:"mt-1 text-xs font-medium text-slate-500",children:["Calculation source: ",pr(n)]}),I?e.jsx(F,{className:"mt-3",tone:"success",message:`Access code: ${I}`}):null,e.jsx(F,{className:"mt-2",tone:"info",message:N}),a?e.jsx(F,{className:"mt-2",tone:"info",message:"Loading course catalog..."}):null,e.jsx(F,{className:"mt-2",tone:"danger",message:s}),e.jsx(zr,{clusters:d,getScore:y,courseCatalog:t,selectedCourses:T,onSelectCourse:(u,x)=>c(O=>({...O,[u]:x})),onCheckCourse:(u,x)=>A(`/course-result?cluster=${u}&course=${encodeURIComponent(x)}`)})]})}const Qr=()=>Object.fromEntries(Object.keys(pn).map(r=>[r,""]));function Xr(){const r=Zn(),[i,n]=E.useState(null),[t,s]=E.useState(null),[a,I]=E.useState("local-engine"),[N,A]=E.useState(""),[T,c]=E.useState(""),d=E.useMemo(()=>Je(),[]),y=r.pathname.startsWith("/admin");E.useEffect(()=>{ne().catch(()=>{})},[]);const{courseCatalog:u,catalogLoading:x,courseCatalogError:O,saveCatalog:h,saveSingleCourse:C}=Nr({mode:y?"admin":"public"}),{adminUser:f,adminProfile:Y,authLoading:g,authWorking:H,authError:B,isAdminAuthenticated:Z,login:Q,loginWithGoogle:_,logout:rn,addRegularAdmin:q}=Me({enabled:y}),P=E.useCallback(async v=>{const p=await Ze(v);return!p||!p.results?null:(n(p.grades||Qr()),s(p.results||null),I("saved-session"),A(p.code),c(p.createdAt?`Loaded ${p.storage==="local"?"local":"saved"} session from ${new Date(p.createdAt).toLocaleString()}.`:`Loaded ${p.storage==="local"?"local":"saved"} session.`),p)},[]),$=E.useCallback(async v=>{await h(v)},[h]),W=E.useCallback(async v=>{await C(v)},[C]),z=E.useCallback(async(v,p)=>await Q(v,p),[Q]),R=E.useCallback(async()=>await _(),[_]),M=E.useCallback(async()=>{await rn()},[rn]),m=E.useCallback(v=>g?e.jsx("section",{className:"mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:e.jsx(F,{tone:"info",message:"Checking admin authentication..."})}):Z?v:e.jsx(En,{to:"/admin/login",replace:!0}),[g,Z]);return e.jsx(Re,{children:e.jsxs(Ae,{children:[e.jsx(tn,{path:"/",element:e.jsx(Wr,{onRestoreByCode:P,payableAmount:Dn})}),e.jsx(tn,{path:"/admin/login",element:e.jsx(Ur,{isAuthenticated:Z,onLogin:z,onGoogleLogin:R,authError:B,isLoading:H||g})}),e.jsx(tn,{path:"/admin",element:m(e.jsx(dr,{firebaseConfigured:d,onUploadCatalog:$,onAddSingleCourse:W,onLogout:M,onAddRegularAdmin:q,adminProfile:Y,adminEmail:(f==null?void 0:f.email)||"",authError:B,courseCatalog:u}))}),e.jsx(tn,{path:"/admin/sessions",element:m(e.jsx(Yr,{firebaseConfigured:d}))}),e.jsx(tn,{path:"/calculator",element:e.jsx(Jr,{gradeOptions:ue,payableAmount:Dn,onCalculationReady:({grades:v,results:p,source:an,accessCode:U,sessionMessage:V})=>{n(v),s(p),I(an),A(U||""),c(V||"")}})}),e.jsx(tn,{path:"/payment",element:e.jsx(En,{to:"/calculator",replace:!0})}),e.jsx(tn,{path:"/results",element:e.jsx(Zr,{results:t,grades:i,source:a,courseCatalog:u,courseCatalogError:O,catalogLoading:x,accessCode:N,sessionMessage:T})}),e.jsx(tn,{path:"/course-result",element:e.jsx(_r,{results:t,grades:i,courseCatalog:u})}),e.jsx(tn,{path:"*",element:e.jsx(En,{to:"/",replace:!0})})]})})}Te.createRoot(document.getElementById("root")).render(e.jsx(ye.StrictMode,{children:e.jsx(Ce,{children:e.jsx(Xr,{})})}));
