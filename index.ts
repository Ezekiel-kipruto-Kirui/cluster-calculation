...
const getFirebaseDatabaseUrl = (): URL => {
  ...
  if (parsed.search) normalized.search = parsed.search;
  return normalized;
};
...
const createBackendServer = () => {
  ...
  const frontendDistCandidates = [
    path.resolve(__dirname, "..", "dist", "frontend", "dist"),
    path.resolve(process.cwd(), "dist", "frontend", "dist"),
