import{u as Zn,j as e,L as cn,r as o,P as ie,a as hn,N as In,R as te,A as se,S as ae,b as Bn,T as jn,E as oe,c as Ee,C as Ie,d as le,X as ce,e as Ne,f as Ue,g as Ae,h as on,i as Te,k as ye,B as Ce}from"./vendor-1jWIULEY.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const I of a.addedNodes)I.tagName==="LINK"&&I.rel==="modulepreload"&&t(I)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Se=[{path:"/",label:"Home"},{path:"/calculator",label:"Calculator"},{path:"/admin",label:"Login"}];function Re({children:r}){const{pathname:i}=Zn(),n=t=>`rounded-lg px-3 py-2 text-sm font-medium transition ${i===t?"bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-sm":"text-slate-700 hover:bg-slate-100"}`;return e.jsxs("div",{className:"min-h-screen bg-mesh text-slate-900",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 backdrop-blur",children:e.jsxs("div",{className:"mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4",children:[e.jsx(cn,{to:"/",className:"text-lg font-semibold tracking-tight text-slate-900",children:"Cluster Calculation"}),e.jsx("nav",{className:"flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm",children:Se.map(t=>e.jsx(cn,{to:t.path,className:n(t.path),children:t.label},t.path))})]})}),e.jsx("main",{className:"mx-auto w-full max-w-7xl px-4 py-8",children:r})]})}const wn={danger:"border-rose-200 bg-rose-50 text-rose-700",warning:"border-amber-200 bg-amber-50 text-amber-700",success:"border-emerald-200 bg-emerald-50 text-emerald-700",info:"border-slate-200 bg-slate-50 text-slate-700"};function p({message:r,tone:i="info",className:n=""}){return r?e.jsx("p",{className:`rounded-lg border px-3 py-2 text-sm ${wn[i]||wn.info} ${n}`,children:r}):null}const ue=["A","A-","B+","B","B-","C+","C","C-","D+","D","D-","E"],de=(r,i)=>{const n=Number(r);return Number.isFinite(n)?n:i},Oe="150".trim(),Pn=de(Oe,0),xn=r=>/^https?:\/\//i.test(r),me=r=>{const i=String(r||"").trim();return i?xn(i)?i.replace(/\/+$/,""):(i.startsWith("/")?i:`/${i}`).replace(/\/+$/,""):""},he="".trim(),An=me(he),ge=r=>{if(!r)return"";if(xn(r))try{return new URL(r).pathname.replace(/\/+$/,"")||""}catch{return""}return r.startsWith("/")?r.replace(/\/+$/,""):""},ve=(r,i)=>{if(!r)return i;const n=ge(r);if(!n||n==="/")return i;const t=n.toLowerCase(),s=i.toLowerCase();return s===t?"":s.startsWith(`${t}/`)?i.slice(n.length):i},J=r=>{const i=String(r||"").trim();if(!i)return An||"";if(xn(i)||!An)return i;const n=i.startsWith("/")?i:`/${i}`,t=ve(An,n);return t?`${An}${t.startsWith("/")?t:`/${t}`}`:An},Vn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Dn=(r,i)=>String((r==null?void 0:r.error)||(r==null?void 0:r.message)||i).trim()||i,Ye=({enabled:r=!0}={})=>{const[i,n]=o.useState(null),[t,s]=o.useState(null),[a,I]=o.useState(r),[N,A]=o.useState(!1),[y,c]=o.useState(""),O=o.useMemo(()=>!0,[]),C=o.useCallback(async()=>{I(!0);try{const S=await fetch(J("/api/admin/me"),{method:"GET",credentials:"include"}),f=await Vn(S);if(!S.ok){n(null),s(null);return}n((f==null?void 0:f.user)||null),s((f==null?void 0:f.profile)||null),c("")}catch{n(null),s(null)}finally{I(!1)}},[]);o.useEffect(()=>{if(!r){I(!1);return}C().catch(()=>{})},[r,C]);const u=o.useCallback(async(S,f)=>{A(!0),c("");try{const Y=await fetch(J("/api/admin/login"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(S||"").trim(),password:String(f||"")})}),v=await Vn(Y);if(!Y.ok){const F=Y.status===404?"Admin login endpoint not found. Check VITE_API_BASE_URL or backend routes.":Dn(v,"Authentication request failed.");return c(F),{success:!1,error:F}}return n((v==null?void 0:v.user)||null),s((v==null?void 0:v.profile)||null),c(""),{success:!0,user:(v==null?void 0:v.user)||void 0,profile:(v==null?void 0:v.profile)||void 0,error:""}}catch(Y){const v=(Y==null?void 0:Y.message)||"Authentication request failed.";return c(v),{success:!1,error:v}}finally{A(!1)}},[]),x=o.useCallback(async()=>{const S="Google popup login is disabled in backend-auth mode. Use email and password.";return c(S),{success:!1,error:S}},[]),m=o.useCallback(async()=>{A(!0);try{await fetch(J("/api/admin/logout"),{method:"POST",credentials:"include"})}finally{n(null),s(null),c(""),A(!1)}},[]),g=o.useCallback(async({email:S,password:f,name:Y})=>{if(!i||!t)throw new Error("You must be logged in as admin.");if(t.role!=="super")throw new Error("Only a super admin can add regular admin users.");const v=await fetch(J("/api/admin/regular-admin"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(S||"").trim(),password:String(f||""),name:String(Y||"").trim()})}),F=await Vn(v);if(!v.ok)throw new Error(Dn(F,"Unable to create regular admin."));return{user:(F==null?void 0:F.user)||null,profile:(F==null?void 0:F.profile)||null}},[t,i]);return{firebaseAuthReady:O,adminUser:i,adminProfile:t,authLoading:a,authWorking:N,authError:y,isAdminAuthenticated:!!(i&&t),login:u,loginWithGoogle:x,logout:m,addRegularAdmin:g}},Ln={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},pn={ENG:"English",KIS:"Kiswahili",MAT:"Mathematics",BIO:"Biology",CHE:"Chemistry",PHY:"Physics",GSC:"General Science",HAG:"History",GEO:"Geography",CRE:"CRE",IRE:"IRE",HRE:"HRE",CMP:"Computer Studies",AGR:"Agriculture",ARD:"Art & Design",HSC:"Home Science",BST:"Business Studies",FRE:"French",GER:"German",MUS:"Music",ARB:"Arabic"},kn=[{title:"Group I",required:!0,subjects:["ENG","KIS","MAT"]},{title:"Group II (Sciences)",required:!1,subjects:["BIO","CHE","PHY","GSC"]},{title:"Group III (Humanities)",required:!1,subjects:["HAG","GEO","CRE","IRE","HRE"]},{title:"Group IV (Technical)",required:!1,subjects:["CMP","AGR","ARD","HSC"]},{title:"Group V (Others)",required:!1,subjects:["BST","FRE","GER","MUS","ARB"]}],Me=["ENG","KIS","MAT"],L=["BIO","CHE","PHY","GSC"],b=["HAG","GEO","CRE","IRE","HRE"],j=["CMP","AGR","ARD","HSC"],w=["BST","FRE","GER","MUS","ARB"],un=[...Me,...L,...b,...j,...w],l=(r,i)=>Math.max(...i.map(n=>n in r?r[n]:0),0),D=(r,i,n)=>{const t=i.filter(s=>s in r).map(s=>r[s]).sort((s,a)=>a-s);return t.length>=n?t[n-1]:0},fe=r=>{const i=Object.values(r).sort((n,t)=>t-n);return i.length>=7?i.slice(0,7).reduce((n,t)=>n+t,0):0},Ve=(r,i)=>Number((Math.sqrt(r/48*(i/84))*48*.94).toFixed(3)),Ke=r=>["BIO","CHE","MAT","PHY"].every(n=>r[n]&&r[n]in Ln),be=(r,i)=>{const n={};for(const[I,N]of Object.entries(i))N in Ln&&(n[I]=Ln[N]);if(Object.keys(n).length<7)return 0;const t=fe(n),s=()=>0;let a=0;if(r===1){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L))+l(n,b)+Math.max(l(n,L),D(n,b,2),l(n,j),l(n,w))}else if(r===2){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+(n.MAT??0)+Math.max(l(n,L),l(n,b))+Math.max(l(n,L),l(n,b),l(n,j),l(n,w))}else if(r===3){if(!("ENG"in n||"KIS"in n))return s();a=l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L))+l(n,b)+Math.max(l(n,L),D(n,b,2),l(n,j),l(n,w))}else if(r===4){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(n.BIO??0,n.CHE??0,n.GEO??0)+Math.max(l(n,L),l(n,b),l(n,j),l(n,w))}else if(r===5){if(!("MAT"in n&&"PHY"in n&&"CHE"in n))return s();a=n.MAT+n.PHY+n.CHE+Math.max(n.BIO??0,l(n,b),l(n,j),l(n,w))}else if(r===6){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+l(n,b)+Math.max(D(n,L,2),D(n,b,2),l(n,j),l(n,w))}else if(r===7){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(D(n,L,2),l(n,b))+Math.max(l(n,L),l(n,b),l(n,j),l(n,w))}else if(r===8){if(!("MAT"in n&&"BIO"in n))return s();a=n.MAT+n.BIO+Math.max(n.PHY??0,n.CHE??0)+Math.max(D(n,L,3),l(n,b),l(n,j),l(n,w))}else if(r===9){if(!("MAT"in n))return s();a=n.MAT+l(n,L)+D(n,L,2)+Math.max(D(n,L,3),l(n,b),l(n,j),l(n,w))}else if(r===10){if(!("MAT"in n))return s();a=n.MAT+l(n,L)+l(n,b)+Math.max(D(n,L,2),D(n,b,2),l(n,j),l(n,w))}else if(r===11)a=Math.max((n.CHE??0)+Math.max(n.MAT??0,n.PHY??0)+Math.max(n.BIO??0,n.HSC??0)+Math.max(l(n,["ENG","KIS"]),l(n,b),l(n,j),l(n,w)),Math.max(n.BIO??0,n.GSC??0)+(n.MAT??0)+Math.max(l(n,L),l(n,b))+Math.max(l(n,["ENG","KIS"]),l(n,L),l(n,b),l(n,j),l(n,w)));else if(r===12||r===13){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0)+Math.max(l(n,["ENG","KIS"]),D(n,L,3),l(n,b),l(n,j),l(n,w))}else if(r===14){if(!("CHE"in n))return s();a=Math.max(n.BIO??0,n.AGR??0,n.HSC??0)+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.GEO??0)+Math.max(l(n,["ENG","KIS"]),l(n,b),l(n,j),l(n,w))}else if(r===15){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.AGR??0)+Math.max(l(n,["ENG","KIS"]),l(n,b),l(n,j),l(n,w))}else if(r===16){if(!("GEO"in n))return s();a=n.GEO+(n.MAT??0)+l(n,L)+Math.max(D(n,L,2),D(n,b,2),l(n,j),l(n,w))}else if(r===17){if(!("FRE"in n||"GER"in n))return s();a=l(n,["FRE","GER"])+l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L),l(n,b))+Math.max(l(n,L),l(n,b),l(n,j),D(n,w,2))}else if(r===18){if(!("MUS"in n))return s();a=n.MUS+l(n,["ENG","KIS"])+Math.max(n.MAT??0,l(n,L),l(n,b))+Math.max(l(n,L),l(n,b),l(n,j),D(n,w,2))}else if(r===19)a=l(n,un)+D(n,un,2)+D(n,un,3)+D(n,un,4);else if(r===20){if(!(n.CRE||n.IRE||n.HRE))return s();a=l(n,["CRE","IRE","HRE"])+l(n,["ENG","KIS"])+D(n,b,2)+Math.max(l(n,L),l(n,j),l(n,w))}else return s();return Ve(a,t)},Le=r=>{const i={};for(let n=1;n<=20;n+=1)i[n]=be(n,r);return i},Qn="kuccps.cluster.sessions",tn={catalog:J("/api/catalog"),adminCatalogUpload:J("/api/admin/catalog/upload"),adminCatalogCourse:J("/api/admin/catalog/course"),sessions:J("/api/sessions"),adminSessions:J("/api/admin/sessions"),adminSessionsBulkDelete:J("/api/admin/sessions/delete-many"),adminMe:J("/api/admin/me")},gn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Gn=async r=>{const i=await fetch(r,{method:"GET",credentials:"include"}),n=await gn(i);return{ok:i.ok,status:i.status,data:n}},Sn=async(r,i)=>{const n=await fetch(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await gn(n);return{ok:n.ok,status:n.status,data:t}},xe=async(r,i)=>{const n=await fetch(r,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await gn(n);return{ok:n.ok,status:n.status,data:t}},pe=async r=>{const i=await fetch(r,{method:"DELETE",credentials:"include"}),n=await gn(i);return{ok:i.ok,status:i.status,data:n}},sn=(r,i)=>{const n=(r==null?void 0:r.data)||{};return String((n==null?void 0:n.error)||(n==null?void 0:n.message)||i)},Nn=r=>String(r||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,""),yn=r=>{const i=r&&typeof r=="object"?r:{},n={};for(let t=1;t<=20;t+=1){const s=Number(i[t]??i[String(t)]??0);n[t]=Number.isFinite(s)?s:0}return n},Fn=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=String(n||"").trim().toUpperCase(),a=String(t||"").trim().toUpperCase();!s||!a||(i[s]=a)}),i},Ge=(r,i)=>{if(!i||String(r||"").trim().toUpperCase()!=="BACHELOR OF SCIENCE CLINICAL MEDICINE")return i;const n=i.replace(/\s+/g," ").trim();return/^mathematics\s*\/\s*physics$/i.test(n)?"Mathematics":i},Fe=(r,i)=>{const n={};return Object.entries(i||{}).forEach(([t,s])=>{const a=Ge(r,String(t||"").trim()),I=String(s||"").trim().toUpperCase();!a||!I||(n[a]=I)}),n},vn=()=>{if(typeof window>"u")return{};try{const r=window.localStorage.getItem(Qn);if(!r)return{};const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}},Xn=r=>{typeof window>"u"||window.localStorage.setItem(Qn,JSON.stringify(r||{}))},dn="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",He=(r=8)=>{if(typeof crypto<"u"&&crypto.getRandomValues){const n=new Uint8Array(r);return crypto.getRandomValues(n),Array.from(n,t=>dn[t%dn.length]).join("")}let i="";for(let n=0;n<r;n+=1){const t=Math.floor(Math.random()*dn.length);i+=dn[t]}return i},Be=()=>{const r=vn();for(let i=0;i<20;i+=1){const n=He();if(!r[n])return n}throw new Error("Unable to generate a local access code.")},je=r=>{const i=vn();i[r.code]=r,Xn(i)},we=(r,i="")=>({name:(r==null?void 0:r.name)||i,requirements:Fe((r==null?void 0:r.name)||i,(r==null?void 0:r.requirements)||{}),universities:Array.isArray(r==null?void 0:r.universities)?r.universities.map(n=>({name:String((n==null?void 0:n.name)||""),cutoff:Number((n==null?void 0:n.cutoff)??0),courseCode:String((n==null?void 0:n.courseCode)||"")})):[]}),Pe=r=>(Array.isArray(r)?r:Object.values(r||{})).map(n=>we(n)).filter(n=>!!n.name),De=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);!Number.isInteger(s)||s<1||(i[s]=Pe(t))}),i},ke=()=>!0,Je=async()=>{const r=await Gn(tn.catalog);if(!r.ok)throw new Error(sn(r,"Unable to load course catalog from backend."));return De(r.data||{})},qe=async r=>{if(!r||typeof r!="object")throw new Error("Invalid course catalog payload.");const i=await Sn(tn.adminCatalogUpload,r);if(!i.ok)throw new Error(sn(i,"Unable to upload course catalog to backend."))},$e=async({cluster:r,name:i,requirements:n,universities:t})=>{const s=await Sn(tn.adminCatalogCourse,{cluster:r,name:i,requirements:n,universities:t});if(!s.ok)throw new Error(sn(s,"Unable to save course entry to backend."));return s.data||{}},_e=async({code:r,email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N})=>{const A={email:i,phoneNumber:n,amountPaid:t,grades:s,results:a,medicineEligible:I,paymentResponse:N};r&&(A.code=r);const y=await Sn(tn.sessions,A);if(!y.ok)throw new Error(sn(y,"Unable to save session to backend."));const c=y.data||{};return{code:Nn(c.code),email:String(c.email||"").trim(),phoneNumber:String(c.phoneNumber||"").trim(),amountPaid:Number(c.amountPaid??0),grades:Fn(c.grades),results:yn(c.results),medicineEligible:!!c.medicineEligible,paymentResponse:c.paymentResponse||null,createdAt:String(c.createdAt||""),updatedAt:String(c.updatedAt||""),storage:"firebase"}},ne=async()=>{const r=vn(),i=Object.entries(r);if(!i.length)return 0;let n=0;const t={...r};for(const[s,a]of i)try{const I={code:Nn(a.code||s),email:String(a.email||"").trim(),phoneNumber:String(a.phoneNumber||"").trim(),amountPaid:Number(a.amountPaid??0),grades:a.grades||{},results:a.results||{},medicineEligible:!!a.medicineEligible,paymentResponse:a.paymentResponse||null},N=await Sn(tn.sessions,I);if(!N.ok)throw new Error(sn(N,"Unable to sync session to backend."));delete t[s],n+=1}catch{}return n>0&&Xn(t),n},We=async r=>{try{const i=await _e(r);return ne().catch(()=>{}),{session:i,storage:"firebase",warning:""}}catch(i){const n=new Date().toISOString(),s={code:Be(),email:String((r==null?void 0:r.email)||"").trim(),phoneNumber:String((r==null?void 0:r.phoneNumber)||"").trim(),amountPaid:Number((r==null?void 0:r.amountPaid)??0),grades:(r==null?void 0:r.grades)||{},results:yn((r==null?void 0:r.results)||{}),medicineEligible:!!(r!=null&&r.medicineEligible),paymentResponse:(r==null?void 0:r.paymentResponse)||null,createdAt:n,updatedAt:n,storage:"local"};return je(s),{session:s,storage:"local",warning:(i==null?void 0:i.message)||"Backend save failed. Session saved locally on this browser only."}}},ze=async r=>{const i=Nn(r);if(!i)return null;const n=await Gn(`${tn.sessions}/${i}`);if(n.ok&&n.data){const s=n.data;return{code:i,email:String(s.email||"").trim(),phoneNumber:String(s.phoneNumber||"").trim(),amountPaid:Number(s.amountPaid??0),grades:Fn(s.grades),results:yn(s.results),medicineEligible:!!s.medicineEligible,paymentResponse:s.paymentResponse||null,createdAt:String(s.createdAt||""),updatedAt:String(s.updatedAt||""),storage:"firebase"}}const t=vn()[i];if(t)return{code:i,email:t.email||"",phoneNumber:t.phoneNumber||"",amountPaid:Number(t.amountPaid??0),grades:t.grades||{},results:yn(t.results||{}),medicineEligible:!!t.medicineEligible,paymentResponse:t.paymentResponse||null,createdAt:t.createdAt||"",updatedAt:t.updatedAt||"",storage:"local"};if(n.status!==404)throw new Error(sn(n,"Unable to load session from backend."));return null},Ze=async()=>{const r=await Gn(tn.adminSessions);if(!r.ok)throw new Error(sn(r,"Unable to load calculated sessions from backend."));return(Array.isArray(r.data)?r.data:[]).map(n=>({code:Nn(n.code),email:String(n.email||"").trim(),phoneNumber:String(n.phoneNumber||"").trim(),amountPaid:Number(n.amountPaid??0),createdAt:String(n.createdAt||""),updatedAt:String(n.updatedAt||""),medicineEligible:!!n.medicineEligible,grades:Fn(n.grades),results:yn(n.results),paymentResponse:n.paymentResponse||null,storage:"firebase"})).filter(n=>n.code).sort((n,t)=>(Date.parse(t.createdAt||"")||0)-(Date.parse(n.createdAt||"")||0))},Qe=async(r,i={})=>{const n=Nn(r);if(!n)throw new Error("Session code is required.");const t=await xe(`${tn.adminSessions}/${n}`,i);if(!t.ok)throw new Error(sn(t,"Unable to update session."))},Xe=async r=>{const i=Nn(r);if(!i)throw new Error("Session code is required.");const n=await pe(`${tn.adminSessions}/${i}`);if(!n.ok)throw new Error(sn(n,"Unable to delete session."))},nr=async(r=[])=>{var n;const i=await Sn(tn.adminSessionsBulkDelete,{codes:Array.isArray(r)?r:[]});if(!i.ok)throw new Error(sn(i,"Unable to delete selected sessions."));return Number(((n=i.data)==null?void 0:n.deleted)??0)},ln={courseName:"COURSE NAME",cluster:"CLUSTER",courseCode:"COURSE CODE",university:"UNIVERSITY",cutoff:"CUT-OFF POINTS",requirements:"MINIMUM SUBJECT REQUIREMENTS"},En=r=>String(r??"").replace(/\u00a0/g," ").trim(),er=r=>{const i=En(r).replace(/,/g,"");if(!i||i==="-")return 0;const n=Number.parseFloat(i);return Number.isFinite(n)?n:0},Jn=r=>{const i=En(r);if(!i||/^none$/i.test(i)||i==="-")return[];const n=[];return i.split(/\r?\n|;/).map(t=>t.trim()).filter(Boolean).forEach(t=>{if(/^none$/i.test(t)||t==="-")return;const s=t.indexOf(":");if(s<0)return;const a=t.slice(0,s).trim(),I=t.slice(s+1).trim().toUpperCase();!a||!I||I==="-"||n.push({subject:a,grade:I})}),n},rr=(r,i)=>{if(!i||String(r||"").trim().toUpperCase()!=="BACHELOR OF SCIENCE CLINICAL MEDICINE")return i;const n=i.replace(/\s+/g," ").trim();return/^mathematics\s*\/\s*physics$/i.test(n)?"Mathematics":i},ir=(r,i=[])=>{const n=[];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=rr(r,t.subject);if(!s)return;const a=String(t.grade||"").trim().toUpperCase();if(!a)return;const I=n.findIndex(N=>N.subject===s);I>=0?n[I]={subject:s,grade:a}:n.push({subject:s,grade:a})}),n},tr=(r=[],i=[])=>{const n=[...r];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=n.findIndex(a=>a.subject===t.subject);s>=0?n[s]=t:n.push(t)}),n},sr=r=>{const i=new Set,n=[];return r.forEach(t=>{const s=`${t.name}|${t.courseCode}`;!t.name||i.has(s)||(i.add(s),n.push(t))}),n},ar=r=>Object.values(ln).some(i=>En(r==null?void 0:r[i])),ee=r=>{const i=ie.parse(r,{header:!0,skipEmptyLines:!1});if(!Array.isArray(i.data)||!i.data.length)throw new Error("CSV has no records.");const n={};let t=null;const s=()=>{t&&(n[t.cluster]||(n[t.cluster]=[]),n[t.cluster].push({name:t.name,requirements:ir(t.name,t.requirements),universities:sr(t.universities)}),t=null)};if(i.data.forEach(a=>{if(!a||typeof a!="object"||!ar(a))return;const I=En(a[ln.courseName]),N=En(a[ln.cluster]),A=En(a[ln.courseCode]),y=En(a[ln.university]),c=En(a[ln.cutoff]),O=En(a[ln.requirements]),C=Number(N);if(!!(I&&Number.isInteger(C)&&C>0))s(),t={name:I,cluster:C,requirements:Jn(O),universities:[]};else if(!t)return;O&&(t.requirements=tr(t.requirements,Jn(O))),(y||A||c)&&t.universities.push({name:y||"Unknown University",courseCode:A,cutoff:er(c)})}),s(),!Object.keys(n).length)throw new Error("CSV did not produce a valid course catalog.");return n},or=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}},Er=`COURSE NAME,CLUSTER,COURSE CODE,UNIVERSITY,CUT-OFF POINTS,MINIMUM SUBJECT REQUIREMENTS\r
...
,,1114488,University of Eldoret,15.092,\r
,,1093488,University of Embu,15.092,\r
`,Ir=r=>{if(!Array.isArray(r))return{};const i={};return r.forEach(n=>{const t=String((n==null?void 0:n.subject)||"").trim(),s=String((n==null?void 0:n.grade)||"").trim().toUpperCase();!t||!s||(i[t]=s)}),i},lr=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);if(!Number.isInteger(s)||s<1)return;const a=Array.isArray(t)?t:[];i[s]=a.map(I=>({name:String((I==null?void 0:I.name)||"").trim(),requirements:Ir(I==null?void 0:I.requirements),universities:Array.isArray(I==null?void 0:I.universities)?I.universities.map(N=>({name:String((N==null?void 0:N.name)||"").trim(),courseCode:String((N==null?void 0:N.courseCode)||"").trim(),cutoff:Number((N==null?void 0:N.cutoff)??0)})).filter(N=>!!N.name):[]})).filter(I=>!!I.name)}),i};let On=null;const qn=()=>{if(On)return On;const r=ee(Er);return On=lr(r),On},cr=({mode:r="public"}={})=>{const[i,n]=o.useState({}),[t,s]=o.useState(!0),[a,I]=o.useState(""),N=o.useCallback(async()=>{if(s(!0),r!=="admin"){try{const c=qn();n(c),I("")}catch(c){n({}),I((c==null?void 0:c.message)||"Unable to load bundled course catalog.")}finally{s(!1)}return}try{const c=await Je();n(c),I("")}catch(c){const O=qn();n(O);const C=(c==null?void 0:c.message)||"Unable to load courses from realtime database.";I(`${C} Showing bundled courses until backend connection is available.`)}finally{s(!1)}},[r]),A=o.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await qe(c),I(""),await N()},[N,r]),y=o.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await $e(c),I(""),await N()},[N,r]);return o.useEffect(()=>{N().catch(()=>{})},[N]),{courseCatalog:i,catalogLoading:t,courseCatalogError:a,loadCatalog:N,saveCatalog:A,saveSingleCourse:y}};function Nr({isAuthenticated:r,onLogin:i,onGoogleLogin:n,authError:t,isLoading:s}){const a=hn(),[I,N]=o.useState(""),[A,y]=o.useState(""),[c,O]=o.useState(!1),[C,u]=o.useState("");if(r)return e.jsx(In,{to:"/admin",replace:!0});const x=async g=>{g.preventDefault(),u("");const S=await i(I,A);if(S.success){a("/admin");return}u(S.error||"Invalid admin credentials.")},m=async()=>{u("");const g=await n();if(g.success){a("/admin");return}u(g.error||"Google sign-in failed.")};return e.jsxs("section",{className:"mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Admin Login"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Only admins can upload course data to Firebase."}),e.jsxs("form",{onSubmit:x,className:"mt-6 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"admin_email",type:"email",value:I,onChange:g=>N(g.target.value),required:!0,className:"ui-input",placeholder:"admin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{id:"admin_password",type:c?"text":"password",value:A,onChange:g=>y(g.target.value),required:!0,className:"ui-input pr-20"}),e.jsx("button",{type:"button",onClick:()=>O(g=>!g),className:"absolute right-2 top-1/2 -translate-y-1/2 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-600 transition hover:bg-slate-50",children:c?"Hide":"View"})]})]}),e.jsx(p,{tone:"danger",message:C}),e.jsx(p,{tone:"danger",message:t}),e.jsx("button",{type:"submit",disabled:s,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:s?"Signing in...":"Login"}),e.jsxs("div",{className:"relative py-1",children:[e.jsx("div",{className:"absolute inset-0 flex items-center",children:e.jsx("span",{className:"w-full border-t border-slate-200"})}),e.jsx("div",{className:"relative flex justify-center",children:e.jsx("span",{className:"bg-white px-2 text-xs text-slate-500",children:"OR"})})]}),e.jsx("button",{type:"button",onClick:m,disabled:s,className:"inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Continue with Google"})]})]})}const Ur="/assets/courses-CtX9VR_p.csv",Ar=r=>new Promise((i,n)=>{const t=new FileReader;t.onload=()=>i(String(t.result||"")),t.onerror=()=>n(new Error("Unable to read selected file.")),t.readAsText(r)});function Tr({firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:n}){const[t,s]=o.useState(""),[a,I]=o.useState(""),[N,A]=o.useState(!1),[y,c]=o.useState(null),O=async(m,g)=>{s(""),I(""),A(!0);try{const S=ee(m);await i(S);const f=or(S);I(`${g} uploaded: ${f.clusters} clusters, ${f.courses} courses, ${f.universities} universities.`)}catch(S){s(S.message||"Failed to upload course catalog.")}finally{A(!1)}},C=async()=>{if(!y){s("Select a CSV file first.");return}try{const m=await Ar(y);await O(m,y.name)}catch(m){s(m.message||"Failed to read selected CSV file.")}},u=async()=>{try{const m=await fetch(n);if(!m.ok)throw new Error(`Unable to load bundled CSV (status ${m.status}).`);const g=await m.text();await O(g,"courses.csv")}catch(m){s(m.message||"Failed to upload bundled courses.csv.")}},x=m=>{var g;c(((g=m.target.files)==null?void 0:g[0])||null)};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight",children:"Courses Upload"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Upload a `courses.csv` compatible file through backend API into Firebase realtime database. Uploading replaces the entire catalog (existing courses are deleted)."}),r?null:e.jsx(p,{className:"mt-4",tone:"warning",message:"Backend Firebase integration is not available."}),e.jsxs("div",{className:"mt-5 flex flex-col gap-3 sm:flex-row sm:items-end",children:[e.jsxs("div",{className:"w-full sm:max-w-md",children:[e.jsx("label",{htmlFor:"admin_csv_upload",className:"mb-1 block text-sm font-medium text-slate-700",children:"Select CSV file"}),e.jsx("input",{id:"admin_csv_upload",type:"file",accept:".csv,text/csv",onChange:x,className:"ui-file-input"})]}),e.jsx("button",{type:"button",onClick:C,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Replace With Selected CSV"}),e.jsx("button",{type:"button",onClick:u,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Replace With Bundled courses.csv"})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:t}),e.jsx(p,{className:"mt-3",tone:"success",message:a})]})}const $n={name:"",email:"",password:""},yr={cluster:"",name:"",requirementsText:"",universityName:"",courseCode:"",cutoff:""},Cr=r=>{const i={};return String(r||"").split(/\r?\n|;/).map(n=>n.trim()).filter(Boolean).forEach(n=>{const t=n.indexOf(":");if(t<0)return;const s=n.slice(0,t).trim(),a=n.slice(t+1).trim().toUpperCase();!s||!a||(i[s]=a)}),i},Sr=r=>{const i=Object.entries(r||{});return i.length?i.map(([n,t])=>({subject:String(n||"").trim(),grade:String(t||"").trim().toUpperCase()})).filter(n=>n.subject&&n.grade).sort((n,t)=>n.subject.localeCompare(t.subject)).map(n=>`${n.subject}: ${n.grade}`).join(", "):"None"},Rr=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a==null?void 0:a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}};function ur({firebaseConfigured:r,onUploadCatalog:i,onAddSingleCourse:n,onLogout:t,onAddRegularAdmin:s,adminProfile:a,adminEmail:I,authError:N,courseCatalog:A}){const[y,c]=o.useState($n),[O,C]=o.useState(!1),[u,x]=o.useState(""),[m,g]=o.useState(""),[S,f]=o.useState(yr),[Y,v]=o.useState(!1),[F,q]=o.useState(""),[rn,$]=o.useState(""),[z,an]=o.useState(""),[H,P]=o.useState("all"),_=(a==null?void 0:a.role)==="super",Z=o.useMemo(()=>Rr(A),[A]),Q=o.useMemo(()=>{const U=[];return Object.entries(A||{}).forEach(([M,K])=>{const X=Number(M);!Number.isInteger(X)||X<1||Array.isArray(K)&&K.forEach(B=>{const E=String((B==null?void 0:B.name)||"").trim();E&&U.push({cluster:X,name:E,requirements:(B==null?void 0:B.requirements)||{},universities:Array.isArray(B==null?void 0:B.universities)?B.universities.length:0})})}),U.sort((M,K)=>M.cluster-K.cluster||M.name.localeCompare(K.name))},[A]),nn=o.useMemo(()=>{const U=new Set;return Q.forEach(M=>U.add(M.cluster)),Array.from(U).sort((M,K)=>M-K)},[Q]),en=o.useMemo(()=>{const U=z.trim().toLowerCase(),M=H==="all"?null:Number(H);return Q.filter(K=>M&&K.cluster!==M?!1:U?K.name.toLowerCase().includes(U):!0)},[Q,H,z]),d=(U,M)=>{c(K=>({...K,[U]:M}))},R=(U,M)=>{f(K=>({...K,[U]:M}))},T=async U=>{if(U.preventDefault(),x(""),g(""),!_){x("Only a super admin can add regular admins.");return}if(!y.email||!y.password){x("Email and password are required.");return}C(!0);try{const M=await s({name:y.name,email:y.email,password:y.password});g(`Regular admin added: ${M.user.email}`),c($n)}catch(M){x(M.message||"Unable to add regular admin.")}finally{C(!1)}},G=async U=>{if(U.preventDefault(),q(""),$(""),!r){q("Firebase is not configured.");return}const M=Number(S.cluster);if(!Number.isInteger(M)||M<1){q("Cluster must be a whole number greater than 0.");return}const K=String(S.name||"").trim();if(!K){q("Course name is required.");return}const X=String(S.universityName||"").trim();if(!X){q("University name is required.");return}const B=String(S.cutoff||"").trim(),E=B?Number(B):0;if(!Number.isFinite(E)||E<0){q("Cutoff must be a number equal to or greater than 0.");return}v(!0);try{await n({cluster:M,name:K,requirements:Cr(S.requirementsText),universities:[{name:X,courseCode:String(S.courseCode||"").trim(),cutoff:E}]}),$(`Saved "${K}" in cluster ${M}.`),f(h=>({...h,universityName:"",courseCode:"",cutoff:""}))}catch(h){q(h.message||"Unable to save course.")}finally{v(!1)}};return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:[e.jsx("div",{className:"pointer-events-none absolute -top-14 -right-12 h-44 w-44 rounded-full bg-cyan-200/40 blur-2xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-10 -left-10 h-36 w-36 rounded-full bg-emerald-200/50 blur-2xl"}),e.jsxs("div",{className:"relative",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Control Center"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Admin Dashboard"}),e.jsx("p",{className:"mt-2 max-w-2xl text-sm text-slate-600",children:"Manage admins and maintain course catalog content for calculator results and eligibility checks."}),e.jsxs("p",{className:"mt-3 text-xs font-medium text-slate-500",children:["Signed in as: ",I||"unknown"," (",(a==null?void 0:a.role)||"regular"," admin)"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(cn,{to:"/admin/sessions",className:"inline-flex items-center justify-center rounded-xl border border-cyan-300 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-100",children:"View Calculated Users"}),e.jsx("button",{type:"button",onClick:t,className:"inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:"Logout"})]})]}),e.jsxs("div",{className:"mt-5 grid gap-3 sm:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Clusters"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:Z.clusters})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Courses"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:Z.courses})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"University Entries"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:Z.universities})]})]})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:N})]}),e.jsxs("div",{className:"grid gap-6 xl:grid-cols-2",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Admin Users"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Create regular admin accounts that can log in and access admin tools."}),_?null:e.jsx(p,{className:"mt-3",tone:"warning",message:"Only a super admin can add regular admin users."}),e.jsxs("form",{onSubmit:T,className:"mt-5 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Full Name"}),e.jsx("input",{id:"regular_admin_name",type:"text",value:y.name,onChange:U=>d("name",U.target.value),className:"ui-input",placeholder:"Admin Name"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"regular_admin_email",type:"email",value:y.email,onChange:U=>d("email",U.target.value),required:!0,className:"ui-input",placeholder:"newadmin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsx("input",{id:"regular_admin_password",type:"password",value:y.password,onChange:U=>d("password",U.target.value),required:!0,minLength:6,className:"ui-input",placeholder:"At least 6 characters"})]}),e.jsx("div",{className:"md:col-span-3",children:e.jsx("button",{type:"submit",disabled:!_||O,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-600 disabled:cursor-not-allowed disabled:bg-slate-400",children:O?"Creating...":"Add Regular Admin"})})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:u}),e.jsx(p,{className:"mt-3",tone:"success",message:m})]}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Add Single Course"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Add one course entry at a time. If the course already exists in the same cluster, the university entry is merged into it."}),r?null:e.jsx(p,{className:"mt-3",tone:"warning",message:"Firebase is not configured for catalog writes."}),e.jsxs("form",{onSubmit:G,className:"mt-5 grid gap-4 md:grid-cols-2",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cluster"}),e.jsx("input",{id:"single_course_cluster",type:"number",min:1,value:S.cluster,onChange:U=>R("cluster",U.target.value),required:!0,className:"ui-input",placeholder:"e.g. 2"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Name"}),e.jsx("input",{id:"single_course_name",type:"text",value:S.name,onChange:U=>R("name",U.target.value),required:!0,className:"ui-input",placeholder:"BACHELOR OF COMMERCE"})]}),e.jsxs("div",{className:"md:col-span-2",children:[e.jsx("label",{htmlFor:"single_course_requirements",className:"mb-1 block text-sm font-medium text-slate-700",children:"Minimum Subject Requirements"}),e.jsx("textarea",{id:"single_course_requirements",value:S.requirementsText,onChange:U=>R("requirementsText",U.target.value),rows:4,className:"ui-textarea",placeholder:`Mathematics: C+
English/Kiswahili: B`})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_university",className:"mb-1 block text-sm font-medium text-slate-700",children:"University"}),e.jsx("input",{id:"single_course_university",type:"text",value:S.universityName,onChange:U=>R("universityName",U.target.value),required:!0,className:"ui-input",placeholder:"University of Nairobi"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_code",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Code"}),e.jsx("input",{id:"single_course_code",type:"text",value:S.courseCode,onChange:U=>R("courseCode",U.target.value),className:"ui-input",placeholder:"1263134"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cutoff",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cutoff Points"}),e.jsx("input",{id:"single_course_cutoff",type:"number",step:"0.001",min:0,value:S.cutoff,onChange:U=>R("cutoff",U.target.value),className:"ui-input",placeholder:"32.613"})]}),e.jsx("div",{className:"md:col-span-2",children:e.jsx("button",{type:"submit",disabled:Y||!r,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-emerald-500 enabled:hover:to-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:Y?"Saving...":"Save Course Entry"})})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:F}),e.jsx(p,{className:"mt-3",tone:"success",message:rn})]})]}),e.jsx(Tr,{firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:Ur}),e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Course Requirements"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Review subject requirements per course to verify catalog accuracy."})]}),e.jsxs("div",{className:"text-xs font-medium text-slate-500",children:["Showing ",en.length," of ",Q.length," courses"]})]}),e.jsxs("div",{className:"mt-4 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_course_search",className:"mb-1 block text-sm font-medium text-slate-700",children:"Search course"}),e.jsx("input",{id:"admin_course_search",type:"text",value:z,onChange:U=>an(U.target.value),className:"ui-input",placeholder:"e.g. Clinical Medicine"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Filter by cluster"}),e.jsxs("select",{id:"admin_course_cluster",value:H,onChange:U=>P(U.target.value),className:"ui-select",children:[e.jsx("option",{value:"all",children:"All clusters"}),nn.map(U=>e.jsxs("option",{value:U,children:["Cluster ",U]},U))]})]})]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Subject Requirements"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Universities"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:en.map(U=>e.jsxs("tr",{className:"hover:bg-slate-50/70",children:[e.jsxs("td",{className:"px-3 py-2 font-medium text-slate-900",children:["Cluster ",U.cluster]}),e.jsx("td",{className:"px-3 py-2",children:U.name}),e.jsx("td",{className:"px-3 py-2 text-slate-600",children:Sr(U.requirements)}),e.jsx("td",{className:"px-3 py-2 text-slate-600",children:U.universities})]},`${U.cluster}-${U.name}`))})]})})]})]})}const Tn=20,dr=["BIO","CHE","MAT","PHY"],mn={code:"",email:"",phoneNumber:"",amountPaid:"0",medicineEligible:!1},Or=r=>{if(!r)return"Unknown";const i=Date.parse(r);return Number.isFinite(i)?new Date(i).toLocaleString():"Unknown"},Kn=r=>{const i=Number(r);return Number.isFinite(i)?i.toFixed(3):"0.000"},re=r=>{const i=r&&typeof r=="object"?r:{};return Array.from({length:20},(n,t)=>{const s=t+1;return{cluster:s,score:Number(i[s]??i[String(s)]??0)}}).map(n=>({...n,score:Number.isFinite(n.score)?n.score:0}))},mr=(r,i=3)=>re(r).sort((n,t)=>t.score-n.score||n.cluster-t.cluster).slice(0,i),hr=r=>[r.code,r.email,r.phoneNumber,r.amountPaid,r.createdAt,r.medicineEligible?"eligible":"not-eligible"].join(" ").toLowerCase(),gr=(r,i)=>{if(i<=7)return Array.from({length:i},(t,s)=>s+1);const n=Math.max(1,Math.min(r-3,i-6));return Array.from({length:7},(t,s)=>n+s)};function vr({firebaseConfigured:r}){const[i,n]=o.useState([]),[t,s]=o.useState(!0),[a,I]=o.useState(""),[N,A]=o.useState(""),[y,c]=o.useState(""),[O,C]=o.useState(""),[u,x]=o.useState(""),[m,g]=o.useState([]),[S,f]=o.useState(1),[Y,v]=o.useState(mn),[F,q]=o.useState(!1),[rn,$]=o.useState(!1),[z,an]=o.useState(""),H=o.useCallback(async()=>{if(!r){s(!1),I("Firebase is not configured."),n([]);return}s(!0),I("");try{const E=await Ze();n(E)}catch(E){I(E.message||"Unable to load cluster sessions."),n([])}finally{s(!1)}},[r]);o.useEffect(()=>{H().catch(()=>{})},[H]);const P=o.useMemo(()=>{const E=String(O||"").trim().toLowerCase();return E?i.filter(h=>hr(h).includes(E)):i},[O,i]),_=o.useMemo(()=>Math.max(1,Math.ceil(P.length/Tn)),[P.length]),Z=o.useMemo(()=>{const E=(S-1)*Tn;return P.slice(E,E+Tn)},[S,P]);o.useMemo(()=>{const E=new Set(P.map(V=>V.email||V.phoneNumber||V.code)).size,h=P.filter(V=>V.medicineEligible).length;return{totalSessions:P.length,uniqueUsers:E,medicineQualifiedCount:h}},[P]);const Q=o.useMemo(()=>new Set(m),[m]),nn=o.useMemo(()=>Z.map(E=>E.code),[Z]),en=nn.length>0&&nn.every(E=>Q.has(E));o.useEffect(()=>{f(1)},[O]),o.useEffect(()=>{S>_&&f(_)},[S,_]),o.useEffect(()=>{const E=new Set(P.map(h=>h.code));g(h=>h.filter(V=>E.has(V))),u&&!E.has(u)&&x(""),Y.code&&!E.has(Y.code)&&v(mn)},[Y.code,u,P]);const d=E=>{g(h=>{const V=new Set(h);return V.has(E)?V.delete(E):V.add(E),Array.from(V)})},R=()=>{g(E=>{const h=new Set(E);return en?nn.forEach(V=>h.delete(V)):nn.forEach(V=>h.add(V)),Array.from(h)})},T=()=>{F||v(mn)},G=async E=>{if(E.preventDefault(),!Y.code)return;A(""),c("");const h=Number(Y.amountPaid);if(!Number.isFinite(h)||h<0){A("Amount paid must be a valid number equal to or greater than 0.");return}q(!0);try{await Qe(Y.code,{email:Y.email,phoneNumber:Y.phoneNumber,amountPaid:h,medicineEligible:Y.medicineEligible}),c(`Session ${Y.code} updated successfully.`),v(mn),await H()}catch(V){A(V.message||"Unable to update session.")}finally{q(!1)}},U=async E=>{if(E&&(A(""),c(""),!!window.confirm(`Delete session ${E}?`))){an(E);try{await Xe(E),c(`Session ${E} deleted.`),g(h=>h.filter(V=>V!==E)),u===E&&x(""),await H()}catch(h){A(h.message||"Unable to delete session.")}finally{an("")}}},M=async()=>{if(m.length&&(A(""),c(""),!!window.confirm(`Delete ${m.length} selected session(s)?`))){$(!0);try{const E=await nr(m);c(`${E} session(s) deleted.`),g([]),u&&m.includes(u)&&x(""),await H()}catch(E){A(E.message||"Unable to delete selected sessions.")}finally{$(!1)}}},K=o.useMemo(()=>gr(S,_),[S,_]),X=P.length?(S-1)*Tn+1:0,B=Math.min(P.length,S*Tn);return e.jsxs("section",{className:"space-y-6",children:[e.jsx("div",{className:"rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Admin Analytics"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Calculated Users Table"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Review users who calculated cluster points and manage records safely."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{type:"button",onClick:()=>H(),className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:[e.jsx(te,{className:"h-4 w-4"}),"Refresh"]}),e.jsxs(cn,{to:"/admin",className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-600",children:[e.jsx(se,{className:"h-4 w-4"}),"Back to Admin"]})]})]})}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"User Calculations"}),e.jsxs("div",{className:"flex w-full flex-wrap items-center justify-end gap-2 lg:w-auto",children:[e.jsx("input",{type:"search",value:O,onChange:E=>C(E.target.value),placeholder:"Search by email, code, phone...",className:"ui-input w-full max-w-sm"}),e.jsxs("button",{type:"button",onClick:R,disabled:!nn.length,className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[en?e.jsx(ae,{className:"h-4 w-4"}):e.jsx(Bn,{className:"h-4 w-4"}),en?"Unselect Page":"Select Page"]}),e.jsxs("button",{type:"button",onClick:M,disabled:!m.length||rn,className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-rose-600 px-3 py-2 text-sm font-semibold text-white transition enabled:hover:bg-rose-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(jn,{className:"h-4 w-4"}),rn?"Deleting...":`Delete Selected (${m.length})`]})]})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:a}),e.jsx(p,{className:"mt-3",tone:"danger",message:N}),e.jsx(p,{className:"mt-3",tone:"success",message:y}),t?e.jsx(p,{className:"mt-3",tone:"info",message:"Loading sessions..."}):null,e.jsx("div",{className:"mt-4 overflow-x-auto",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-xs uppercase tracking-wider text-slate-500",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-3 font-semibold",children:e.jsx("input",{type:"checkbox",checked:en,onChange:R,"aria-label":"Select all on current page",className:"ui-checkbox"})}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Date"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Access Code"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"User"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Best Cluster"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Top 3 Cluster Points"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Actions"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-200 bg-white text-slate-700",children:[!t&&!Z.length?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-3 py-8 text-center text-sm text-slate-500",children:"No calculation sessions found."})}):null,Z.map(E=>{const h=mr(E.results),V=h[0],W=Object.entries(E.grades||{}).filter(([,k])=>k),Un=z===E.code;return e.jsxs(o.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsx("input",{type:"checkbox",checked:Q.has(E.code),onChange:()=>d(E.code),"aria-label":`Select ${E.code}`,className:"ui-checkbox"})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:Or(E.createdAt)}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3 font-mono font-semibold text-slate-900",children:E.code}),e.jsxs("td",{className:"px-3 py-3",children:[e.jsx("p",{className:"font-medium text-slate-900",children:E.email||"No email"}),e.jsx("p",{className:"text-xs text-slate-500",children:E.phoneNumber||"No phone"})]}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:V?`C${V.cluster}: ${Kn(V.score)}`:"N/A"}),e.jsx("td",{className:"px-3 py-3",children:e.jsx("div",{className:"flex flex-wrap gap-1.5",children:h.map(k=>e.jsxs("span",{className:"rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-medium text-slate-700",children:["C",k.cluster,": ",Kn(k.score)]},`${E.code}-${k.cluster}`))})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>x(k=>k===E.code?"":E.code),className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-100",children:[u===E.code?e.jsx(oe,{className:"h-3.5 w-3.5"}):e.jsx(Ee,{className:"h-3.5 w-3.5"}),u===E.code?"Hide":"View"]}),e.jsxs("button",{type:"button",onClick:()=>U(E.code),disabled:Un,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-rose-300 bg-rose-50 px-2.5 py-1.5 text-xs font-semibold text-rose-700 transition enabled:hover:bg-rose-100 disabled:cursor-not-allowed disabled:text-rose-400",children:[e.jsx(jn,{className:"h-3.5 w-3.5"}),Un?"Deleting...":"Delete"]})]})})]}),u===E.code?e.jsx("tr",{className:"bg-slate-50/70",children:e.jsx("td",{colSpan:8,className:"px-3 py-4",children:e.jsxs("div",{className:"grid gap-4 lg:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"Qualification Details"}),e.jsx("p",{className:"mt-2 text-xs text-slate-600",children:"Medicine core subjects (BIO, CHE, MAT, PHY):"}),e.jsx("div",{className:"mt-2 flex flex-wrap gap-1.5",children:dr.map(k=>{var Rn,Hn;return e.jsxs("span",{className:`rounded-full border px-2 py-1 text-xs font-medium ${(Rn=E.grades)!=null&&Rn[k]?"border-emerald-200 bg-emerald-50 text-emerald-700":"border-rose-200 bg-rose-50 text-rose-700"}`,children:[k,": ",((Hn=E.grades)==null?void 0:Hn[k])||"Missing"]},`${E.code}-${k}`)})}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Amount Paid: KES ",E.amountPaid||0]})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3 lg:col-span-2",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"All Cluster Points"}),e.jsx("div",{className:"mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5",children:re(E.results).map(k=>e.jsxs("div",{className:"rounded-lg border border-slate-200 bg-slate-50 px-2 py-2 text-xs",children:[e.jsxs("p",{className:"font-semibold text-slate-700",children:["Cluster ",k.cluster]}),e.jsx("p",{className:"mt-1 font-mono text-slate-900",children:Kn(k.score)})]},`${E.code}-cluster-${k.cluster}`))}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Graded subjects: ",W.length," ",W.length?`(${W.map(([k,Rn])=>`${k}:${Rn}`).join(", ")})`:""]})]})]})})}):null]},E.code)})]})]})}),e.jsxs("div",{className:"mt-4 flex flex-wrap items-center justify-between gap-3",children:[e.jsxs("p",{className:"text-sm text-slate-600",children:["Showing ",X,"-",B," of ",P.length]}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>f(E=>Math.max(1,E-1)),disabled:S<=1,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(Ie,{className:"h-4 w-4"}),"Prev"]}),K.map(E=>e.jsx("button",{type:"button",onClick:()=>f(E),className:`inline-flex items-center justify-center rounded-lg border px-3 py-1.5 text-sm font-semibold transition ${E===S?"border-slate-900 bg-slate-900 text-white":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"}`,children:E},`page-${E}`)),e.jsxs("button",{type:"button",onClick:()=>f(E=>Math.min(_,E+1)),disabled:S>=_,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:["Next",e.jsx(le,{className:"h-4 w-4"})]})]})]})]}),Y.code?e.jsx("div",{className:"fixed inset-0 z-40 flex items-center justify-center bg-slate-900/40 p-4",children:e.jsxs("div",{className:"w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsxs("h3",{className:"text-lg font-semibold text-slate-900",children:["Edit Session ",Y.code]}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Update user contact details, payment amount, and qualification flag."}),e.jsxs("form",{onSubmit:G,className:"mt-4 grid gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"edit_session_email",type:"email",value:Y.email,onChange:E=>v(h=>({...h,email:E.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_phone",className:"mb-1 block text-sm font-medium text-slate-700",children:"Phone Number"}),e.jsx("input",{id:"edit_session_phone",type:"text",value:Y.phoneNumber,onChange:E=>v(h=>({...h,phoneNumber:E.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_amount",className:"mb-1 block text-sm font-medium text-slate-700",children:"Amount Paid"}),e.jsx("input",{id:"edit_session_amount",type:"number",min:0,step:"0.01",value:Y.amountPaid,onChange:E=>v(h=>({...h,amountPaid:E.target.value})),className:"ui-input"})]}),e.jsxs("label",{className:"inline-flex items-center gap-2 text-sm font-medium text-slate-700",children:[e.jsx("input",{type:"checkbox",checked:Y.medicineEligible,onChange:E=>v(h=>({...h,medicineEligible:E.target.checked})),className:"ui-checkbox"}),"Medicine Eligible"]}),e.jsxs("div",{className:"mt-2 flex items-center justify-end gap-2",children:[e.jsxs("button",{type:"button",onClick:T,disabled:F,className:"inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(ce,{className:"h-4 w-4"}),"Cancel"]}),e.jsxs("button",{type:"submit",disabled:F,className:"inline-flex items-center justify-center gap-1.5 rounded-lg bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Bn,{className:"h-4 w-4"}),F?"Saving...":"Save Changes"]})]})]})]})}):null]})}const Cn={darajaPayment:J("/api/payments"),darajaQuery:J("/api/payments/query"),email:J("/sendEmail"),calculateCluster:J("/calculateClusterPoints"),adminHealth:J("/api/admin/health")},Yr=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Yn=async({url:r,headers:i,body:n})=>{const t=await fetch(r,{method:"POST",credentials:"include",headers:i||{},body:n||void 0}),s=await Yr(t);return{ok:t.ok,status:t.status,data:s}},Mn=(r,i)=>{const n=(r==null?void 0:r.data)||{},t=(n==null?void 0:n.error)||(n==null?void 0:n.message)||(n==null?void 0:n.errorMessage)||(n==null?void 0:n.ResultDesc);return t?String(t):i},fn=r=>r&&typeof r=="object"&&"data"in r&&r.success!==!1?r.data:r,Mr=r=>({source:"local-engine",results:Le(r),medicineEligible:Ke(r)}),fr=async r=>{const i=(r==null?void 0:r["phone number"])||(r==null?void 0:r.phone_number)||(r==null?void 0:r.phoneNumber)||(r==null?void 0:r.phone)||"",n=Number((r==null?void 0:r.amount)??0),t=await Yn({url:Cn.darajaPayment,headers:{"Content-Type":"application/json"},body:JSON.stringify({phone_number:i,amount:n,account_reference:String((r==null?void 0:r.account_reference)||(r==null?void 0:r.accountReference)||"KUCCPS-CLUSTER"),transaction_description:String((r==null?void 0:r.transaction_description)||(r==null?void 0:r.transactionDesc)||"Cluster payment")})});if(!t.ok)throw new Error(Mn(t,"Unable to initiate STK push."));return fn(t.data)},_n=async r=>{const i=String((r==null?void 0:r.email)||"").trim(),n=String((r==null?void 0:r.subject)||"").trim(),t=String((r==null?void 0:r.message)||"");if(!i||!n||!t)throw new Error("Email, subject and message are required.");const s=new URLSearchParams({email:i,subject:n,message:t}).toString(),a=[{url:Cn.email,headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,subject:n,message:t})},{url:Cn.email,headers:{"Content-Type":"application/x-www-form-urlencoded"},body:s}],I=[],N=[];for(const y of a){const c=await Yn(y);if(c.ok)return fn(c.data);I.push(c.status),N.push(Mn(c,`HTTP ${c.status}`))}const A=N.filter(Boolean).join(" | ");throw new Error(`Email API request failed. ${A||`Status codes: ${I.join(", ")}.`}`)},Vr=async({checkoutRequestId:r})=>{const i={checkoutRequestId:String(r||"").trim()};if(!i.checkoutRequestId)throw new Error("checkoutRequestId is required.");const n=await Yn({url:Cn.darajaQuery,headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(n.ok)return fn(n.data);throw new Error(Mn(n,"Unable to fetch payment status."))},Wn=r=>new Promise(i=>window.setTimeout(i,r)),Kr=async({checkoutRequestId:r,timeoutMs:i=3e5,intervalMs:n=3e3,onStatus:t})=>{var I;const s=Date.now();let a="";for(;Date.now()-s<=i;){let N;try{N=await Vr({checkoutRequestId:r})}catch(c){a=String((c==null?void 0:c.message)||"").trim()||a,t==null||t({status:"pending",transientError:!0,resultDesc:a||"Temporary payment status check issue."}),await Wn(n);continue}t==null||t(N);const A=String((N==null?void 0:N.status)||"").trim().toLowerCase(),y=Number(((I=N==null?void 0:N.queryResponse)==null?void 0:I.ResultCode)??NaN);if(A==="success"||y===0)return N;if(A==="failed")throw new Error((N==null?void 0:N.resultDesc)||"Payment failed. Please try again.");await Wn(n)}throw new Error(a?`Timed out while waiting for M-Pesa confirmation. Last status: ${a}`:"Timed out while waiting for M-Pesa confirmation.")},br=async({grades:r,checkoutRequestId:i,merchantRequestId:n})=>{const t={grades:r||{},checkoutRequestId:String(i||"").trim(),merchantRequestId:String(n||"").trim()};if(!t.checkoutRequestId&&!t.merchantRequestId)throw new Error("checkoutRequestId or merchantRequestId is required before calculation.");const s=await Yn({url:Cn.calculateCluster,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(s.ok)return fn(s.data);throw new Error(Mn(s,"Unable to calculate cluster points after payment."))},Lr=r=>r==="saved-session"?"Saved Session":r==="firebase-function"?"Firebase Function":"Local Cluster Engine",xr=r=>Number(r||0).toFixed(3).replace(/\.?0+$/,""),pr=(r,i)=>{const n=Object.entries(r||{}).map(([t,s])=>[t,Number(s)]).filter(([,t])=>Number.isFinite(t)&&t>0).sort((t,s)=>s[1]-t[1]).slice(0,i);return n.length?["Top cluster points:",...n.map(([t,s],a)=>`${a+1}. Cluster ${t}: ${xr(s)}`)]:[]},Gr=({code:r,results:i,medicineEligible:n})=>{const t=["Your KUCCPS cluster calculation is ready.","",`Access code: ${r}`];return i&&Object.keys(i).length>0&&t.push("",...pr(i,3)),typeof n=="boolean"&&t.push("",`Medicine eligibility: ${n?"Eligible":"Not eligible"}.`),t.push("","Use this code on the home page to open your saved cluster points and continue course selection."),t.join(`
`)},Fr=({payableAmount:r})=>["We received your email for KUCCPS cluster calculation.","",`Next step: complete the M-Pesa payment of KES ${Number(r||0)}.`,"We will email your access code after the payment is confirmed."].join(`
`),Hr=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Br=r=>Hr.test(String(r||"").trim()),jr=r=>{const i=String(r||"").replace(/\D/g,"");return i.length===10&&i.startsWith("0")?`254${i.slice(1)}`:i.length===9&&i.startsWith("7")?`254${i}`:i.length===12&&i.startsWith("254")?i:null},zn=()=>Object.fromEntries(Object.keys(pn).map(r=>[r,""])),wr="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:shadow",Pr="mt-3 inline-flex w-full items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100",Dr="ui-select";function kr({onCalculationReady:r,payableAmount:i,gradeOptions:n}){const t=hn(),[s,a]=o.useState(zn()),[I,N]=o.useState(Object.fromEntries(kn.map((d,R)=>[d.title,R===0]))),[A,y]=o.useState(!1),[c,O]=o.useState(""),[C,u]=o.useState(""),[x,m]=o.useState(""),[g,S]=o.useState(null),[f,Y]=o.useState(""),[v,F]=o.useState(""),[q,rn]=o.useState(""),[$,z]=o.useState(!1),[an,H]=o.useState(""),P=(d,R)=>{a(T=>({...T,[d]:R}))},_=d=>pn[d]||d,Z=()=>Object.entries(s).filter(([,d])=>d&&d!=="").map(([d])=>d),Q=d=>{N(R=>{const T=Object.fromEntries(Object.keys(R).map(G=>[G,!1]));return T[d]=!R[d],T})},nn=async d=>{d.preventDefault(),H(""),u(""),m("");const R=Z();if(R.length<7){H("Select grades for at least 7 subjects across all groups to compute cluster points.");return}const T=zn();R.forEach(U=>{T[U]=s[U]});const G=String(v||"").trim();if(!Br(G)){H("Enter a valid email address.");return}S(T),Y(G);try{z(!0),G&&G!==q&&(await _n({email:G,subject:"KUCCPS Cluster Calculator: Email received",message:Fr({payableAmount:i})}),rn(G))}catch(U){const M=U instanceof Error?U.message:"";H(M?`Unable to send confirmation email (${M}). Please verify your email and try again.`:"Unable to send confirmation email. Please verify your email and try again.");return}finally{z(!1)}y(!0)},en=async d=>{if(d.preventDefault(),u(""),m(""),!g){u("Please submit your grades and email first.");return}if(!f){u("Enter a valid email before continuing.");return}const R=jr(c);if(!R){u("Enter a valid M-Pesa phone number e.g. 0712345678 or 254712345678.");return}z(!0);try{m("Sending the STK push to your phone...");const T=await fr({amount:i,phone_number:R,phone:R,phoneNumber:R,"phone number":R}),G=String((T==null?void 0:T.CheckoutRequestID)||(T==null?void 0:T.checkoutRequestId)||"").trim(),U=String((T==null?void 0:T.MerchantRequestID)||(T==null?void 0:T.merchantRequestId)||"").trim();if(!G&&!U)throw new Error("STK push response did not include a payment reference.");m("STK push sent. Complete the payment on your phone. Waiting for confirmation...");const M=await Kr({checkoutRequestId:G,merchantRequestId:U,onStatus:W=>{(W==null?void 0:W.status)==="pending"&&m("Waiting for M-Pesa confirmation. Complete the prompt on your phone to continue.")}});m("Payment confirmed. Calculating cluster points...");let K,X="";try{K=await br({grades:g,checkoutRequestId:G,merchantRequestId:U})}catch(W){K=Mr(g),X=String((W==null?void 0:W.message)||"").trim()||"Backend calculation API was unavailable, so a local verified fallback was used."}const{session:B,storage:E,warning:h}=await We({email:f,phoneNumber:R,amountPaid:i,grades:g,results:K.results,medicineEligible:K.medicineEligible,paymentResponse:{initiation:T,confirmation:M}}),V=["Payment confirmed."];X&&V.push(`Cluster points calculated locally (${X}).`),E==="local"?V.push(h||"Firebase save failed. Session was saved on this browser only, so code restore works only on this device."):V.push("Session saved to Firebase.");try{await _n({email:f,subject:"KUCCPS Cluster Calculator Results",message:Gr({code:B.code,results:K.results,medicineEligible:K.medicineEligible})}),V.push(`Results email sent to ${f}.`)}catch(W){const Un=W instanceof Error?W.message:"";V.push(Un?`Email delivery failed (${Un}). Save this code: ${B.code}.`:`Email delivery failed. Save this code: ${B.code}.`)}r({grades:g,results:K.results,source:K.source,accessCode:B.code,sessionMessage:V.join(" ")}),y(!1),u(""),m(""),H(""),t("/results")}catch(T){const G=T instanceof Error?T.message:"Payment or calculation failed.";u(G),H(G),m("")}finally{z(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Cluster Points Calculator"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Enter your grades and email, then start payment. Cluster points are only shown after the M-Pesa payment is confirmed."}),e.jsxs("p",{className:"mt-1 text-sm font-medium text-emerald-700",children:["Amount: KES ",i]}),e.jsxs("form",{onSubmit:nn,className:"mt-6 space-y-6",children:[e.jsx(p,{tone:"danger",message:an}),e.jsx("div",{className:"grid gap-5 xl:grid-cols-2",children:kn.map(d=>e.jsxs("article",{className:wr,children:[e.jsx("div",{className:"flex items-start justify-between gap-3",children:e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-semibold text-slate-900",children:d.title}),e.jsx("p",{className:"mt-1 text-xs text-slate-500",children:d.required?"Core group. Enter grades for all listed subjects.":"Optional group. Fill available subjects."})]})}),e.jsxs("button",{type:"button",onClick:()=>Q(d.title),className:Pr,children:[e.jsx("span",{children:I[d.title]?"Hide grade fields":"Show grade fields"}),e.jsx(Ne,{className:`h-4 w-4 text-slate-500 transition-transform ${I[d.title]?"rotate-180":"rotate-0"}`})]}),I[d.title]?e.jsx("div",{className:"mt-4 grid gap-3 sm:grid-cols-2",children:d.subjects.map(R=>e.jsxs("div",{children:[e.jsxs("label",{htmlFor:`${d.title}-${R}`,className:"mb-1 block text-sm font-medium text-slate-700",children:[_(R),d.required?e.jsx("span",{className:"text-rose-600",children:" *"}):null]}),e.jsxs("select",{id:`${d.title}-${R}`,value:s[R],onChange:T=>P(R,T.target.value),required:d.required,className:Dr,children:[e.jsx("option",{value:"",children:"Select grade"}),n.map(T=>e.jsx("option",{value:T,children:T},T))]})]},R))}):null]},d.title))}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email Address (for access code)"}),e.jsx("input",{id:"email",type:"email",value:v,onChange:d=>F(d.target.value),placeholder:"you@example.com",required:!0,className:"ui-input"})]}),e.jsx("button",{type:"submit",disabled:$,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:$?"Processing...":"Calculate Cluster Points"})]}),A?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 px-4",children:e.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsx("h2",{className:"text-lg font-semibold text-slate-900",children:"Enter M-Pesa Phone Number"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["We will send an STK push for KES ",i,". Your cluster points remain locked until the payment is confirmed."]}),e.jsxs("form",{onSubmit:en,className:"mt-4 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"dialog_phone_number",className:"mb-1 block text-sm font-medium text-slate-700",children:"M-Pesa Phone Number"}),e.jsx("input",{id:"dialog_phone_number",type:"tel",value:c,onChange:d=>O(d.target.value),placeholder:"0712345678",autoFocus:!0,required:!0,className:"ui-input"})]}),e.jsx(p,{tone:"info",message:x}),e.jsx(p,{tone:"danger",message:C}),e.jsxs("div",{className:"flex items-center justify-end gap-3",children:[e.jsx("button",{type:"button",onClick:()=>{$||(y(!1),u(""))},disabled:$,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60",children:"Cancel"}),e.jsx("button",{type:"submit",disabled:$,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-700 disabled:cursor-not-allowed disabled:bg-slate-400",children:$?"Processing...":"Send STK Push"})]})]})]})}):null]})}const bn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},Jr={ENGLISH:"ENG",KISWAHILI:"KIS",MATHEMATICS:"MAT",MATH:"MAT",BIOLOGY:"BIO",CHEMISTRY:"CHE",PHYSICS:"PHY","GENERAL SCIENCE":"GSC",HISTORY:"HAG","HISTORY & GOVERNMENT":"HAG",GEOGRAPHY:"GEO",CRE:"CRE",IRE:"IRE",HRE:"HRE","COMPUTER STUDIES":"CMP",AGRICULTURE:"AGR","ART & DESIGN":"ARD","HOME SCIENCE":"HSC","BUSINESS STUDIES":"BST",FRENCH:"FRE",GERMAN:"GER",MUSIC:"MUS",ARABIC:"ARB"},qr=(r,i)=>{const n=[];for(const[t,s]of Object.entries(i||{})){const a=String(s||"").trim().toUpperCase();if(!(a in bn))continue;const I=String(t).split("/").map(c=>{const O=c.trim().toUpperCase();return Jr[O]||O});let N=!1,A=null,y=null;for(const c of I){const O=(r[c]||"").toUpperCase();if(O){if((bn[O]||0)>=bn[a]){N=!0;break}A=c,y=O}}N||n.push({subject:t,required:a,studentSubject:A,studentGrade:y})}return{passed:n.length===0,failed:n}};function $r({results:r,grades:i,courseCatalog:n}){const[t]=Ue(),s=Number(t.get("cluster")||0),a=t.get("course")||"";if(!r||!i)return e.jsx(In,{to:"/",replace:!0});if(!s||!a)return e.jsx(In,{to:"/results",replace:!0});const N=(n[s]||[]).find(C=>C.name===a);if(!N)return e.jsx(In,{to:"/results",replace:!0});const A=Number(r[s]??r[String(s)]??0),y=qr(i,N.requirements),c=[],O=C=>Number(C||0).toFixed(3).replace(/\.?0+$/,"");if(y.passed)for(const C of N.universities||[])A>=Number(C.cutoff)&&c.push(C);return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:a}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 text-sm text-slate-700",children:[e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster:"})," ",s]}),e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster Points:"})," ",A]})]})]}),y.passed?c.length?e.jsxs("article",{className:"rounded-2xl border border-emerald-200 bg-white p-5 shadow-sm",children:[e.jsx("h2",{className:"text-lg font-semibold text-emerald-900",children:"Qualified Universities"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["You qualify for ",c.length," ",c.length===1?"university":"universities"," based on your cluster points."]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-emerald-100",children:e.jsxs("table",{className:"min-w-full divide-y divide-emerald-100 text-sm",children:[e.jsx("thead",{className:"bg-emerald-50 text-left text-emerald-900",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"University"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cutoff"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Your Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Margin"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Status"})]})}),e.jsx("tbody",{className:"divide-y divide-emerald-50 bg-white text-slate-700",children:c.slice().sort((C,u)=>Number(u.cutoff)-Number(C.cutoff)).map(C=>e.jsxs("tr",{className:"hover:bg-emerald-50/40",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:C.name}),e.jsx("td",{className:"px-3 py-2",children:O(C.cutoff)}),e.jsx("td",{className:"px-3 py-2",children:O(A)}),e.jsxs("td",{className:"px-3 py-2 text-emerald-700",children:["+",O(A-Number(C.cutoff))]}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:"rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs font-semibold text-emerald-800",children:"Qualified"})})]},`${C.name}-${C.cutoff}`))})]})})]}):e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"Based on your current cluster points, you do not qualify for any listed university for this course."})]}):e.jsxs("div",{className:"space-y-4",children:[e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"You do not meet subject requirements for this course, so you are not qualified for any listed university."})]}),e.jsxs("article",{className:"rounded-2xl border border-rose-200 bg-rose-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-rose-900",children:"Subject Requirements Not Met"}),e.jsx("ul",{className:"mt-3 space-y-1 text-sm text-rose-900",children:y.failed.map(C=>e.jsxs("li",{children:[C.subject," required >= ",C.required,C.studentSubject?` (you had ${C.studentSubject}: ${C.studentGrade})`:" (subject not done)"]},`${C.subject}-${C.required}`))})]})]}),e.jsx("div",{children:e.jsx(cn,{to:"/results",className:"text-sm font-medium text-slate-700 hover:text-slate-900",children:"Back to Results"})})]})}function _r({onRestoreByCode:r,payableAmount:i}){const n=hn(),[t,s]=o.useState(""),[a,I]=o.useState(""),[N,A]=o.useState(!1),y=async c=>{c.preventDefault(),I(""),A(!0);try{if(!await r(t)){I("Code not found. Confirm the code sent to your email.");return}n("/results")}catch(O){I(O.message||"Unable to load code.")}finally{A(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-12",children:[e.jsx("h1",{className:"mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl",children:"Start a new calculation or continue with your access code"}),e.jsxs("p",{className:"mt-4 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg",children:["New users pay KES ",i,", then receive a unique code by email to reopen saved results later."]}),e.jsxs("div",{className:"mt-6 flex flex-row items-center gap-4",children:[e.jsx("div",{className:"mt-8",children:e.jsx(cn,{to:"/calculator",className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:from-slate-800 hover:to-slate-700",children:"Get Started"})}),e.jsxs("form",{onSubmit:y,className:"max-w-xl space-y-3 rounded-xl",children:[e.jsx("label",{htmlFor:"access_code",className:"block text-sm font-medium text-slate-700",children:"Have an access code? Paste it here"}),e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row",children:[e.jsx("input",{id:"access_code",type:"text",value:t,onChange:c=>s(c.target.value.toUpperCase()),placeholder:"e.g. 8F3KQ2P9",className:"ui-input",required:!0}),e.jsx("button",{type:"submit",disabled:N,className:"inline-flex items-center justify-center rounded-lg bg-emerald-700 px-6 py-2 text-sm font-semibold text-white transition enabled:hover:bg-emerald-600 disabled:cursor-not-allowed disabled:bg-emerald-400",children:N?"Opening...":"Open"})]}),e.jsx(p,{tone:"danger",message:a})]})]})]})}function Wr({clusters:r,getScore:i,courseCatalog:n,selectedCourses:t,onSelectCourse:s,onCheckCourse:a}){return e.jsx("div",{className:"mt-6 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-100 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course Check"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:r.map(I=>{const N=n[I]||[];return e.jsxs("tr",{className:"align-top hover:bg-slate-50",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:I}),e.jsx("td",{className:"px-3 py-2",children:i(I)}),e.jsx("td",{className:"px-3 py-2",children:e.jsxs("div",{className:"flex flex-col gap-2 sm:flex-row",children:[e.jsxs("select",{value:t[I]||"",onChange:A=>s(I,A.target.value),className:"ui-select sm:max-w-sm",children:[e.jsx("option",{value:"",children:"Select Course"}),N.map(A=>e.jsx("option",{value:A.name,children:A.name},A.name))]}),e.jsx("button",{type:"button",disabled:!t[I],onClick:()=>a(I,t[I]),className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-3 py-2 text-xs font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Check"})]})})]},I)})})]})})}function zr({results:r,grades:i,source:n,courseCatalog:t,courseCatalogError:s,catalogLoading:a,accessCode:I,sessionMessage:N}){const A=hn(),[y,c]=o.useState({});if(!r||!i)return e.jsx(In,{to:"/",replace:!0});const O=Array.from({length:20},(u,x)=>x+1),C=u=>Number(r[u]??r[String(u)]??0);return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"All Cluster Points"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Select a course to evaluate your qualification details."}),e.jsxs("p",{className:"mt-1 text-xs font-medium text-slate-500",children:["Calculation source: ",Lr(n)]}),I?e.jsx(p,{className:"mt-3",tone:"success",message:`Access code: ${I}`}):null,e.jsx(p,{className:"mt-2",tone:"info",message:N}),a?e.jsx(p,{className:"mt-2",tone:"info",message:"Loading course catalog..."}):null,e.jsx(p,{className:"mt-2",tone:"danger",message:s}),e.jsx(Wr,{clusters:O,getScore:C,courseCatalog:t,selectedCourses:y,onSelectCourse:(u,x)=>c(m=>({...m,[u]:x})),onCheckCourse:(u,x)=>A(`/course-result?cluster=${u}&course=${encodeURIComponent(x)}`)})]})}const Zr=()=>Object.fromEntries(Object.keys(pn).map(r=>[r,""]));function Qr(){const r=Zn(),[i,n]=o.useState(null),[t,s]=o.useState(null),[a,I]=o.useState("local-engine"),[N,A]=o.useState(""),[y,c]=o.useState(""),O=o.useMemo(()=>ke(),[]),C=r.pathname.startsWith("/admin");o.useEffect(()=>{ne().catch(()=>{})},[]);const{courseCatalog:u,catalogLoading:x,courseCatalogError:m,saveCatalog:g,saveSingleCourse:S}=cr({mode:C?"admin":"public"}),{adminUser:f,adminProfile:Y,authLoading:v,authWorking:F,authError:q,isAdminAuthenticated:rn,login:$,loginWithGoogle:z,logout:an,addRegularAdmin:H}=Ye({enabled:C}),P=o.useCallback(async R=>{const T=await ze(R);return!T||!T.results?null:(n(T.grades||Zr()),s(T.results||null),I("saved-session"),A(T.code),c(T.createdAt?`Loaded ${T.storage==="local"?"local":"saved"} session from ${new Date(T.createdAt).toLocaleString()}.`:`Loaded ${T.storage==="local"?"local":"saved"} session.`),T)},[]),_=o.useCallback(async R=>{await g(R)},[g]),Z=o.useCallback(async R=>{await S(R)},[S]),Q=o.useCallback(async(R,T)=>await $(R,T),[$]),nn=o.useCallback(async()=>await z(),[z]),en=o.useCallback(async()=>{await an()},[an]),d=o.useCallback(R=>v?e.jsx("section",{className:"mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:e.jsx(p,{tone:"info",message:"Checking admin authentication..."})}):rn?R:e.jsx(In,{to:"/admin/login",replace:!0}),[v,rn]);return e.jsx(Re,{children:e.jsxs(Ae,{children:[e.jsx(on,{path:"/",element:e.jsx(_r,{onRestoreByCode:P,payableAmount:Pn})}),e.jsx(on,{path:"/admin/login",element:e.jsx(Nr,{isAuthenticated:rn,onLogin:Q,onGoogleLogin:nn,authError:q,isLoading:F||v})}),e.jsx(on,{path:"/admin",element:d(e.jsx(ur,{firebaseConfigured:O,onUploadCatalog:_,onAddSingleCourse:Z,onLogout:en,onAddRegularAdmin:H,adminProfile:Y,adminEmail:(f==null?void 0:f.email)||"",authError:q,courseCatalog:u}))}),e.jsx(on,{path:"/admin/sessions",element:d(e.jsx(vr,{firebaseConfigured:O}))}),e.jsx(on,{path:"/calculator",element:e.jsx(kr,{gradeOptions:ue,payableAmount:Pn,onCalculationReady:({grades:R,results:T,source:G,accessCode:U,sessionMessage:M})=>{n(R),s(T),I(G),A(U||""),c(M||"")}})}),e.jsx(on,{path:"/payment",element:e.jsx(In,{to:"/calculator",replace:!0})}),e.jsx(on,{path:"/results",element:e.jsx(zr,{results:t,grades:i,source:a,courseCatalog:u,courseCatalogError:m,catalogLoading:x,accessCode:N,sessionMessage:y})}),e.jsx(on,{path:"/course-result",element:e.jsx($r,{results:t,grades:i,courseCatalog:u})}),e.jsx(on,{path:"*",element:e.jsx(In,{to:"/",replace:!0})})]})})}Te.createRoot(document.getElementById("root")).render(e.jsx(ye.StrictMode,{children:e.jsx(Ce,{children:e.jsx(Qr,{})})}));
