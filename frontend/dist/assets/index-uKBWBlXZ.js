import{u as Wn,j as e,L as In,r as I,P as Xn,a as Sn,N as tn,R as ne,A as ee,S as re,b as Fn,T as Bn,E as ie,c as te,C as se,d as ae,X as oe,e as Ee,f as Ie,g as le,h as X,i as ce,k as Ne,B as Ue}from"./vendor-1jWIULEY.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Ae=[{path:"/",label:"Home"},{path:"/calculator",label:"Calculator"},{path:"/admin",label:"Login"}];function Te({children:r}){const{pathname:i}=Wn(),n=t=>`rounded-lg px-3 py-2 text-sm font-medium transition ${i===t?"bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-sm":"text-slate-700 hover:bg-slate-100"}`;return e.jsxs("div",{className:"min-h-screen bg-mesh text-slate-900",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 backdrop-blur",children:e.jsxs("div",{className:"mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4",children:[e.jsx(In,{to:"/",className:"text-lg font-semibold tracking-tight text-slate-900",children:"Cluster Calculation"}),e.jsx("nav",{className:"flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm",children:Ae.map(t=>e.jsx(In,{to:t.path,className:n(t.path),children:t.label},t.path))})]})}),e.jsx("main",{className:"mx-auto w-full max-w-7xl px-4 py-8",children:r})]})}const wn={danger:"border-rose-200 bg-rose-50 text-rose-700",warning:"border-amber-200 bg-amber-50 text-amber-700",success:"border-emerald-200 bg-emerald-50 text-emerald-700",info:"border-slate-200 bg-slate-50 text-slate-700"};function p({message:r,tone:i="info",className:n=""}){return r?e.jsx("p",{className:`rounded-lg border px-3 py-2 text-sm ${wn[i]||wn.info} ${n}`,children:r}):null}const ye=["A","A-","B+","B","B-","C+","C","C-","D+","D","D-","E"],Ce=(r,i)=>{const n=Number(r);return Number.isFinite(n)?n:i},Se="150".trim(),Dn=Ce(Se,0),Re="".trim(),Yn=Re.replace(/\/+$/,""),Oe=r=>/^https?:\/\//i.test(r),j=r=>{const i=String(r||"").trim();if(!i)return Yn||"";if(Oe(i)||!Yn)return i;const n=i.startsWith("/")?i:`/${i}`;return`${Yn}${n}`},Mn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},Pn=(r,i)=>String((r==null?void 0:r.error)||(r==null?void 0:r.message)||i).trim()||i,ue=({enabled:r=!0}={})=>{const[i,n]=I.useState(null),[t,s]=I.useState(null),[a,l]=I.useState(r),[N,U]=I.useState(!1),[C,c]=I.useState(""),O=I.useMemo(()=>!0,[]),T=I.useCallback(async()=>{l(!0);try{const y=await fetch(j("/api/admin/me"),{method:"GET",credentials:"include"}),g=await Mn(y);if(!y.ok){n(null),s(null);return}n((g==null?void 0:g.user)||null),s((g==null?void 0:g.profile)||null),c("")}catch{n(null),s(null)}finally{l(!1)}},[]);I.useEffect(()=>{if(!r){l(!1);return}T().catch(()=>{})},[r,T]);const S=I.useCallback(async(y,g)=>{U(!0),c("");try{const Y=await fetch(j("/api/admin/login"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(y||"").trim(),password:String(g||"")})}),v=await Mn(Y);if(!Y.ok){const H=Pn(v,"Authentication request failed.");return c(H),{success:!1,error:H}}return n((v==null?void 0:v.user)||null),s((v==null?void 0:v.profile)||null),c(""),{success:!0,user:(v==null?void 0:v.user)||void 0,profile:(v==null?void 0:v.profile)||void 0,error:""}}catch(Y){const v=(Y==null?void 0:Y.message)||"Authentication request failed.";return c(v),{success:!1,error:v}}finally{U(!1)}},[]),x=I.useCallback(async()=>{const y="Google popup login is disabled in backend-auth mode. Use email and password.";return c(y),{success:!1,error:y}},[]),u=I.useCallback(async()=>{U(!0);try{await fetch(j("/api/admin/logout"),{method:"POST",credentials:"include"})}finally{n(null),s(null),c(""),U(!1)}},[]),h=I.useCallback(async({email:y,password:g,name:Y})=>{if(!i||!t)throw new Error("You must be logged in as admin.");if(t.role!=="super")throw new Error("Only a super admin can add regular admin users.");const v=await fetch(j("/api/admin/regular-admin"),{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:String(y||"").trim(),password:String(g||""),name:String(Y||"").trim()})}),H=await Mn(v);if(!v.ok)throw new Error(Pn(H,"Unable to create regular admin."));return{user:(H==null?void 0:H.user)||null,profile:(H==null?void 0:H.profile)||null}},[t,i]);return{firebaseAuthReady:O,adminUser:i,adminProfile:t,authLoading:a,authWorking:N,authError:C,isAdminAuthenticated:!!(i&&t),login:S,loginWithGoogle:x,logout:u,addRegularAdmin:h}},Kn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},Ln={ENG:"English",KIS:"Kiswahili",MAT:"Mathematics",BIO:"Biology",CHE:"Chemistry",PHY:"Physics",GSC:"General Science",HAG:"History",GEO:"Geography",CRE:"CRE",IRE:"IRE",HRE:"HRE",CMP:"Computer Studies",AGR:"Agriculture",ARD:"Art & Design",HSC:"Home Science",BST:"Business Studies",FRE:"French",GER:"German",MUS:"Music",ARB:"Arabic"},jn=[{title:"Group I",required:!0,subjects:["ENG","KIS","MAT"]},{title:"Group II (Sciences)",required:!1,subjects:["BIO","CHE","PHY","GSC"]},{title:"Group III (Humanities)",required:!1,subjects:["HAG","GEO","CRE","IRE","HRE"]},{title:"Group IV (Technical)",required:!1,subjects:["CMP","AGR","ARD","HSC"]},{title:"Group V (Others)",required:!1,subjects:["BST","FRE","GER","MUS","ARB"]}],de=["ENG","KIS","MAT"],b=["BIO","CHE","PHY","GSC"],V=["HAG","GEO","CRE","IRE","HRE"],B=["CMP","AGR","ARD","HSC"],w=["BST","FRE","GER","MUS","ARB"],An=[...de,...b,...V,...B,...w],E=(r,i)=>Math.max(...i.map(n=>n in r?r[n]:0),0),D=(r,i,n)=>{const t=i.filter(s=>s in r).map(s=>r[s]).sort((s,a)=>a-s);return t.length>=n?t[n-1]:0},me=r=>{const i=Object.values(r).sort((n,t)=>t-n);return i.length>=7?i.slice(0,7).reduce((n,t)=>n+t,0):0},he=(r,i)=>Number((Math.sqrt(r/48*(i/84))*48*.94).toFixed(3)),ve=r=>["BIO","CHE","MAT","PHY"].every(n=>r[n]&&r[n]in Kn),ge=(r,i)=>{const n={};for(const[l,N]of Object.entries(i))N in Kn&&(n[l]=Kn[N]);if(Object.keys(n).length<7)return 0;const t=me(n),s=()=>0;let a=0;if(r===1){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b))+E(n,V)+Math.max(E(n,b),D(n,V,2),E(n,B),E(n,w))}else if(r===2){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+(n.MAT??0)+Math.max(E(n,b),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),E(n,w))}else if(r===3){if(!("ENG"in n||"KIS"in n))return s();a=E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b))+E(n,V)+Math.max(E(n,b),D(n,V,2),E(n,B),E(n,w))}else if(r===4){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(n.BIO??0,n.CHE??0,n.GEO??0)+Math.max(E(n,b),E(n,V),E(n,B),E(n,w))}else if(r===5){if(!("MAT"in n&&"PHY"in n&&"CHE"in n))return s();a=n.MAT+n.PHY+n.CHE+Math.max(n.BIO??0,E(n,V),E(n,B),E(n,w))}else if(r===6){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+E(n,V)+Math.max(D(n,b,2),D(n,V,2),E(n,B),E(n,w))}else if(r===7){if(!("MAT"in n&&"PHY"in n))return s();a=n.MAT+n.PHY+Math.max(D(n,b,2),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),E(n,w))}else if(r===8){if(!("MAT"in n&&"BIO"in n))return s();a=n.MAT+n.BIO+Math.max(n.PHY??0,n.CHE??0)+Math.max(D(n,b,3),E(n,V),E(n,B),E(n,w))}else if(r===9){if(!("MAT"in n))return s();a=n.MAT+E(n,b)+D(n,b,2)+Math.max(D(n,b,3),E(n,V),E(n,B),E(n,w))}else if(r===10){if(!("MAT"in n))return s();a=n.MAT+E(n,b)+E(n,V)+Math.max(D(n,b,2),D(n,V,2),E(n,B),E(n,w))}else if(r===11)a=Math.max((n.CHE??0)+Math.max(n.MAT??0,n.PHY??0)+Math.max(n.BIO??0,n.HSC??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,B),E(n,w)),Math.max(n.BIO??0,n.GSC??0)+(n.MAT??0)+Math.max(E(n,b),E(n,V))+Math.max(E(n,["ENG","KIS"]),E(n,b),E(n,V),E(n,B),E(n,w)));else if(r===12||r===13){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0)+Math.max(E(n,["ENG","KIS"]),D(n,b,3),E(n,V),E(n,B),E(n,w))}else if(r===14){if(!("CHE"in n))return s();a=Math.max(n.BIO??0,n.AGR??0,n.HSC??0)+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.GEO??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,B),E(n,w))}else if(r===15){if(!("BIO"in n&&"CHE"in n))return s();a=n.BIO+n.CHE+Math.max(n.MAT??0,n.PHY??0,n.AGR??0)+Math.max(E(n,["ENG","KIS"]),E(n,V),E(n,B),E(n,w))}else if(r===16){if(!("GEO"in n))return s();a=n.GEO+(n.MAT??0)+E(n,b)+Math.max(D(n,b,2),D(n,V,2),E(n,B),E(n,w))}else if(r===17){if(!("FRE"in n||"GER"in n))return s();a=E(n,["FRE","GER"])+E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),D(n,w,2))}else if(r===18){if(!("MUS"in n))return s();a=n.MUS+E(n,["ENG","KIS"])+Math.max(n.MAT??0,E(n,b),E(n,V))+Math.max(E(n,b),E(n,V),E(n,B),D(n,w,2))}else if(r===19)a=E(n,An)+D(n,An,2)+D(n,An,3)+D(n,An,4);else if(r===20){if(!(n.CRE||n.IRE||n.HRE))return s();a=E(n,["CRE","IRE","HRE"])+E(n,["ENG","KIS"])+D(n,V,2)+Math.max(E(n,b),E(n,B),E(n,w))}else return s();return he(a,t)},Ye=r=>{const i={};for(let n=1;n<=20;n+=1)i[n]=ge(n,r);return i},Zn="kuccps.cluster.sessions",en={catalog:j("/api/catalog"),adminCatalogUpload:j("/api/admin/catalog/upload"),adminCatalogCourse:j("/api/admin/catalog/course"),sessions:j("/api/sessions"),adminSessions:j("/api/admin/sessions"),adminSessionsBulkDelete:j("/api/admin/sessions/delete-many"),adminMe:j("/api/admin/me")},Rn=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},bn=async r=>{const i=await fetch(r,{method:"GET",credentials:"include"}),n=await Rn(i);return{ok:i.ok,status:i.status,data:n}},On=async(r,i)=>{const n=await fetch(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await Rn(n);return{ok:n.ok,status:n.status,data:t}},Me=async(r,i)=>{const n=await fetch(r,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(i??{})}),t=await Rn(n);return{ok:n.ok,status:n.status,data:t}},fe=async r=>{const i=await fetch(r,{method:"DELETE",credentials:"include"}),n=await Rn(i);return{ok:i.ok,status:i.status,data:n}},rn=(r,i)=>{const n=(r==null?void 0:r.data)||{};return String((n==null?void 0:n.error)||(n==null?void 0:n.message)||i)},Nn=r=>String(r||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,""),cn=r=>{const i=r&&typeof r=="object"?r:{},n={};for(let t=1;t<=20;t+=1){const s=Number(i[t]??i[String(t)]??0);n[t]=Number.isFinite(s)?s:0}return n},xn=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=String(n||"").trim().toUpperCase(),a=String(t||"").trim().toUpperCase();!s||!a||(i[s]=a)}),i},pn=()=>{if(typeof window>"u")return{};try{const r=window.localStorage.getItem(Zn);if(!r)return{};const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}},Ve=r=>{typeof window>"u"||window.localStorage.setItem(Zn,JSON.stringify(r||{}))},Tn="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",Ke=(r=8)=>{if(typeof crypto<"u"&&crypto.getRandomValues){const n=new Uint8Array(r);return crypto.getRandomValues(n),Array.from(n,t=>Tn[t%Tn.length]).join("")}let i="";for(let n=0;n<r;n+=1){const t=Math.floor(Math.random()*Tn.length);i+=Tn[t]}return i},Le=()=>{const r=pn();for(let i=0;i<20;i+=1){const n=Ke();if(!r[n])return n}throw new Error("Unable to generate a local access code.")},be=r=>{const i=pn();i[r.code]=r,Ve(i)},xe=(r,i="")=>({name:(r==null?void 0:r.name)||i,requirements:(r==null?void 0:r.requirements)||{},universities:Array.isArray(r==null?void 0:r.universities)?r.universities.map(n=>({name:String((n==null?void 0:n.name)||""),cutoff:Number((n==null?void 0:n.cutoff)??0),courseCode:String((n==null?void 0:n.courseCode)||"")})):[]}),pe=r=>(Array.isArray(r)?r:Object.values(r||{})).map(n=>xe(n)).filter(n=>!!n.name),Ge=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);!Number.isInteger(s)||s<1||(i[s]=pe(t))}),i},He=()=>!0,Fe=async()=>{const r=await bn(en.catalog);if(!r.ok)throw new Error(rn(r,"Unable to load course catalog from backend."));return Ge(r.data||{})},Be=async r=>{if(!r||typeof r!="object")throw new Error("Invalid course catalog payload.");const i=await On(en.adminCatalogUpload,r);if(!i.ok)throw new Error(rn(i,"Unable to upload course catalog to backend."))},we=async({cluster:r,name:i,requirements:n,universities:t})=>{const s=await On(en.adminCatalogCourse,{cluster:r,name:i,requirements:n,universities:t});if(!s.ok)throw new Error(rn(s,"Unable to save course entry to backend."));return s.data||{}},De=async({email:r,phoneNumber:i,amountPaid:n,grades:t,results:s,medicineEligible:a,paymentResponse:l})=>{const N=await On(en.sessions,{email:r,phoneNumber:i,amountPaid:n,grades:t,results:s,medicineEligible:a,paymentResponse:l});if(!N.ok)throw new Error(rn(N,"Unable to save session to backend."));const U=N.data||{};return{code:Nn(U.code),email:String(U.email||"").trim(),phoneNumber:String(U.phoneNumber||"").trim(),amountPaid:Number(U.amountPaid??0),grades:xn(U.grades),results:cn(U.results),medicineEligible:!!U.medicineEligible,paymentResponse:U.paymentResponse||null,createdAt:String(U.createdAt||""),updatedAt:String(U.updatedAt||""),storage:"firebase"}},Pe=async r=>{try{return{session:await De(r),storage:"firebase",warning:""}}catch(i){const n=new Date().toISOString(),s={code:Le(),email:String((r==null?void 0:r.email)||"").trim(),phoneNumber:String((r==null?void 0:r.phoneNumber)||"").trim(),amountPaid:Number((r==null?void 0:r.amountPaid)??0),grades:(r==null?void 0:r.grades)||{},results:cn((r==null?void 0:r.results)||{}),medicineEligible:!!(r!=null&&r.medicineEligible),paymentResponse:(r==null?void 0:r.paymentResponse)||null,createdAt:n,updatedAt:n,storage:"local"};return be(s),{session:s,storage:"local",warning:(i==null?void 0:i.message)||"Backend save failed. Session saved locally on this browser only."}}},je=async r=>{const i=Nn(r);if(!i)return null;const n=await bn(`${en.sessions}/${i}`);if(n.ok&&n.data){const s=n.data;return{code:i,email:String(s.email||"").trim(),phoneNumber:String(s.phoneNumber||"").trim(),amountPaid:Number(s.amountPaid??0),grades:xn(s.grades),results:cn(s.results),medicineEligible:!!s.medicineEligible,paymentResponse:s.paymentResponse||null,createdAt:String(s.createdAt||""),updatedAt:String(s.updatedAt||""),storage:"firebase"}}const t=pn()[i];if(t)return{code:i,email:t.email||"",phoneNumber:t.phoneNumber||"",amountPaid:Number(t.amountPaid??0),grades:t.grades||{},results:cn(t.results||{}),medicineEligible:!!t.medicineEligible,paymentResponse:t.paymentResponse||null,createdAt:t.createdAt||"",updatedAt:t.updatedAt||"",storage:"local"};if(n.status!==404)throw new Error(rn(n,"Unable to load session from backend."));return null},ke=async()=>{const r=await bn(en.adminSessions);if(!r.ok)throw new Error(rn(r,"Unable to load calculated sessions from backend."));return(Array.isArray(r.data)?r.data:[]).map(n=>({code:Nn(n.code),email:String(n.email||"").trim(),phoneNumber:String(n.phoneNumber||"").trim(),amountPaid:Number(n.amountPaid??0),createdAt:String(n.createdAt||""),updatedAt:String(n.updatedAt||""),medicineEligible:!!n.medicineEligible,grades:xn(n.grades),results:cn(n.results),paymentResponse:n.paymentResponse||null,storage:"firebase"})).filter(n=>n.code).sort((n,t)=>(Date.parse(t.createdAt||"")||0)-(Date.parse(n.createdAt||"")||0))},Je=async(r,i={})=>{const n=Nn(r);if(!n)throw new Error("Session code is required.");const t=await Me(`${en.adminSessions}/${n}`,i);if(!t.ok)throw new Error(rn(t,"Unable to update session."))},qe=async r=>{const i=Nn(r);if(!i)throw new Error("Session code is required.");const n=await fe(`${en.adminSessions}/${i}`);if(!n.ok)throw new Error(rn(n,"Unable to delete session."))},$e=async(r=[])=>{var n;const i=await On(en.adminSessionsBulkDelete,{codes:Array.isArray(r)?r:[]});if(!i.ok)throw new Error(rn(i,"Unable to delete selected sessions."));return Number(((n=i.data)==null?void 0:n.deleted)??0)},an={courseName:"COURSE NAME",cluster:"CLUSTER",courseCode:"COURSE CODE",university:"UNIVERSITY",cutoff:"CUT-OFF POINTS",requirements:"MINIMUM SUBJECT REQUIREMENTS"},nn=r=>String(r??"").replace(/\u00a0/g," ").trim(),_e=r=>{const i=nn(r).replace(/,/g,"");if(!i||i==="-")return 0;const n=Number.parseFloat(i);return Number.isFinite(n)?n:0},kn=r=>{const i=nn(r);if(!i||/^none$/i.test(i)||i==="-")return[];const n=[];return i.split(/\r?\n|;/).map(t=>t.trim()).filter(Boolean).forEach(t=>{if(/^none$/i.test(t)||t==="-")return;const s=t.indexOf(":");if(s<0)return;const a=t.slice(0,s).trim(),l=t.slice(s+1).trim().toUpperCase();!a||!l||l==="-"||n.push({subject:a,grade:l})}),n},We=(r=[],i=[])=>{const n=[...r];return i.forEach(t=>{if(!(t!=null&&t.subject)||!(t!=null&&t.grade))return;const s=n.findIndex(a=>a.subject===t.subject);s>=0?n[s]=t:n.push(t)}),n},Ze=r=>{const i=new Set,n=[];return r.forEach(t=>{const s=`${t.name}|${t.courseCode}`;!t.name||i.has(s)||(i.add(s),n.push(t))}),n},ze=r=>Object.values(an).some(i=>nn(r==null?void 0:r[i])),zn=r=>{const i=Xn.parse(r,{header:!0,skipEmptyLines:!1});if(!Array.isArray(i.data)||!i.data.length)throw new Error("CSV has no records.");const n={};let t=null;const s=()=>{t&&(n[t.cluster]||(n[t.cluster]=[]),n[t.cluster].push({name:t.name,requirements:t.requirements,universities:Ze(t.universities)}),t=null)};if(i.data.forEach(a=>{if(!a||typeof a!="object"||!ze(a))return;const l=nn(a[an.courseName]),N=nn(a[an.cluster]),U=nn(a[an.courseCode]),C=nn(a[an.university]),c=nn(a[an.cutoff]),O=nn(a[an.requirements]),T=Number(N);if(!!(l&&Number.isInteger(T)&&T>0))s(),t={name:l,cluster:T,requirements:kn(O),universities:[]};else if(!t)return;O&&(t.requirements=We(t.requirements,kn(O))),(C||U||c)&&t.universities.push({name:C||"Unknown University",courseCode:U,cutoff:_e(c)})}),s(),!Object.keys(n).length)throw new Error("CSV did not produce a valid course catalog.");return n},Qe=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}},Xe=`COURSE NAME,CLUSTER,COURSE CODE,UNIVERSITY,CUT-OFF POINTS,MINIMUM SUBJECT REQUIREMENTS\r
...
,,1114488,University of Eldoret,15.092,\r
,,1093488,University of Embu,15.092,\r
`,nr=r=>{if(!Array.isArray(r))return{};const i={};return r.forEach(n=>{const t=String((n==null?void 0:n.subject)||"").trim(),s=String((n==null?void 0:n.grade)||"").trim().toUpperCase();!t||!s||(i[t]=s)}),i},er=r=>{if(!r||typeof r!="object")return{};const i={};return Object.entries(r).forEach(([n,t])=>{const s=Number(n);if(!Number.isInteger(s)||s<1)return;const a=Array.isArray(t)?t:[];i[s]=a.map(l=>({name:String((l==null?void 0:l.name)||"").trim(),requirements:nr(l==null?void 0:l.requirements),universities:Array.isArray(l==null?void 0:l.universities)?l.universities.map(N=>({name:String((N==null?void 0:N.name)||"").trim(),courseCode:String((N==null?void 0:N.courseCode)||"").trim(),cutoff:Number((N==null?void 0:N.cutoff)??0)})).filter(N=>!!N.name):[]})).filter(l=>!!l.name)}),i};let yn=null;const Jn=()=>{if(yn)return yn;const r=zn(Xe);return yn=er(r),yn},rr=({mode:r="public"}={})=>{const[i,n]=I.useState({}),[t,s]=I.useState(!0),[a,l]=I.useState(""),N=I.useCallback(async()=>{if(s(!0),r!=="admin"){try{const c=Jn();n(c),l("")}catch(c){n({}),l((c==null?void 0:c.message)||"Unable to load bundled course catalog.")}finally{s(!1)}return}try{const c=await Fe();n(c),l("")}catch(c){const O=Jn();n(O);const T=(c==null?void 0:c.message)||"Unable to load courses from realtime database.";l(`${T} Showing bundled courses until backend connection is available.`)}finally{s(!1)}},[r]),U=I.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await Be(c),l(""),await N()},[N,r]),C=I.useCallback(async c=>{if(r!=="admin")throw new Error("Catalog updates are only available in admin mode.");await we(c),l(""),await N()},[N,r]);return I.useEffect(()=>{N().catch(()=>{})},[N]),{courseCatalog:i,catalogLoading:t,courseCatalogError:a,loadCatalog:N,saveCatalog:U,saveSingleCourse:C}};function ir({isAuthenticated:r,onLogin:i,onGoogleLogin:n,authError:t,isLoading:s}){const a=Sn(),[l,N]=I.useState(""),[U,C]=I.useState(""),[c,O]=I.useState(!1),[T,S]=I.useState("");if(r)return e.jsx(tn,{to:"/admin",replace:!0});const x=async h=>{h.preventDefault(),S("");const y=await i(l,U);if(y.success){a("/admin");return}S(y.error||"Invalid admin credentials.")},u=async()=>{S("");const h=await n();if(h.success){a("/admin");return}S(h.error||"Google sign-in failed.")};return e.jsxs("section",{className:"mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Admin Login"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Only admins can upload course data to Firebase."}),e.jsxs("form",{onSubmit:x,className:"mt-6 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"admin_email",type:"email",value:l,onChange:h=>N(h.target.value),required:!0,className:"ui-input",placeholder:"admin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{id:"admin_password",type:c?"text":"password",value:U,onChange:h=>C(h.target.value),required:!0,className:"ui-input pr-20"}),e.jsx("button",{type:"button",onClick:()=>O(h=>!h),className:"absolute right-2 top-1/2 -translate-y-1/2 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-600 transition hover:bg-slate-50",children:c?"Hide":"View"})]})]}),e.jsx(p,{tone:"danger",message:T}),e.jsx(p,{tone:"danger",message:t}),e.jsx("button",{type:"submit",disabled:s,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:s?"Signing in...":"Login"}),e.jsxs("div",{className:"relative py-1",children:[e.jsx("div",{className:"absolute inset-0 flex items-center",children:e.jsx("span",{className:"w-full border-t border-slate-200"})}),e.jsx("div",{className:"relative flex justify-center",children:e.jsx("span",{className:"bg-white px-2 text-xs text-slate-500",children:"OR"})})]}),e.jsx("button",{type:"button",onClick:u,disabled:s,className:"inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Continue with Google"})]})]})}const tr="/assets/courses-CtX9VR_p.csv",sr=r=>new Promise((i,n)=>{const t=new FileReader;t.onload=()=>i(String(t.result||"")),t.onerror=()=>n(new Error("Unable to read selected file.")),t.readAsText(r)});function ar({firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:n}){const[t,s]=I.useState(""),[a,l]=I.useState(""),[N,U]=I.useState(!1),[C,c]=I.useState(null),O=async(u,h)=>{s(""),l(""),U(!0);try{const y=zn(u);await i(y);const g=Qe(y);l(`${h} uploaded: ${g.clusters} clusters, ${g.courses} courses, ${g.universities} universities.`)}catch(y){s(y.message||"Failed to upload course catalog.")}finally{U(!1)}},T=async()=>{if(!C){s("Select a CSV file first.");return}try{const u=await sr(C);await O(u,C.name)}catch(u){s(u.message||"Failed to read selected CSV file.")}},S=async()=>{try{const u=await fetch(n);if(!u.ok)throw new Error(`Unable to load bundled CSV (status ${u.status}).`);const h=await u.text();await O(h,"courses.csv")}catch(u){s(u.message||"Failed to upload bundled courses.csv.")}},x=u=>{var h;c(((h=u.target.files)==null?void 0:h[0])||null)};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight",children:"Courses Upload"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Upload a `courses.csv` compatible file through backend API into Firebase realtime database."}),r?null:e.jsx(p,{className:"mt-4",tone:"warning",message:"Backend Firebase integration is not available."}),e.jsxs("div",{className:"mt-5 flex flex-col gap-3 sm:flex-row sm:items-end",children:[e.jsxs("div",{className:"w-full sm:max-w-md",children:[e.jsx("label",{htmlFor:"admin_csv_upload",className:"mb-1 block text-sm font-medium text-slate-700",children:"Select CSV file"}),e.jsx("input",{id:"admin_csv_upload",type:"file",accept:".csv,text/csv",onChange:x,className:"ui-file-input"})]}),e.jsx("button",{type:"button",onClick:T,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Upload Selected CSV"}),e.jsx("button",{type:"button",onClick:S,disabled:N||!r,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:"Upload Bundled courses.csv"})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:t}),e.jsx(p,{className:"mt-3",tone:"success",message:a})]})}const qn={name:"",email:"",password:""},or={cluster:"",name:"",requirementsText:"",universityName:"",courseCode:"",cutoff:""},Er=r=>{const i={};return String(r||"").split(/\r?\n|;/).map(n=>n.trim()).filter(Boolean).forEach(n=>{const t=n.indexOf(":");if(t<0)return;const s=n.slice(0,t).trim(),a=n.slice(t+1).trim().toUpperCase();!s||!a||(i[s]=a)}),i},Ir=r=>{const i=Object.keys(r||{}).length;let n=0,t=0;return Object.values(r||{}).forEach(s=>{Array.isArray(s)&&(n+=s.length,s.forEach(a=>{t+=Array.isArray(a==null?void 0:a.universities)?a.universities.length:0}))}),{clusters:i,courses:n,universities:t}};function lr({firebaseConfigured:r,onUploadCatalog:i,onAddSingleCourse:n,onLogout:t,onAddRegularAdmin:s,adminProfile:a,adminEmail:l,authError:N,courseCatalog:U}){const[C,c]=I.useState(qn),[O,T]=I.useState(!1),[S,x]=I.useState(""),[u,h]=I.useState(""),[y,g]=I.useState(or),[Y,v]=I.useState(!1),[H,F]=I.useState(""),[$,W]=I.useState(""),k=(a==null?void 0:a.role)==="super",_=I.useMemo(()=>Ir(U),[U]),J=(M,A)=>{c(d=>({...d,[M]:A}))},G=(M,A)=>{g(d=>({...d,[M]:A}))},q=async M=>{if(M.preventDefault(),x(""),h(""),!k){x("Only a super admin can add regular admins.");return}if(!C.email||!C.password){x("Email and password are required.");return}T(!0);try{const A=await s({name:C.name,email:C.email,password:C.password});h(`Regular admin added: ${A.user.email}`),c(qn)}catch(A){x(A.message||"Unable to add regular admin.")}finally{T(!1)}},Z=async M=>{if(M.preventDefault(),F(""),W(""),!r){F("Firebase is not configured.");return}const A=Number(y.cluster);if(!Number.isInteger(A)||A<1){F("Cluster must be a whole number greater than 0.");return}const d=String(y.name||"").trim();if(!d){F("Course name is required.");return}const m=String(y.universityName||"").trim();if(!m){F("University name is required.");return}const f=String(y.cutoff||"").trim(),K=f?Number(f):0;if(!Number.isFinite(K)||K<0){F("Cutoff must be a number equal to or greater than 0.");return}v(!0);try{await n({cluster:A,name:d,requirements:Er(y.requirementsText),universities:[{name:m,courseCode:String(y.courseCode||"").trim(),cutoff:K}]}),W(`Saved "${d}" in cluster ${A}.`),g(z=>({...z,universityName:"",courseCode:"",cutoff:""}))}catch(z){F(z.message||"Unable to save course.")}finally{v(!1)}};return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:[e.jsx("div",{className:"pointer-events-none absolute -top-14 -right-12 h-44 w-44 rounded-full bg-cyan-200/40 blur-2xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-10 -left-10 h-36 w-36 rounded-full bg-emerald-200/50 blur-2xl"}),e.jsxs("div",{className:"relative",children:[e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Control Center"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Admin Dashboard"}),e.jsx("p",{className:"mt-2 max-w-2xl text-sm text-slate-600",children:"Manage admins and maintain course catalog content for calculator results and eligibility checks."}),e.jsxs("p",{className:"mt-3 text-xs font-medium text-slate-500",children:["Signed in as: ",l||"unknown"," (",(a==null?void 0:a.role)||"regular"," admin)"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(In,{to:"/admin/sessions",className:"inline-flex items-center justify-center rounded-xl border border-cyan-300 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-100",children:"View Calculated Users"}),e.jsx("button",{type:"button",onClick:t,className:"inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:"Logout"})]})]}),e.jsxs("div",{className:"mt-5 grid gap-3 sm:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Clusters"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:_.clusters})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"Courses"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:_.courses})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white/80 p-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-wider text-slate-500",children:"University Entries"}),e.jsx("p",{className:"mt-2 text-2xl font-semibold text-slate-900",children:_.universities})]})]})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:N})]}),e.jsxs("div",{className:"grid gap-6 xl:grid-cols-2",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Admin Users"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Create regular admin accounts that can log in and access admin tools."}),k?null:e.jsx(p,{className:"mt-3",tone:"warning",message:"Only a super admin can add regular admin users."}),e.jsxs("form",{onSubmit:q,className:"mt-5 grid gap-4 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Full Name"}),e.jsx("input",{id:"regular_admin_name",type:"text",value:C.name,onChange:M=>J("name",M.target.value),className:"ui-input",placeholder:"Admin Name"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"regular_admin_email",type:"email",value:C.email,onChange:M=>J("email",M.target.value),required:!0,className:"ui-input",placeholder:"newadmin@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"regular_admin_password",className:"mb-1 block text-sm font-medium text-slate-700",children:"Password"}),e.jsx("input",{id:"regular_admin_password",type:"password",value:C.password,onChange:M=>J("password",M.target.value),required:!0,minLength:6,className:"ui-input",placeholder:"At least 6 characters"})]}),e.jsx("div",{className:"md:col-span-3",children:e.jsx("button",{type:"submit",disabled:!k||O,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-600 disabled:cursor-not-allowed disabled:bg-slate-400",children:O?"Creating...":"Add Regular Admin"})})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:S}),e.jsx(p,{className:"mt-3",tone:"success",message:u})]}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"Add Single Course"}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Add one course entry at a time. If the course already exists in the same cluster, the university entry is merged into it."}),r?null:e.jsx(p,{className:"mt-3",tone:"warning",message:"Firebase is not configured for catalog writes."}),e.jsxs("form",{onSubmit:Z,className:"mt-5 grid gap-4 md:grid-cols-2",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cluster",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cluster"}),e.jsx("input",{id:"single_course_cluster",type:"number",min:1,value:y.cluster,onChange:M=>G("cluster",M.target.value),required:!0,className:"ui-input",placeholder:"e.g. 2"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_name",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Name"}),e.jsx("input",{id:"single_course_name",type:"text",value:y.name,onChange:M=>G("name",M.target.value),required:!0,className:"ui-input",placeholder:"BACHELOR OF COMMERCE"})]}),e.jsxs("div",{className:"md:col-span-2",children:[e.jsx("label",{htmlFor:"single_course_requirements",className:"mb-1 block text-sm font-medium text-slate-700",children:"Minimum Subject Requirements"}),e.jsx("textarea",{id:"single_course_requirements",value:y.requirementsText,onChange:M=>G("requirementsText",M.target.value),rows:4,className:"ui-textarea",placeholder:`Mathematics: C+
English/Kiswahili: B`})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_university",className:"mb-1 block text-sm font-medium text-slate-700",children:"University"}),e.jsx("input",{id:"single_course_university",type:"text",value:y.universityName,onChange:M=>G("universityName",M.target.value),required:!0,className:"ui-input",placeholder:"University of Nairobi"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_code",className:"mb-1 block text-sm font-medium text-slate-700",children:"Course Code"}),e.jsx("input",{id:"single_course_code",type:"text",value:y.courseCode,onChange:M=>G("courseCode",M.target.value),className:"ui-input",placeholder:"1263134"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"single_course_cutoff",className:"mb-1 block text-sm font-medium text-slate-700",children:"Cutoff Points"}),e.jsx("input",{id:"single_course_cutoff",type:"number",step:"0.001",min:0,value:y.cutoff,onChange:M=>G("cutoff",M.target.value),className:"ui-input",placeholder:"32.613"})]}),e.jsx("div",{className:"md:col-span-2",children:e.jsx("button",{type:"submit",disabled:Y||!r,className:"inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-emerald-500 enabled:hover:to-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:Y?"Saving...":"Save Course Entry"})})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:H}),e.jsx(p,{className:"mt-3",tone:"success",message:$})]})]}),e.jsx(ar,{firebaseConfigured:r,onUploadCatalog:i,bundledCoursesCsvUrl:tr})]})}const ln=20,cr=["BIO","CHE","MAT","PHY"],Cn={code:"",email:"",phoneNumber:"",amountPaid:"0",medicineEligible:!1},Nr=r=>{if(!r)return"Unknown";const i=Date.parse(r);return Number.isFinite(i)?new Date(i).toLocaleString():"Unknown"},fn=r=>{const i=Number(r);return Number.isFinite(i)?i.toFixed(3):"0.000"},Qn=r=>{const i=r&&typeof r=="object"?r:{};return Array.from({length:20},(n,t)=>{const s=t+1;return{cluster:s,score:Number(i[s]??i[String(s)]??0)}}).map(n=>({...n,score:Number.isFinite(n.score)?n.score:0}))},Ur=(r,i=3)=>Qn(r).sort((n,t)=>t.score-n.score||n.cluster-t.cluster).slice(0,i),Ar=r=>[r.code,r.email,r.phoneNumber,r.amountPaid,r.createdAt,r.medicineEligible?"eligible":"not-eligible"].join(" ").toLowerCase(),Tr=(r,i)=>{if(i<=7)return Array.from({length:i},(t,s)=>s+1);const n=Math.max(1,Math.min(r-3,i-6));return Array.from({length:7},(t,s)=>n+s)};function yr({firebaseConfigured:r}){const[i,n]=I.useState([]),[t,s]=I.useState(!0),[a,l]=I.useState(""),[N,U]=I.useState(""),[C,c]=I.useState(""),[O,T]=I.useState(""),[S,x]=I.useState(""),[u,h]=I.useState([]),[y,g]=I.useState(1),[Y,v]=I.useState(Cn),[H,F]=I.useState(!1),[$,W]=I.useState(!1),[k,_]=I.useState(""),J=I.useCallback(async()=>{if(!r){s(!1),l("Firebase is not configured."),n([]);return}s(!0),l("");try{const o=await ke();n(o)}catch(o){l(o.message||"Unable to load cluster sessions."),n([])}finally{s(!1)}},[r]);I.useEffect(()=>{J().catch(()=>{})},[J]);const G=I.useMemo(()=>{const o=String(O||"").trim().toLowerCase();return o?i.filter(R=>Ar(R).includes(o)):i},[O,i]),q=I.useMemo(()=>Math.max(1,Math.ceil(G.length/ln)),[G.length]),Z=I.useMemo(()=>{const o=(y-1)*ln;return G.slice(o,o+ln)},[y,G]);I.useMemo(()=>{const o=new Set(G.map(L=>L.email||L.phoneNumber||L.code)).size,R=G.filter(L=>L.medicineEligible).length;return{totalSessions:G.length,uniqueUsers:o,medicineQualifiedCount:R}},[G]);const M=I.useMemo(()=>new Set(u),[u]),A=I.useMemo(()=>Z.map(o=>o.code),[Z]),d=A.length>0&&A.every(o=>M.has(o));I.useEffect(()=>{g(1)},[O]),I.useEffect(()=>{y>q&&g(q)},[y,q]),I.useEffect(()=>{const o=new Set(G.map(R=>R.code));h(R=>R.filter(L=>o.has(L))),S&&!o.has(S)&&x(""),Y.code&&!o.has(Y.code)&&v(Cn)},[Y.code,S,G]);const m=o=>{h(R=>{const L=new Set(R);return L.has(o)?L.delete(o):L.add(o),Array.from(L)})},f=()=>{h(o=>{const R=new Set(o);return d?A.forEach(L=>R.delete(L)):A.forEach(L=>R.add(L)),Array.from(R)})},K=()=>{H||v(Cn)},z=async o=>{if(o.preventDefault(),!Y.code)return;U(""),c("");const R=Number(Y.amountPaid);if(!Number.isFinite(R)||R<0){U("Amount paid must be a valid number equal to or greater than 0.");return}F(!0);try{await Je(Y.code,{email:Y.email,phoneNumber:Y.phoneNumber,amountPaid:R,medicineEligible:Y.medicineEligible}),c(`Session ${Y.code} updated successfully.`),v(Cn),await J()}catch(L){U(L.message||"Unable to update session.")}finally{F(!1)}},Q=async o=>{if(o&&(U(""),c(""),!!window.confirm(`Delete session ${o}?`))){_(o);try{await qe(o),c(`Session ${o} deleted.`),h(R=>R.filter(L=>L!==o)),S===o&&x(""),await J()}catch(R){U(R.message||"Unable to delete session.")}finally{_("")}}},sn=async()=>{if(u.length&&(U(""),c(""),!!window.confirm(`Delete ${u.length} selected session(s)?`))){W(!0);try{const o=await $e(u);c(`${o} session(s) deleted.`),h([]),S&&u.includes(S)&&x(""),await J()}catch(o){U(o.message||"Unable to delete selected sessions.")}finally{W(!1)}}},on=I.useMemo(()=>Tr(y,q),[y,q]),hn=G.length?(y-1)*ln+1:0,vn=Math.min(G.length,y*ln);return e.jsxs("section",{className:"space-y-6",children:[e.jsx("div",{className:"rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-emerald-50 p-6 shadow-sm",children:e.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"inline-flex rounded-full border border-cyan-200 bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cyan-700",children:"Admin Analytics"}),e.jsx("h1",{className:"mt-3 text-3xl font-semibold tracking-tight text-slate-900",children:"Calculated Users Table"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Review users who calculated cluster points and manage records safely."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{type:"button",onClick:()=>J(),className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100",children:[e.jsx(ne,{className:"h-4 w-4"}),"Refresh"]}),e.jsxs(In,{to:"/admin",className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-600",children:[e.jsx(ee,{className:"h-4 w-4"}),"Back to Admin"]})]})]})}),e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsxs("div",{className:"flex flex-wrap items-center justify-between gap-3",children:[e.jsx("h2",{className:"text-xl font-semibold tracking-tight text-slate-900",children:"User Calculations"}),e.jsxs("div",{className:"flex w-full flex-wrap items-center justify-end gap-2 lg:w-auto",children:[e.jsx("input",{type:"search",value:O,onChange:o=>T(o.target.value),placeholder:"Search by email, code, phone...",className:"ui-input w-full max-w-sm"}),e.jsxs("button",{type:"button",onClick:f,disabled:!A.length,className:"inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[d?e.jsx(re,{className:"h-4 w-4"}):e.jsx(Fn,{className:"h-4 w-4"}),d?"Unselect Page":"Select Page"]}),e.jsxs("button",{type:"button",onClick:sn,disabled:!u.length||$,className:"inline-flex items-center justify-center gap-1.5 rounded-xl bg-rose-600 px-3 py-2 text-sm font-semibold text-white transition enabled:hover:bg-rose-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Bn,{className:"h-4 w-4"}),$?"Deleting...":`Delete Selected (${u.length})`]})]})]}),e.jsx(p,{className:"mt-3",tone:"danger",message:a}),e.jsx(p,{className:"mt-3",tone:"danger",message:N}),e.jsx(p,{className:"mt-3",tone:"success",message:C}),t?e.jsx(p,{className:"mt-3",tone:"info",message:"Loading sessions..."}):null,e.jsx("div",{className:"mt-4 overflow-x-auto",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-50 text-left text-xs uppercase tracking-wider text-slate-500",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-3 font-semibold",children:e.jsx("input",{type:"checkbox",checked:d,onChange:f,"aria-label":"Select all on current page",className:"ui-checkbox"})}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Date"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Access Code"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"User"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Best Cluster"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Top 3 Cluster Points"}),e.jsx("th",{className:"px-3 py-3 font-semibold",children:"Actions"})]})}),e.jsxs("tbody",{className:"divide-y divide-slate-200 bg-white text-slate-700",children:[!t&&!Z.length?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-3 py-8 text-center text-sm text-slate-500",children:"No calculation sessions found."})}):null,Z.map(o=>{const R=Ur(o.results),L=R[0],gn=Object.entries(o.grades||{}).filter(([,P])=>P),Gn=k===o.code;return e.jsxs(I.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsx("input",{type:"checkbox",checked:M.has(o.code),onChange:()=>m(o.code),"aria-label":`Select ${o.code}`,className:"ui-checkbox"})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:Nr(o.createdAt)}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3 font-mono font-semibold text-slate-900",children:o.code}),e.jsxs("td",{className:"px-3 py-3",children:[e.jsx("p",{className:"font-medium text-slate-900",children:o.email||"No email"}),e.jsx("p",{className:"text-xs text-slate-500",children:o.phoneNumber||"No phone"})]}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:L?`C${L.cluster}: ${fn(L.score)}`:"N/A"}),e.jsx("td",{className:"px-3 py-3",children:e.jsx("div",{className:"flex flex-wrap gap-1.5",children:R.map(P=>e.jsxs("span",{className:"rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-medium text-slate-700",children:["C",P.cluster,": ",fn(P.score)]},`${o.code}-${P.cluster}`))})}),e.jsx("td",{className:"whitespace-nowrap px-3 py-3",children:e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>x(P=>P===o.code?"":o.code),className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-100",children:[S===o.code?e.jsx(ie,{className:"h-3.5 w-3.5"}):e.jsx(te,{className:"h-3.5 w-3.5"}),S===o.code?"Hide":"View"]}),e.jsxs("button",{type:"button",onClick:()=>Q(o.code),disabled:Gn,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-rose-300 bg-rose-50 px-2.5 py-1.5 text-xs font-semibold text-rose-700 transition enabled:hover:bg-rose-100 disabled:cursor-not-allowed disabled:text-rose-400",children:[e.jsx(Bn,{className:"h-3.5 w-3.5"}),Gn?"Deleting...":"Delete"]})]})})]}),S===o.code?e.jsx("tr",{className:"bg-slate-50/70",children:e.jsx("td",{colSpan:8,className:"px-3 py-4",children:e.jsxs("div",{className:"grid gap-4 lg:grid-cols-3",children:[e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"Qualification Details"}),e.jsx("p",{className:"mt-2 text-xs text-slate-600",children:"Medicine core subjects (BIO, CHE, MAT, PHY):"}),e.jsx("div",{className:"mt-2 flex flex-wrap gap-1.5",children:cr.map(P=>{var Un,Hn;return e.jsxs("span",{className:`rounded-full border px-2 py-1 text-xs font-medium ${(Un=o.grades)!=null&&Un[P]?"border-emerald-200 bg-emerald-50 text-emerald-700":"border-rose-200 bg-rose-50 text-rose-700"}`,children:[P,": ",((Hn=o.grades)==null?void 0:Hn[P])||"Missing"]},`${o.code}-${P}`)})}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Amount Paid: KES ",o.amountPaid||0]})]}),e.jsxs("div",{className:"rounded-xl border border-slate-200 bg-white p-3 lg:col-span-2",children:[e.jsx("h3",{className:"text-sm font-semibold text-slate-900",children:"All Cluster Points"}),e.jsx("div",{className:"mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5",children:Qn(o.results).map(P=>e.jsxs("div",{className:"rounded-lg border border-slate-200 bg-slate-50 px-2 py-2 text-xs",children:[e.jsxs("p",{className:"font-semibold text-slate-700",children:["Cluster ",P.cluster]}),e.jsx("p",{className:"mt-1 font-mono text-slate-900",children:fn(P.score)})]},`${o.code}-cluster-${P.cluster}`))}),e.jsxs("p",{className:"mt-3 text-xs text-slate-500",children:["Graded subjects: ",gn.length," ",gn.length?`(${gn.map(([P,Un])=>`${P}:${Un}`).join(", ")})`:""]})]})]})})}):null]},o.code)})]})]})}),e.jsxs("div",{className:"mt-4 flex flex-wrap items-center justify-between gap-3",children:[e.jsxs("p",{className:"text-sm text-slate-600",children:["Showing ",hn,"-",vn," of ",G.length]}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsxs("button",{type:"button",onClick:()=>g(o=>Math.max(1,o-1)),disabled:y<=1,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(se,{className:"h-4 w-4"}),"Prev"]}),on.map(o=>e.jsx("button",{type:"button",onClick:()=>g(o),className:`inline-flex items-center justify-center rounded-lg border px-3 py-1.5 text-sm font-semibold transition ${o===y?"border-slate-900 bg-slate-900 text-white":"border-slate-300 bg-white text-slate-700 hover:bg-slate-100"}`,children:o},`page-${o}`)),e.jsxs("button",{type:"button",onClick:()=>g(o=>Math.min(q,o+1)),disabled:y>=q,className:"inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:["Next",e.jsx(ae,{className:"h-4 w-4"})]})]})]})]}),Y.code?e.jsx("div",{className:"fixed inset-0 z-40 flex items-center justify-center bg-slate-900/40 p-4",children:e.jsxs("div",{className:"w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsxs("h3",{className:"text-lg font-semibold text-slate-900",children:["Edit Session ",Y.code]}),e.jsx("p",{className:"mt-1 text-sm text-slate-600",children:"Update user contact details, payment amount, and qualification flag."}),e.jsxs("form",{onSubmit:z,className:"mt-4 grid gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email"}),e.jsx("input",{id:"edit_session_email",type:"email",value:Y.email,onChange:o=>v(R=>({...R,email:o.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_phone",className:"mb-1 block text-sm font-medium text-slate-700",children:"Phone Number"}),e.jsx("input",{id:"edit_session_phone",type:"text",value:Y.phoneNumber,onChange:o=>v(R=>({...R,phoneNumber:o.target.value})),className:"ui-input"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"edit_session_amount",className:"mb-1 block text-sm font-medium text-slate-700",children:"Amount Paid"}),e.jsx("input",{id:"edit_session_amount",type:"number",min:0,step:"0.01",value:Y.amountPaid,onChange:o=>v(R=>({...R,amountPaid:o.target.value})),className:"ui-input"})]}),e.jsxs("label",{className:"inline-flex items-center gap-2 text-sm font-medium text-slate-700",children:[e.jsx("input",{type:"checkbox",checked:Y.medicineEligible,onChange:o=>v(R=>({...R,medicineEligible:o.target.checked})),className:"ui-checkbox"}),"Medicine Eligible"]}),e.jsxs("div",{className:"mt-2 flex items-center justify-end gap-2",children:[e.jsxs("button",{type:"button",onClick:K,disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-400",children:[e.jsx(oe,{className:"h-4 w-4"}),"Cancel"]}),e.jsxs("button",{type:"submit",disabled:H,className:"inline-flex items-center justify-center gap-1.5 rounded-lg bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:bg-cyan-500 disabled:cursor-not-allowed disabled:bg-slate-400",children:[e.jsx(Fn,{className:"h-4 w-4"}),H?"Saving...":"Save Changes"]})]})]})]})}):null]})}const En={darajaPayment:j("/api/payments"),darajaQuery:j("/api/payments/query"),email:j("/sendEmail"),calculateCluster:j("/calculateClusterPoints"),adminHealth:j("/api/admin/health")},Cr=async r=>{try{const i=await r.text();return i?JSON.parse(i):null}catch{return null}},un=async({url:r,headers:i,body:n})=>{const t=await fetch(r,{method:"POST",credentials:"include",headers:i||{},body:n||void 0}),s=await Cr(t);return{ok:t.ok,status:t.status,data:s}},dn=(r,i)=>{const n=(r==null?void 0:r.data)||{},t=(n==null?void 0:n.error)||(n==null?void 0:n.message)||(n==null?void 0:n.errorMessage)||(n==null?void 0:n.ResultDesc);return t?String(t):i},mn=r=>r&&typeof r=="object"&&"data"in r&&r.success!==!1?r.data:r,Sr=r=>({source:"local-engine",results:Ye(r),medicineEligible:ve(r)}),Rr=async r=>{const i=(r==null?void 0:r["phone number"])||(r==null?void 0:r.phone_number)||(r==null?void 0:r.phoneNumber)||(r==null?void 0:r.phone)||"",n=Number((r==null?void 0:r.amount)??0),t=await un({url:En.darajaPayment,headers:{"Content-Type":"application/json"},body:JSON.stringify({phone_number:i,amount:n,account_reference:String((r==null?void 0:r.account_reference)||(r==null?void 0:r.accountReference)||"KUCCPS-CLUSTER"),transaction_description:String((r==null?void 0:r.transaction_description)||(r==null?void 0:r.transactionDesc)||"Cluster payment")})});if(!t.ok)throw new Error(dn(t,"Unable to initiate STK push."));return mn(t.data)},Or=async r=>{const i=String((r==null?void 0:r.email)||"").trim(),n=String(r==null?void 0:r.subject).trim(),t=String((r==null?void 0:r.message)||"");if(!i||!n||!t)throw new Error("Email, subject and message are required.");const s=new URLSearchParams({email:i,subject:n,message:t}).toString(),a=[{url:En.email,headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,subject:n,message:t})},{url:`${En.email}${En.email.includes("?")?"&":"?"}${s}`,headers:{},body:void 0}],l=[],N=[];for(const C of a){const c=await un(C);if(c.ok)return mn(c.data);l.push(c.status),N.push(dn(c,`HTTP ${c.status}`))}const U=N.filter(Boolean).join(" | ");throw new Error(`Email API request failed. ${U||`Status codes: ${l.join(", ")}.`}`)},ur=async({checkoutRequestId:r})=>{const i={checkoutRequestId:String(r||"").trim()};if(!i.checkoutRequestId)throw new Error("checkoutRequestId is required.");const n=await un({url:En.darajaQuery,headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(n.ok)return mn(n.data);throw new Error(dn(n,"Unable to fetch payment status."))},$n=r=>new Promise(i=>window.setTimeout(i,r)),dr=async({checkoutRequestId:r,timeoutMs:i=3e5,intervalMs:n=3e3,onStatus:t})=>{var l;const s=Date.now();let a="";for(;Date.now()-s<=i;){let N;try{N=await ur({checkoutRequestId:r})}catch(c){a=String((c==null?void 0:c.message)||"").trim()||a,t==null||t({status:"pending",transientError:!0,resultDesc:a||"Temporary payment status check issue."}),await $n(n);continue}t==null||t(N);const U=String((N==null?void 0:N.status)||"").trim().toLowerCase(),C=Number(((l=N==null?void 0:N.queryResponse)==null?void 0:l.ResultCode)??NaN);if(U==="success"||C===0)return N;if(U==="failed")throw new Error((N==null?void 0:N.resultDesc)||"Payment failed. Please try again.");await $n(n)}throw new Error(a?`Timed out while waiting for M-Pesa confirmation. Last status: ${a}`:"Timed out while waiting for M-Pesa confirmation.")},mr=async({grades:r,checkoutRequestId:i,merchantRequestId:n})=>{const t={grades:r||{},checkoutRequestId:String(i||"").trim(),merchantRequestId:String(n||"").trim()};if(!t.checkoutRequestId&&!t.merchantRequestId)throw new Error("checkoutRequestId or merchantRequestId is required before calculation.");const s=await un({url:En.calculateCluster,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(s.ok)return mn(s.data);throw new Error(dn(s,"Unable to calculate cluster points after payment."))},hr=r=>r==="saved-session"?"Saved Session":r==="firebase-function"?"Firebase Function":"Local Cluster Engine",vr=({code:r})=>["Your KUCCPS cluster calculation is ready.","",`Access code: ${r}`,"","Use this code on the home page to open your saved cluster points and continue course selection."].join(`
`),gr=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Yr=r=>gr.test(String(r||"").trim()),Mr=r=>{const i=String(r||"").replace(/\D/g,"");return i.length===10&&i.startsWith("0")?`254${i.slice(1)}`:i.length===9&&i.startsWith("7")?`254${i}`:i.length===12&&i.startsWith("254")?i:null},_n=()=>Object.fromEntries(Object.keys(Ln).map(r=>[r,""])),fr="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:shadow",Vr="mt-3 inline-flex w-full items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100",Kr="ui-select";function Lr({onCalculationReady:r,payableAmount:i,gradeOptions:n}){const t=Sn(),[s,a]=I.useState(_n()),[l,N]=I.useState(Object.fromEntries(jn.map((A,d)=>[A.title,d===0]))),[U,C]=I.useState(!1),[c,O]=I.useState(""),[T,S]=I.useState(""),[x,u]=I.useState(""),[h,y]=I.useState(null),[g,Y]=I.useState(""),[v,H]=I.useState(""),[F,$]=I.useState(!1),[W,k]=I.useState(""),_=(A,d)=>{a(m=>({...m,[A]:d}))},J=A=>Ln[A]||A,G=()=>Object.entries(s).filter(([,A])=>A&&A!=="").map(([A])=>A),q=A=>{N(d=>{const m=Object.fromEntries(Object.keys(d).map(f=>[f,!1]));return m[A]=!d[A],m})},Z=A=>{A.preventDefault(),k(""),S(""),u("");const d=G();if(d.length<7){k("Select grades for at least 7 subjects across all groups to compute cluster points.");return}const m=_n();d.forEach(K=>{m[K]=s[K]});const f=String(v||"").trim();if(!Yr(f)){k("Enter a valid email address.");return}y(m),Y(f),C(!0)},M=async A=>{if(A.preventDefault(),S(""),u(""),!h){S("Please submit your grades and email first.");return}if(!g){S("Enter a valid email before continuing.");return}const d=Mr(c);if(!d){S("Enter a valid M-Pesa phone number e.g. 0712345678 or 254712345678.");return}$(!0);try{u("Sending the STK push to your phone...");const m=await Rr({amount:i,phone_number:d,phone:d,phoneNumber:d,"phone number":d}),f=String((m==null?void 0:m.CheckoutRequestID)||(m==null?void 0:m.checkoutRequestId)||"").trim(),K=String((m==null?void 0:m.MerchantRequestID)||(m==null?void 0:m.merchantRequestId)||"").trim();if(!f&&!K)throw new Error("STK push response did not include a payment reference.");u("STK push sent. Complete the payment on your phone. Waiting for confirmation...");const z=await dr({checkoutRequestId:f,merchantRequestId:K,onStatus:R=>{(R==null?void 0:R.status)==="pending"&&u("Waiting for M-Pesa confirmation. Complete the prompt on your phone to continue.")}});u("Payment confirmed. Calculating cluster points...");let Q,sn="";try{Q=await mr({grades:h,checkoutRequestId:f,merchantRequestId:K})}catch(R){Q=Sr(h),sn=String((R==null?void 0:R.message)||"").trim()||"Backend calculation API was unavailable, so a local verified fallback was used."}const{session:on,storage:hn,warning:vn}=await Pe({email:g,phoneNumber:d,amountPaid:i,grades:h,results:Q.results,medicineEligible:Q.medicineEligible,paymentResponse:{initiation:m,confirmation:z}}),o=["Payment confirmed."];sn&&o.push(`Cluster points calculated locally (${sn}).`),hn==="local"?o.push(vn||"Firebase save failed. Session was saved on this browser only, so code restore works only on this device."):o.push("Session saved to Firebase.");try{await Or({email:g,subject:"KUCCPS Cluster Calculator Access Code",message:vr({code:on.code})}),o.push(`Access code sent to ${g}.`)}catch(R){const L=R instanceof Error?R.message:"";o.push(L?`Email delivery failed (${L}). Save this code: ${on.code}.`:`Email delivery failed. Save this code: ${on.code}.`)}r({grades:h,results:Q.results,source:Q.source,accessCode:on.code,sessionMessage:o.join(" ")}),C(!1),S(""),u(""),k(""),t("/results")}catch(m){const f=m instanceof Error?m.message:"Payment or calculation failed.";S(f),k(f),u("")}finally{$(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"Cluster Points Calculator"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Enter your grades and email, then start payment. Cluster points are only shown after the M-Pesa payment is confirmed."}),e.jsxs("p",{className:"mt-1 text-sm font-medium text-emerald-700",children:["Amount: KES ",i]}),e.jsxs("form",{onSubmit:Z,className:"mt-6 space-y-6",children:[e.jsx(p,{tone:"danger",message:W}),e.jsx("div",{className:"grid gap-5 xl:grid-cols-2",children:jn.map(A=>e.jsxs("article",{className:fr,children:[e.jsx("div",{className:"flex items-start justify-between gap-3",children:e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-semibold text-slate-900",children:A.title}),e.jsx("p",{className:"mt-1 text-xs text-slate-500",children:A.required?"Core group. Enter grades for all listed subjects.":"Optional group. Fill available subjects."})]})}),e.jsxs("button",{type:"button",onClick:()=>q(A.title),className:Vr,children:[e.jsx("span",{children:l[A.title]?"Hide grade fields":"Show grade fields"}),e.jsx(Ee,{className:`h-4 w-4 text-slate-500 transition-transform ${l[A.title]?"rotate-180":"rotate-0"}`})]}),l[A.title]?e.jsx("div",{className:"mt-4 grid gap-3 sm:grid-cols-2",children:A.subjects.map(d=>e.jsxs("div",{children:[e.jsxs("label",{htmlFor:`${A.title}-${d}`,className:"mb-1 block text-sm font-medium text-slate-700",children:[J(d),A.required?e.jsx("span",{className:"text-rose-600",children:" *"}):null]}),e.jsxs("select",{id:`${A.title}-${d}`,value:s[d],onChange:m=>_(d,m.target.value),required:A.required,className:Kr,children:[e.jsx("option",{value:"",children:"Select grade"}),n.map(m=>e.jsx("option",{value:m,children:m},m))]})]},d))}):null]},A.title))}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"email",className:"mb-1 block text-sm font-medium text-slate-700",children:"Email Address (for access code)"}),e.jsx("input",{id:"email",type:"email",value:v,onChange:A=>H(A.target.value),placeholder:"you@example.com",required:!0,className:"ui-input"})]}),e.jsx("button",{type:"submit",disabled:F,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition hover:from-slate-800 hover:to-slate-700",children:F?"Processing...":"Calculate Cluster Points"})]}),U?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 px-4",children:e.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl",children:[e.jsx("h2",{className:"text-lg font-semibold text-slate-900",children:"Enter M-Pesa Phone Number"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["We will send an STK push for KES ",i,". Your cluster points remain locked until the payment is confirmed."]}),e.jsxs("form",{onSubmit:M,className:"mt-4 space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"dialog_phone_number",className:"mb-1 block text-sm font-medium text-slate-700",children:"M-Pesa Phone Number"}),e.jsx("input",{id:"dialog_phone_number",type:"tel",value:c,onChange:A=>O(A.target.value),placeholder:"0712345678",autoFocus:!0,required:!0,className:"ui-input"})]}),e.jsx(p,{tone:"info",message:x}),e.jsx(p,{tone:"danger",message:T}),e.jsxs("div",{className:"flex items-center justify-end gap-3",children:[e.jsx("button",{type:"button",onClick:()=>{F||(C(!1),S(""))},disabled:F,className:"inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60",children:"Cancel"}),e.jsx("button",{type:"submit",disabled:F,className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-2 text-sm font-semibold text-white transition enabled:hover:from-slate-800 enabled:hover:to-slate-700 disabled:cursor-not-allowed disabled:bg-slate-400",children:F?"Processing...":"Send STK Push"})]})]})]})}):null]})}const Vn={A:12,"A-":11,"B+":10,B:9,"B-":8,"C+":7,C:6,"C-":5,"D+":4,D:3,"D-":2,E:1},br={ENGLISH:"ENG",KISWAHILI:"KIS",MATHEMATICS:"MAT",MATH:"MAT",BIOLOGY:"BIO",CHEMISTRY:"CHE",PHYSICS:"PHY","GENERAL SCIENCE":"GSC",HISTORY:"HAG","HISTORY & GOVERNMENT":"HAG",GEOGRAPHY:"GEO",CRE:"CRE",IRE:"IRE",HRE:"HRE","COMPUTER STUDIES":"CMP",AGRICULTURE:"AGR","ART & DESIGN":"ARD","HOME SCIENCE":"HSC","BUSINESS STUDIES":"BST",FRENCH:"FRE",GERMAN:"GER",MUSIC:"MUS",ARABIC:"ARB"},xr=(r,i)=>{const n=[];for(const[t,s]of Object.entries(i||{})){const a=String(s||"").trim().toUpperCase();if(!(a in Vn))continue;const l=String(t).split("/").map(c=>{const O=c.trim().toUpperCase();return br[O]||O});let N=!1,U=null,C=null;for(const c of l){const O=(r[c]||"").toUpperCase();if(O){if((Vn[O]||0)>=Vn[a]){N=!0;break}U=c,C=O}}N||n.push({subject:t,required:a,studentSubject:U,studentGrade:C})}return{passed:n.length===0,failed:n}};function pr({results:r,grades:i,courseCatalog:n}){const[t]=Ie(),s=Number(t.get("cluster")||0),a=t.get("course")||"";if(!r||!i)return e.jsx(tn,{to:"/",replace:!0});if(!s||!a)return e.jsx(tn,{to:"/results",replace:!0});const N=(n[s]||[]).find(T=>T.name===a);if(!N)return e.jsx(tn,{to:"/results",replace:!0});const U=Number(r[s]??r[String(s)]??0),C=xr(i,N.requirements),c=[],O=T=>Number(T||0).toFixed(3).replace(/\.?0+$/,"");if(C.passed)for(const T of N.universities||[])U>=Number(T.cutoff)&&c.push(T);return e.jsxs("section",{className:"space-y-6",children:[e.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:a}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 text-sm text-slate-700",children:[e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster:"})," ",s]}),e.jsxs("p",{children:[e.jsx("span",{className:"font-semibold text-slate-900",children:"Cluster Points:"})," ",U]})]})]}),C.passed?c.length?e.jsxs("article",{className:"rounded-2xl border border-emerald-200 bg-white p-5 shadow-sm",children:[e.jsx("h2",{className:"text-lg font-semibold text-emerald-900",children:"Qualified Universities"}),e.jsxs("p",{className:"mt-1 text-sm text-slate-600",children:["You qualify for ",c.length," ",c.length===1?"university":"universities"," based on your cluster points."]}),e.jsx("div",{className:"mt-4 overflow-x-auto rounded-xl border border-emerald-100",children:e.jsxs("table",{className:"min-w-full divide-y divide-emerald-100 text-sm",children:[e.jsx("thead",{className:"bg-emerald-50 text-left text-emerald-900",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"University"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cutoff"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Your Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Margin"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Status"})]})}),e.jsx("tbody",{className:"divide-y divide-emerald-50 bg-white text-slate-700",children:c.slice().sort((T,S)=>Number(S.cutoff)-Number(T.cutoff)).map(T=>e.jsxs("tr",{className:"hover:bg-emerald-50/40",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:T.name}),e.jsx("td",{className:"px-3 py-2",children:O(T.cutoff)}),e.jsx("td",{className:"px-3 py-2",children:O(U)}),e.jsxs("td",{className:"px-3 py-2 text-emerald-700",children:["+",O(U-Number(T.cutoff))]}),e.jsx("td",{className:"px-3 py-2",children:e.jsx("span",{className:"rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs font-semibold text-emerald-800",children:"Qualified"})})]},`${T.name}-${T.cutoff}`))})]})})]}):e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"Based on your current cluster points, you do not qualify for any listed university for this course."})]}):e.jsxs("div",{className:"space-y-4",children:[e.jsxs("article",{className:"rounded-2xl border border-amber-200 bg-amber-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-amber-900",children:"Not Qualified for Any University"}),e.jsx("p",{className:"mt-2 text-sm text-amber-900",children:"You do not meet subject requirements for this course, so you are not qualified for any listed university."})]}),e.jsxs("article",{className:"rounded-2xl border border-rose-200 bg-rose-50 p-5",children:[e.jsx("h2",{className:"text-lg font-semibold text-rose-900",children:"Subject Requirements Not Met"}),e.jsx("ul",{className:"mt-3 space-y-1 text-sm text-rose-900",children:C.failed.map(T=>e.jsxs("li",{children:[T.subject," required >= ",T.required,T.studentSubject?` (you had ${T.studentSubject}: ${T.studentGrade})`:" (subject not done)"]},`${T.subject}-${T.required}`))})]})]}),e.jsx("div",{children:e.jsx(In,{to:"/results",className:"text-sm font-medium text-slate-700 hover:text-slate-900",children:"Back to Results"})})]})}function Gr({onRestoreByCode:r,payableAmount:i}){const n=Sn(),[t,s]=I.useState(""),[a,l]=I.useState(""),[N,U]=I.useState(!1),C=async c=>{c.preventDefault(),l(""),U(!0);try{if(!await r(t)){l("Code not found. Confirm the code sent to your email.");return}n("/results")}catch(O){l(O.message||"Unable to load code.")}finally{U(!1)}};return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-12",children:[e.jsx("h1",{className:"mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl",children:"Start a new calculation or continue with your access code"}),e.jsxs("p",{className:"mt-4 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg",children:["New users pay KES ",i,", then receive a unique code by email to reopen saved results later."]}),e.jsxs("div",{className:"mt-6 flex flex-row items-center gap-4",children:[e.jsx("div",{className:"mt-8",children:e.jsx(In,{to:"/calculator",className:"inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:from-slate-800 hover:to-slate-700",children:"Get Started"})}),e.jsxs("form",{onSubmit:C,className:"max-w-xl space-y-3 rounded-xl",children:[e.jsx("label",{htmlFor:"access_code",className:"block text-sm font-medium text-slate-700",children:"Have an access code? Paste it here"}),e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row",children:[e.jsx("input",{id:"access_code",type:"text",value:t,onChange:c=>s(c.target.value.toUpperCase()),placeholder:"e.g. 8F3KQ2P9",className:"ui-input",required:!0}),e.jsx("button",{type:"submit",disabled:N,className:"inline-flex items-center justify-center rounded-lg bg-emerald-700 px-6 py-2 text-sm font-semibold text-white transition enabled:hover:bg-emerald-600 disabled:cursor-not-allowed disabled:bg-emerald-400",children:N?"Opening...":"Open"})]}),e.jsx(p,{tone:"danger",message:a})]})]})]})}function Hr({clusters:r,getScore:i,courseCatalog:n,selectedCourses:t,onSelectCourse:s,onCheckCourse:a}){return e.jsx("div",{className:"mt-6 overflow-x-auto rounded-xl border border-slate-200",children:e.jsxs("table",{className:"min-w-full divide-y divide-slate-200 text-sm",children:[e.jsx("thead",{className:"bg-slate-100 text-left text-slate-700",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Cluster"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Points"}),e.jsx("th",{className:"px-3 py-2 font-semibold",children:"Course Check"})]})}),e.jsx("tbody",{className:"divide-y divide-slate-100 bg-white text-slate-700",children:r.map(l=>{const N=n[l]||[];return e.jsxs("tr",{className:"align-top hover:bg-slate-50",children:[e.jsx("td",{className:"px-3 py-2 font-medium text-slate-900",children:l}),e.jsx("td",{className:"px-3 py-2",children:i(l)}),e.jsx("td",{className:"px-3 py-2",children:e.jsxs("div",{className:"flex flex-col gap-2 sm:flex-row",children:[e.jsxs("select",{value:t[l]||"",onChange:U=>s(l,U.target.value),className:"ui-select sm:max-w-sm",children:[e.jsx("option",{value:"",children:"Select Course"}),N.map(U=>e.jsx("option",{value:U.name,children:U.name},U.name))]}),e.jsx("button",{type:"button",disabled:!t[l],onClick:()=>a(l,t[l]),className:"inline-flex items-center justify-center rounded-lg bg-slate-900 px-3 py-2 text-xs font-semibold text-white transition enabled:hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400",children:"Check"})]})})]},l)})})]})})}function Fr({results:r,grades:i,source:n,courseCatalog:t,courseCatalogError:s,catalogLoading:a,accessCode:l,sessionMessage:N}){const U=Sn(),[C,c]=I.useState({});if(!r||!i)return e.jsx(tn,{to:"/",replace:!0});const O=Array.from({length:20},(S,x)=>x+1),T=S=>Number(r[S]??r[String(S)]??0);return e.jsxs("section",{className:"rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:[e.jsx("h1",{className:"text-2xl font-semibold tracking-tight",children:"All Cluster Points"}),e.jsx("p",{className:"mt-2 text-sm text-slate-600",children:"Select a course to evaluate your qualification details."}),e.jsxs("p",{className:"mt-1 text-xs font-medium text-slate-500",children:["Calculation source: ",hr(n)]}),l?e.jsx(p,{className:"mt-3",tone:"success",message:`Access code: ${l}`}):null,e.jsx(p,{className:"mt-2",tone:"info",message:N}),a?e.jsx(p,{className:"mt-2",tone:"info",message:"Loading course catalog..."}):null,e.jsx(p,{className:"mt-2",tone:"danger",message:s}),e.jsx(Hr,{clusters:O,getScore:T,courseCatalog:t,selectedCourses:C,onSelectCourse:(S,x)=>c(u=>({...u,[S]:x})),onCheckCourse:(S,x)=>U(`/course-result?cluster=${S}&course=${encodeURIComponent(x)}`)})]})}const Br=()=>Object.fromEntries(Object.keys(Ln).map(r=>[r,""]));function wr(){const r=Wn(),[i,n]=I.useState(null),[t,s]=I.useState(null),[a,l]=I.useState("local-engine"),[N,U]=I.useState(""),[C,c]=I.useState(""),O=I.useMemo(()=>He(),[]),T=r.pathname.startsWith("/admin"),{courseCatalog:S,catalogLoading:x,courseCatalogError:u,saveCatalog:h,saveSingleCourse:y}=rr({mode:T?"admin":"public"}),{adminUser:g,adminProfile:Y,authLoading:v,authWorking:H,authError:F,isAdminAuthenticated:$,login:W,loginWithGoogle:k,logout:_,addRegularAdmin:J}=ue({enabled:T}),G=I.useCallback(async f=>{const K=await je(f);return!K||!K.results?null:(n(K.grades||Br()),s(K.results||null),l("saved-session"),U(K.code),c(K.createdAt?`Loaded ${K.storage==="local"?"local":"saved"} session from ${new Date(K.createdAt).toLocaleString()}.`:`Loaded ${K.storage==="local"?"local":"saved"} session.`),K)},[]),q=I.useCallback(async f=>{await h(f)},[h]),Z=I.useCallback(async f=>{await y(f)},[y]),M=I.useCallback(async(f,K)=>await W(f,K),[W]),A=I.useCallback(async()=>await k(),[k]),d=I.useCallback(async()=>{await _()},[_]),m=I.useCallback(f=>v?e.jsx("section",{className:"mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:e.jsx(p,{tone:"info",message:"Checking admin authentication..."})}):$?f:e.jsx(tn,{to:"/admin/login",replace:!0}),[v,$]);return e.jsx(Te,{children:e.jsxs(le,{children:[e.jsx(X,{path:"/",element:e.jsx(Gr,{onRestoreByCode:G,payableAmount:Dn})}),e.jsx(X,{path:"/admin/login",element:e.jsx(ir,{isAuthenticated:$,onLogin:M,onGoogleLogin:A,authError:F,isLoading:H||v})}),e.jsx(X,{path:"/admin",element:m(e.jsx(lr,{firebaseConfigured:O,onUploadCatalog:q,onAddSingleCourse:Z,onLogout:d,onAddRegularAdmin:J,adminProfile:Y,adminEmail:(g==null?void 0:g.email)||"",authError:F,courseCatalog:S}))}),e.jsx(X,{path:"/admin/sessions",element:m(e.jsx(yr,{firebaseConfigured:O}))}),e.jsx(X,{path:"/calculator",element:e.jsx(Lr,{gradeOptions:ye,payableAmount:Dn,onCalculationReady:({grades:f,results:K,source:z,accessCode:Q,sessionMessage:sn})=>{n(f),s(K),l(z),U(Q||""),c(sn||"")}})}),e.jsx(X,{path:"/payment",element:e.jsx(tn,{to:"/calculator",replace:!0})}),e.jsx(X,{path:"/results",element:e.jsx(Fr,{results:t,grades:i,source:a,courseCatalog:S,courseCatalogError:u,catalogLoading:x,accessCode:N,sessionMessage:C})}),e.jsx(X,{path:"/course-result",element:e.jsx(pr,{results:t,grades:i,courseCatalog:S})}),e.jsx(X,{path:"*",element:e.jsx(tn,{to:"/",replace:!0})})]})})}ce.createRoot(document.getElementById("root")).render(e.jsx(Ne.StrictMode,{children:e.jsx(Ue,{children:e.jsx(wr,{})})}));
